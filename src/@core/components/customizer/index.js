    ...
    return skinsArr.map((radio, index) => {
      ...
      return (
        ...
        >
          ...
          />
          <Label for={id} className="mb-0 ml-50">
            {radio.label}
          </Label>
        </div>
      )
          ...
          <FormGroup className="mb-2">
            ...
            <div className="d-flex">
              <div className="d-flex align-items-center mr-1">
                ...
                />
                <Label for="full-width" className="mb-0 ml-50">
                  Full Width
                </Label>
              </div>
              <div className="d-flex align-items-center">
                ...
                />
                <Label for="boxes" className="mb-0 ml-50">
                  Boxed
                </Label>
              </div>
            </div>
          ...
          <FormGroup className="mb-2">
            <div className="d-flex align-items-center">
              <div className="d-flex align-items-center mr-1">
                ...
                />
                <Label for="vertical-layout" className="mb-0 ml-50">
                  Vertical
                </Label>
              </div>
              <div className="d-flex align-items-center">
                ...
                />
                <Label for="horizontal-layout" className="mb-0 ml-50">
                  Horizontal
                </Label>
              </div>
            </div>
