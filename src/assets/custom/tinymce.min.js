...
!(function () {
  ...
  const Uo = (e) => (t) => !!t && t.nodeType === e,
    ...
    Ur = (e) => (
      Fr(e) && (e = e.parentNode),
      Ir(e) && e.hasAttribute('data-mce-caret')
    ),
    zr = (e) => Fr(e) && Lr(e.data),
    jr = (e) => Ur(e) || zr(e),
    ...
    bu = (e, t) => {
      ...
      return Xo(n)
        ...
        : n
          ? os(n)
            ? I.some(
                e ? Mi.before(n) : nr((o = n)) ? Mi.before(o) : Mi.after(o)
              )
            : ((e, t, n) => {
                ...
                .bind((e) => {
                  ...
                  if (r.length > 0) {
                    if (o) return I.some(wh.partialTable(r, I.none()))
                    {
                      const e = Ah(n, t)
                      return I.some(
                        wh.partialTable(r, I.some({ ...t, rng: e }))
                      )
                    }
                  }
                  return I.none()
      ...
      var Re = function (e) {
        ...
        Pe = function (e) {
          ...
          if (
            ...
            return (Re(e), !0)
          if ('select' === r && cy(/<template/i, e.innerHTML))
            return (Re(e), !0)
          if (!z[r] || q[r]) {
            if (!q[r] && Me(r)) {
            ...
            : (t && sr(o.getNode())) || (!t && sr(o.getNode(!0)))
              ? ((e, t, n, o) => {
                  ...
                  return gh(vn(e), vn(n.getNode()))
                    .map((e) =>
                      ps(e) ? vx.remove(e.dom) : vx.moveToElement(r)
                    )
                      ...
                      : ((e, t, n) =>
                          ((e, t) => {
                            const n = t.getNode(!e),
                              o = e ? 'after' : 'before'
                            return (
                              jo(n) && n.getAttribute('data-mce-caret') === o
                            )
                          })(t, n)
                            ? ((e, t) =>
                                y(t)
                                  ...
                                  : e && sr(t.nextSibling)
                                    ...
                                    : !e && sr(t.previousSibling)
                                      ? I.some(
                                          vx.moveToElement(t.previousSibling)
                                        )
    ...
    TN = (e) => {
      ...
      if (e.selection.isCollapsed()) {
        ...
        return qx(o, e.getBody(), r)
          ...
          .map(
            (o) => () =>
              ((e, t) => (n) => (Ip(e, n) ? RN(t) : AN(t)))(n, t)(o).each(ON(e))
          )
      }
      return I.none()
    },
  ...
  const sA = (e, t) => Math.abs(e.left - t),
    ...
    qA = (e, t, n) => {
      ;(MA(e, e.get(t.prefix + '-end'), n),
        MA(e, e.get(t.prefix + '-start'), n))
    },
  ...
  class ST {
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = xT.get(this.id)),
        this.targetElm
      )
    }
    getWin() {
...
!(function () {
  ...
  var n,
    ...
    O = function (t) {
      ...
      for (
        var n, e = g(t), o = d, r = e.length, c = new Array(r), a = 0;
        a < r;
        a++
      ) {
        var i = e[a]
