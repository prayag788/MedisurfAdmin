  ...
  const onSubmit = async e => {
    ...
    if (!pass.length) {
      ...
      try {
        ...
        toast.success(
          <ToastContent
            message={'A password reset link has been sent to your email address. Enjoy!'}
          />,
          {
            position: 'top-center',
            autoClose: 5000,
        ...
        setLoading(prev => false)
        toast.error(<ToastContentForError message={'Email address does not exist'} />, {
          position: 'top-center',
          autoClose: 5000,
          hideProgressBar: false,
          closeOnClick: true,
          ...
          <Col className="d-flex align-items-center auth-bg px-2 p-lg-5" lg="4" sm="12">
            <Col className="px-xl-2 mx-auto" sm="8" md="6" lg="12">
              ...
              <Form className="auth-forgot-password-form mt-2" onSubmit={onSubmit}>
                ...
                <Button.Ripple color="primary" block type="submit" disabled={loading}>
                  {!loading ? 'Send reset link' : <Spinner color="white" size="sm" />}
                </Button.Ripple>
              </Form>
