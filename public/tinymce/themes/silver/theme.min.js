...
!(function () {
  ...
  const an = (e, t, o) => (e.stype === rn.Error ? t(e.serror) : o(e.svalue)),
    ...
    Cn = (e) => ({
      extract: (t, o) =>
        ((e, t) => (e.stype === rn.Error ? t(e.serror) : e))(e(o), (e) =>
          ((e, t) => kn(e, x(t)))(t, e)
        ),
      toString: x('val'),
    }),
        ...
        a = (e) =>
          e.fold(
            ...
            (e) =>
              ((e, t) =>
                e.stype === rn.Value
                  ? { stype: rn.Value, svalue: t(e.svalue) }
      ...
      return {
        extract: (t, n) => {
          ...
          for (const r of e) {
            ...
            if (e.stype === rn.Value)
              return { stype: rn.Value, svalue: o(e.svalue) }
            s.push(e)
          }
          return wn(s)
        },
    ...
    Wn = Cn((e) =>
      Un(e)
        ? dn(e)
        : un('Expected value to be acceptable for sending via postMessage')
    ),
    jn = (e, t) => ({
      extract: (o, n) =>
        be(n, e).fold(
    ...
    qn = (e, t, o) => {
      return (
        (n = ((e, t, o) =>
          ((e, t) =>
            e.stype === rn.Error
              ? { stype: rn.Error, serror: t(e.serror) }
  ...
  const la = (e) => {
    ...
    xa = (e, t) => {
      ...
      return (
        (e.toFunctionAnnotation = () => ({ name: t, parameters: ya(r) })),
        e
      )
    },
    wa = la('alloy-premade'),
    Sa = (e) => (
      Object.defineProperty(e.element.dom, wa, { value: e.uid, writable: !0 }),
      Ms(wa, e)
    ),
    ka = (e) => be(e, wa),
    Ca = (e) =>
      ...
      ((e, t) => {
        ...
        return o.errors.length > 0
          ...
          : ((e, t) =>
              0 === e.length
                ? sn.value(t)
                : sn.value(fn(t, bn.apply(void 0, e))))(o.values, t)
        var n
      })(
        pe(e, (e, o) =>
      ...
      const o = () => m,
        ...
        l = ((e, t, o) => {
          const n = {
            ...(s = e).dom,
            uid: s.uid,
            domChildren: H(s.components, (e) => e.element),
          }
          var s
        ...
        switch (
          be(xi.get(), e)
            .orThunk(() => {
              const t = ae(xi.get())
              return re(t, (t) =>
                e.indexOf(t) > -1 ? A.some(xi.get()[t]) : A.none()
              )
            })
            .getOr(yi.NORMAL)
        ) {
  ...
  const _i = x(Dn(Oi())),
    ...
    Mi = (e, t, o) => (
      (() => {
        ...
        if (void 0 !== e.stack) {
          ...
          G(
            t,
            (e) => e.indexOf('alloy') > 0 && !N(wi, (t) => e.indexOf(t) > -1)
          ).getOr('unknown')
        }
      })(),
      Qn(
    ...
    cl = (e, t, o) =>
      zi(Qi(e, t), ol(e), o.south(), ji(), 'south', Ki(e, { top: 3 }), Ji),
    dl = (e, t, o) =>
      zi(
        ((e) => e.x + e.width)(e),
        nl(e, t),
  ...
  var vl = Object.freeze({
    ...
    yl = [
      ns('channels', $n(sn.value, Mn([Fi('onReceive'), ys('schema', Nn())]))),
    ]
  const xl = (e, t, o) =>
      Zr((n, s) => {
        o(n, e, t)
          ...
          config: (t) => {
            ...
            return {
              ...
              value: {
                config: n,
                me: c,
                configAsRaw: Qt(() => Yn(o + '-config', e, t)),
                initialConfig: t,
                state: a,
              },
            }
  ...
  var Ml = Object.freeze({
    __proto__: null,
    exhibit: (e, t) =>
      Ea({ classes: [], styles: t.useFixed() ? {} : { position: 'relative' } }),
  })
                  ...
                  const a = (t) => {
                      ...
                      const n =
                        null !== (o = t.raw.pseudoElement) && void 0 !== o
                          ...
                          : ''
                      return (
                        Ze(t.target, e) && !De(n) && R(sc, t.raw.propertyName)
                      )
                    },
                    i = (r) => {
                      if (m(r) || a(r)) {
                        ...
                        ;(m(a) || a === or()) &&
                          (clearTimeout(s), Et(e, rc), ja(e, t.classes))
                      }
                    },
                    l = tc(e, nr(), (t) => {
                      a(t) &&
          ...
          const a = n.width,
            ...
            l = (t, l, c, d, u) => {
              ...
              return g.fold(x(g), (e, t, o, n) =>
                (u === n ? o > d || t > c : !u && n) ? g : Yl.nofit(l, c, d, u)
              )
            }
          return j(
            t,
  ...
  const yc = 'data-alloy-vertical-dir',
    xc = (e) =>
      ui(
        e,
        (e) => Ge(e) && Ot(e, 'data-alloy-vertical-dir') === vc.BottomToTop
      ),
    wc = () =>
      vs('layouts', [
        os('onLtr'),
  ...
  const Nc = (e, t, o, n) => ({ start: e, soffset: t, finish: o, foffset: n }),
    ...
    Gc = (e, t, o) =>
      t(Ve(o.startContainer), o.startOffset, Ve(o.endContainer), o.endOffset),
    $c = (e, t) =>
      ((e, t) => {
        const o = ((e, t) =>
          t.match({
  ...
  var hd = [
      ...
      Ri('placement', (e, t, o) => {
        ...
        return A.some(
          hc({ anchorBox: n, bubble: pc(), overrides: t.overrides, layouts: s })
        )
      }),
    ],
    fd = Jn('type', {
  ...
  const bd = [
      ds('classes', Hn),
      ks('mode', 'all', ['all', 'layout', 'placement']),
    ],
  ...
  const Sd = Ol({
    ...
    Wd = (e, t, o) => {
      ;(((e) =>
        N(['top', 'left', 'right', 'bottom'], (t) => Nt(e, t).isSome()))(
        e.element
  ...
  var jd = Object.freeze({
      ...
      isOpen: Pd,
      isPartOf: (e, t, o, n) =>
        Pd(0, 0, o) && o.get().exists((o) => t.isPartOf(e, o, n)),
    ...
    $d = [
      ...
      os('isPartOf'),
      os('getAttachPoint'),
      ys('cloakVisibilityAttr', 'data-precloak-visibility'),
    ],
    qd = Object.freeze({
      __proto__: null,
      init: () => {
  ...
  const Xd = Ol({
    ...
    Zd = Mn([
      ys('isExtraPart', T),
      vs('fireEventInstead', [ys('event', Cr())]),
    ]),
    Qd = (e) => {
  ...
  var du = [
    ...
    gu = [
      xs(
        'store',
        { mode: 'memory' },
        Jn('mode', { memory: mu, manual: uu, dataset: du })
      ),
      Di('onSetValue'),
      ys('resetOnDom', !1),
    ]
            ...
            e.fold(
              ...
              (e) => {
                n[e.pname] = Ou(!0, (t, o, n) => {
                  ...
                  return H(s, (o) =>
                    e.factory.sketch(
                      fn(e.defaults(t, o, n), o, e.overrides(t, o))
                    )
                  )
                })
              }
  ...
  const um = (e, t, o, n, s) => {
    ...
    vm = (e) =>
      (Ye('input')(e) && 'radio' !== Ot(e, 'type')) || Ye('textarea')(e)
  ...
  const xm = [os('find')],
    ...
    Dm = (e, t) =>
      Cm(e, t)
        ? ((e) => Tt(e.element, 'disabled'))(e)
        : ((e) => 'true' === Ot(e.element, 'aria-disabled'))(e)
  var Bm = Object.freeze({
    ...
    Fm = Object.freeze({
      __proto__: null,
      exhibit: (e, t) =>
        Ea({ classes: t.disabled() ? t.disableClass.toArray() : [] }),
  ...
  const Rm = Ol({ fields: Im, name: 'disabling', active: Fm, apis: Bm }),
    ...
    Vm = (e, t, o, n) => {
      ;(Nm(e, t, 0, [n]),
        zm(e, t, o, n) ||
          (La(n.element, t.highlightClass), t.onHighlight(e, n), Fr(n, Dr())))
    },
    zm = (e, t, o, n) => Ua(n.element, t.highlightClass),
    Hm = (e, t, o) =>
      pi(e.element, '.' + t.itemClass).bind((t) =>
        e.getSystem().getByDom(t).toOptional()
      ),
    Lm = (e, t, o) => {
  ...
  var Wm = Object.freeze({
      ...
      dehighlight: (e, t, o, n) => {
        zm(e, t, o, n) &&
          (Pa(n.element, t.highlightClass), t.onDehighlight(e, n), Fr(n, Br()))
      },
      highlight: Vm,
      ...
      highlightAt: (e, t, o, n) => {
        ;((e, t, o, n) => {
          ...
          return A.from(s[n]).fold(
            () => sn.error(new Error('No element found with index ' + n)),
      ...
      getHighlighted: (e, t, o) =>
        pi(e.element, '.' + t.highlightClass).bind((t) =>
          e.getSystem().getByDom(t).toOptional()
        ),
      getFirst: Hm,
      getLast: Lm,
  ...
  const Gm = Ol({ fields: jm, name: 'highlighting', apis: Wm }),
    ...
    ug = (e, t, o) => {
      t.exists((e) => o.exists((t) => Ze(t, e))) ||
        Ir(e, _r(), { prevFocus: t, newFocus: o })
    },
    mg = () => {
  ...
  const hg = (e, t, o, n, s) => {
              ...
              xs(
                ...
                Gn((e) =>
                  R(['onFocus', 'onEnterOrSpace', 'onApi'], e)
                    ? sn.value(e)
                    : sn.error('Invalid value for focusInside')
                )
              ),
              Ri('handler', a),
              Ri('state', t),
    ...
    fg = (e) => {
      const t = [
        ...
        s = (e, t, n, s) => {
          const r = Xc(e.element, n.selector)
          return ((e, t) =>
            t.focusManager.get(e).bind((e) => hi(e, t.selector)))(e, n).bind(
            (t) =>
              $(r, k(Ze, t)).bind((t) =>
                ((e, t, n, s, r) =>
                  r(t, n, (e) =>
        ...
        r = x([
          ...
          dg(ag([cg, rg(Xm)]), (e, t, o) => o.onEnter.bind((o) => o(e, t))),
        ]),
        a = x([dg(rg(Ym), (e, t, o) => o.onEscape.bind((o) => o(e, t)))])
      return hg(t, Oa.init, r, a, () => A.some(n))
    }
  ...
  const yg = (e, t, o) =>
      vm(o) && rg(Km)(t.event)
        ? A.none()
        : ((e, t, o) => (Nr(e, o, ur()), A.some(!0)))(e, 0, o),
    xg = (e, t) => A.some(!0),
    wg = [
      ys('execute', yg),
      ys('useSpace', !1),
      ys('useEnter', !0),
      ys('useControlEnter', !1),
      ys('useDown', !1),
    ],
  ...
  var kg = hg(
    ...
    (e, t, o, n) => {
      ...
      return [dg(rg(i), Sg)].concat(
        o.useControlEnter ? [dg(ag([lg, rg(Xm)]), Sg)] : []
      )
    },
  ...
  const _g = (e) => (t, o, n, s) => {
    ...
    Xg = x([
      ...
      dg(rg(Km.concat(Xm)), (e, t, o, n) =>
        ((e, t) => t.focusManager.get(e).bind((e) => hi(e, t.selector)))(
          e,
          o
  ...
  const Jg = (e, t, o, n, s) => {
      const r = (e, t, o) =>
        s(e, t, n, 0, o.length - 1, o[t], (t) => {
          return (
            (n = o[t]),
            'button' === Ue(n) && 'disabled' === Ot(n, 'disabled')
              ? r(e, t, o)
              : A.from(o[t])
          )
          var n
    ...
    rp = (e) => (t, o, n, s) =>
      e(t, o, n, s).bind(() => (n.executeOnMove ? tp(t, o, n) : A.some(!0))),
    ap = x([dg(rg(Km), xg), dg(rg(Ym), (e, t, o) => o.onEscape(e, t))])
  var ip = hg(
    ep,
    Oa.init,
    (e, t, o, n) => {
      const s = [...(o.allowHorizontal ? Jm : [])].concat(
          o.allowVertical ? Zm : []
        ),
  ...
  const lp = (e, t, o) =>
    ...
    xp = x([
      ...
      dg(rg(Zm), Dg(vp)),
      dg(rg(eg), Bg(yp)),
      dg(rg(Km.concat(Xm)), (e, t, o) =>
        Rl(e.element).bind((n) => o.execute(e, t, n))
      ),
    ]),
    wp = x([dg(rg(Km), xg)])
  ...
  const kp = [os('selector'), ys('execute', yg), ys('moveOnTab', !1)],
    ...
    Ep = x([
      dg(rg(Zm), Fg(_p)),
      dg(rg(eg), Fg(Tp)),
      dg(ag([ig, rg(qm)]), (e, t, o, n) =>
        o.moveOnTab ? Fg(_p)(e, t, o, n) : A.none()
      ),
      dg(ag([cg, rg(qm)]), (e, t, o, n) =>
        o.moveOnTab ? Fg(Tp)(e, t, o, n) : A.none()
      ),
      dg(rg(Xm), Cp),
      dg(rg(Km), Cp),
    ]),
    ...
    Wp = (e, t) => {
      Nl(() => {
        ;((o, n, s) => {
          ...
          const i = ((e, t, o) => Ya(e, t, (t, n) => Ka(e, n, t, o)))(
              e.element,
              t,
    ...
    xs(
      ...
      Jn('mode', {
        pressed: [
          ...
          Ri('update', (e, t, o) => {
            ;(kt(e.element, 'aria-pressed', o),
              t.syncWithExpanded && lh(e, 0, o))
          }),
        ],
        checked: [
          Ri('update', (e, t, o) => {
  ...
  const uh = () => {
    ...
    fh = (e) => {
      ;(Rl(e.element).isNone() || oh.isFocused(e)) &&
        (oh.isFocused(e) || oh.focus(e), Ir(e, gh, { item: e }))
    },
    bh = (e) => {
      Ir(e, ph, { item: e })
    },
      ...
      factory: (e, t) => {
        const o = Ql(),
          ...
          c = (t, o, n) => {
            ...
            L(s, (o) => {
              ;(ja(o.element, [e.markers.backgroundMenu]),
                e.stayInDom || Kp.remove(t, o))
            })
          },
          d = (t, n) => {
            const r = ((t) =>
        ...
        return {
          ...
          behaviours: bu(e.tmenuBehaviours, [
            Pp.config({
              mode: 'special',
              onRight: h((e, t) =>
                vm(t.element) ? A.none() : g(e, t, m.HighlightSubmenu)
              ),
    ...
    Ph = fm({
      ...
      factory: (e, t) => {
        const o = (t, o, n, s) => {
            ...
            ;(Xd.openWhileCloaked(t, o, () =>
              Sd.positionWithinBounds(r, t, n, s())
            ),
              pu.setValue(
                t,
        ...
        return {
          ...
          behaviours: bu(e.inlineBehaviours, [
            Xd.config({
              isPartOf: (t, o, n) =>
                vi(o, n) ||
                ((t, o) => e.getRelated(t).exists((e) => vi(e, o)))(t, n),
  ...
  const Wh = fm({
      ...
      factory: (e) => {
        ...
        return {
          ...
          components: e.components,
          events: t,
          behaviours: yu(e.buttonBehaviours, [
            oh.config({}),
    ...
    jh = (e) => {
      const t =
        ((e) => void 0 !== e.uid)(e) && ye(e, 'uid') ? e.uid : ha('memento')
      return {
      ...
      factory: (e) => {
        const t = jh({
          ...
          a = q([
            e.icon.toArray(),
            e.level.toArray(),
            e.level.bind((e) => A.from(tf[e])).toArray(),
          ]),
          i = jh(
            Wh.sketch({
              dom: {
  ...
  const cf = (e) => (t) => t.options.get(e),
    ...
    $f = cf('sidebar_show'),
    qf = cf('promotion'),
    Xf = (e) => !1 === e.options.get('skin'),
    Yf = (e) => !1 !== e.options.get('menubar'),
    Kf = (e) => {
    ...
    Jf = (e) => e.options.get('line_height_formats').split(' '),
    Zf = (e) => {
      const t = Bf(e),
        o = r(t),
        n = l(t) && t.length > 0
    ...
    nb = (e) => e.inline && ob(e).isSome(),
    sb = (e) => ob(e).getOrThunk(() => ft(ht(Ve(e.getElement())))),
    rb = (e) => e.inline && !Yf(e) && !Zf(e) && !eb(e),
    ab = (e) =>
      (e.options.get('toolbar_sticky') || e.inline) && !nb(e) && !rb(e),
    ib = (e) => !nb(e) && 'split' === e.options.get('ui_mode'),
    lb = (e) => {
  ...
  var cb = Object.freeze({
    ...
    getLineHeightFormats: Jf,
    getContentLanguages: Sf,
    getRemovedMenuItems: kf,
    isMenubarEnabled: Yf,
    isMultipleToolbars: eb,
    isToolbarEnabled: Zf,
    isToolbarPersist: Af,
    getMultipleToolbarsOption: Qf,
    getUiContainer: sb,
    useFixedContainer: nb,
    isSplitUiMode: ib,
    getToolbarMode: Cf,
    isDraggableModal: Lf,
    isDistractionFree: rb,
    isStickyToolbar: ab,
    getStickyToolbarOffset: Mf,
    getToolbarLocation: _f,
    isToolbarLocationBottom: tb,
    getToolbarGroups: Of,
    getMenus: lb,
    getMenubar: Df,
    getToolbar: Bf,
  ...
  const db = '[data-mce-autocompleter]',
    ub = (e) => hi(e, db)
  var mb
  !(function (e) {
  ...
  var gb = mb
  const pb = 'tox-menu-nav__js',
    hb = 'tox-collection__item',
    fb = 'tox-swatch',
    bb = { normal: pb, color: fb },
    vb = 'tox-collection__item--enabled',
    yb = 'tox-collection__item-icon',
    xb = 'tox-collection__item-label',
    wb = 'tox-collection__item-caret',
    Sb = 'tox-collection__item--active',
    kb = 'tox-collection__item-container',
    Cb = 'tox-collection__item-container--row',
    Ob = (e) => be(bb, e).getOr(pb),
    _b = (e) => ('color' === e ? 'tox-swatches' : 'tox-menu'),
    Tb = (e) => ({
    ...
    Vb = la('refetch-trigger-event'),
    zb = la('redirect-menu-item-interaction'),
    Hb = 'tox-menu__searcher',
    Lb = (e) =>
      pi(e.element, `.${Hb}`).bind((t) =>
        e.getSystem().getByDom(t).toOptional()
      ),
    Pb = Lb,
    Ub = (e) => ({
    ...
    Wb = (e) => {
      const t = (e, t) => (t.cut(), A.none()),
        o = (e, t) => {
          ...
          return (Ir(e, zb, o), A.some(!0))
        },
        n = 'searcher-events'
      return {
        dom: { tag: 'div', classes: [hb] },
        components: [
          Nb.sketch({
            inputClasses: [Hb, 'tox-textfield'],
            inputAttributes: {
              ...e.placeholder
    ...
    Xb = (e, t, o) =>
      Dh.parts.items({
        preprocess: (n) => {
          const s = H(n, o)
          return 'auto' !== e && e > 1
            ? $b({ tag: 'div', classes: ['tox-collection__group'] }, e)(s)
            : qb(s, (e, o) => 'separator' === t[o].type)
        },
      }),
    Yb = (e, t, o = !0) => ({
      dom: {
    ...
    Kb = (e) => N(e, (e) => 'icon' in e && void 0 !== e.icon),
    Jb = (e) => (console.error(Kn(e)), console.log(e), A.none()),
    Zb = (e, t, o, n, s) => {
      const r =
        ((a = o),
        {
          ...
          components: [
            Dh.parts.items({
              preprocess: (e) => qb(e, (e, t) => 'separator' === a[t].type),
            }),
          ],
        })
      var a
    ...
    Qb = (e, t, o, n, s) => {
          ...
          components: [
            {
              ...
              components: [
                Dh.parts.items({
                  preprocess:
                    'auto' !== e
                      ? $b({ tag: 'div', classes: ['tox-swatches__row'] }, e)
                      : w,
                }),
              ],
            },
            ...
            : 'search-with-field' === s.searchMode.searchMode
              ? ((e, t, o) => {
                  ...
                  return {
                    ...
                    components: [
                      Wb({ i18n: Gh.translate, placeholder: o.placeholder }),
                      {
                        dom: {
                          tag: 'div',
                          classes: [
              ...
              : ((e, t, o = !0) => {
                  ...
                  return {
                    dom: {
                      tag: 'div',
                      classes: ['tox-menu', 'tox-collection', jb].concat(
                        1 === e
                          ? ['tox-collection--list']
                          : ['tox-collection--grid']
                      ),
      ...
      return { value: e, dom: Ab(t, n, s.menuType), components: Mb, items: o }
    },
    ev = rs('type'),
    tv = rs('name'),
    ov = rs('label'),
    ...
    Ev = Dn([ev, gv]),
    Av = Dn([_v('autocompleteitem'), yv, wv, Cv, av, gv, pv]),
    Mv = [wv, hv, pv, gv, uv],
    Dv = Dn([ev, cv].concat(Mv)),
    Bv = (e) => qn('toolbarbutton', Dv, e),
    Fv = [yv].concat(Mv),
    Iv = Dn(Fv.concat([ev, cv])),
    Rv = (e) => qn('ToggleButton', Iv, e),
    Nv = [
      Os('predicate', T),
      ks('scope', 'node', ['node', 'editor']),
      ks('position', 'selection', ['node', 'selection', 'line']),
    ],
    Vv = Mv.concat([_v('contextformbutton'), Sv, cv, es('original', w)]),
    zv = Fv.concat([_v('contextformbutton'), Sv, cv, es('original', w)]),
    Hv = Mv.concat([_v('contextformbutton')]),
    Lv = Fv.concat([_v('contextformtogglebutton')]),
    Pv = Jn('type', { contextformbutton: Vv, contextformtogglebutton: zv }),
    Uv = Dn(
      [
        _v('contextform'),
        Os('initValue', x('')),
        ...
        ms(
          'launch',
          Jn('type', { contextformbutton: Hv, contextformtogglebutton: Lv })
        ),
      ].concat(Nv)
    ),
    Wv = Dn([_v('contexttoolbar'), rs('items')].concat(Nv)),
    jv = [ev, rs('src'), ps('alt'), _s('classes', [], Hn)],
    Gv = Dn(jv),
    $v = [ev, nv, mv, _s('classes', ['tox-collection__item-label'], Hn)],
    qv = Dn($v),
    Xv = En(() =>
      jn('type', { cardimage: Gv, cardtext: qv, cardcontainer: Yv })
    ),
    Yv = Dn([
      ev,
  ...
  const Jv = Dn([ev, fv, ds('items', Xv), uv, Ov].concat(Kv)),
    Zv = Dn([ev, yv, pv].concat(Kv)),
    Qv = [ev, rs('fancytype'), Ov],
    ey = [ys('initData', {})].concat(Qv),
    ty = [
      fs('select'),
      Ts('initData', {}, [
        Cs('allowCustomColors', !0),
        Ss('storageKey', 'default'),
        bs('colors', Nn()),
      ]),
    ].concat(Qv),
    oy = Jn('fancytype', { inserttable: ey, colorswatch: ty }),
    ny = Dn([ev, uv, Ov, pv].concat(Kv)),
    sy = Dn([ev, lv, uv, pv].concat(Kv)),
    ry = Dn([ev, pv, yv, uv, cv].concat(Kv)),
    ay = (e, t, o) => {
    ...
    iy = (e) => ((e, t) => kl([Jp(e, t)]))(la('unnamed-events'), e),
    ly = la('tooltip.exclusive'),
    cy = la('tooltip.show'),
    dy = la('tooltip.hide'),
    uy = (e, t, o) => {
      e.getSystem().broadcastOn([ly], {})
    }
        ...
        return Hr(
          q([
            [
                  ...
                  ;((o) => {
                    if (!t.isShowing()) {
                      ...
                      ;(t.setTooltip(s),
                        Ad(n, s),
                        e.onShow(o, s),
                        Sd.position(n, s, { anchor: e.anchor(o) }))
                    }
                  })(o)
                }, e.delay)
              }),
              ...
              Ur(dr(), (e, t) => {
                const n = t
                n.universal || (R(n.channels, ly) && o(e))
              }),
              Jr((e) => {
                o(e)
              }),
  ...
  const yy = (e, t) => {
      ...
      ;(t &&
        ...
        L(n, (e) => {
          e.broadcastOn([by], { readonly: t })
        }))
    },
    xy = (e, t) => {
      ;(e.on('init', () => {
        e.mode.isReadOnly() && yy(t, !0)
      }),
        e.on('SwitchMode', () => yy(t, e.mode.isReadOnly())),
    ...
    Sy = (e) => Rm.config({ disabled: e }),
    ky = (e) => Rm.config({ disabled: e, disableClass: 'tox-tbtn--disabled' }),
    Cy = (e) =>
      Rm.config({
        disabled: e,
    ...
    Ty = (e, t) => Jr((o) => Oy(e, o)(t.get())),
    Ey = (e, t) =>
      Qr((o, n) => {
        ;(Oy(e, o)(e.onAction),
          e.triggersSubmenu ||
            t !== gb.CLOSE_ON_EXECUTE ||
            (o.getSystem().isConnected() && Fr(o, hr()), n.stop()))
      }),
    Ay = {
      [ur()]: ['disabling', 'alloy.base.behaviour', 'toggling', 'item-events'],
    },
    My = we,
    Dy = (e, t, o, n) => {
      const s = Es(b)
      return {
        type: 'item',
        dom: t.dom,
        components: My(t.optComponents),
        data: e.data,
        eventOrder: Ay,
        hasSubmenu: e.triggersSubmenu,
        itemBehaviours: kl(
          [
            Jp('item-events', [Ey(e, o), _y(e, s), Ty(e, s)]),
    ...
    Iy = (e, t, o = [yb]) => ef(e, { tag: 'div', classes: o }, t),
    Ry = (e) => ({
      dom: { tag: 'div', classes: [xb] },
      components: [ti(Gh.translate(e))],
    }),
    Ny = (e, t) => ({ dom: { tag: 'div', classes: t, innerHtml: e } }),
    Vy = (e, t) => ({
      dom: { tag: 'div', classes: [xb] },
      components: [
        {
    ...
    Hy = (e) => Iy('checkmark', e, ['tox-collection__item-checkmark']),
    Ly = (e) => {
      const t = e
        .map((e) => ({
          attributes: { title: Gh.translate(e), id: la('menu-item') },
        }))
        .getOr({})
      return { tag: 'div', classes: [pb, hb], ...t }
    },
    Py = (e, t, o, n = A.none()) =>
      'color' === e.presets
        ? ((e, t, o) => {
        ...
        : ((e, t, o, n) => {
            const s = { tag: 'div', classes: [yb] },
              r = o
                ? e.iconContent
                    .map((e) => ef(e, s, t.icons, n))
                    .orThunk(() => A.some({ dom: s }))
                : A.none(),
              a = e.checkMark,
              i = A.from(e.meta).fold(
                () => Ry,
                (e) => (ve(e, 'style') ? k(Vy, e.style) : Ry)
              ),
            ...
            return {
              dom: Ly(e.ariaLabel),
              optComponents: [r, l, e.shortcutContent.map(zy), a, e.caret],
            }
          })(e, t, o, n),
    Uy = (e, t) =>
      be(e, 'tooltipWorker')
        .map((e) => [
          fy.config({
            ...
            anchor: (e) => ({
              type: 'submenu',
              item: e,
              overrides: { maxHeightFunction: cc },
            }),
            mode: 'follow-highlight',
            onShow: (t, o) => {
              e((e) => {
                fy.setComponents(t, [oi({ element: Ve(e) })])
              })
            },
          }),
        ])
      ...
      H(e, (e) => {
        switch (e.type) {
          ...
          case 'cardtext':
            ...
            return Ny(Wy(e.text, n), e.classes)
        }
      }),
    Gy = Yu(Ch(), Oh()),
    $y = (e) => ({ value: Ky(e) }),
    qy = /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
    Xy = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i,
    Yy = (e) => qy.test(e) || Xy.test(e),
    Ky = (e) => _e(e, '#').toUpperCase(),
    Jy = (e) => {
      const t = e.toString(16)
      return (1 === t.length ? '0' + t : t).toUpperCase()
    },
    Zy = (e) => {
      const t = Jy(e.red) + Jy(e.green) + Jy(e.blue)
      return $y(t)
    },
    Qy = Math.min,
    ex = Math.max,
    tx = Math.round,
    ox = /^\s*rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)\s*$/i,
    nx =
      /^\s*rgba\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d?(?:\.\d+)?)\s*\)\s*$/i,
    sx = (e, t, o, n) => ({ red: e, green: t, blue: o, alpha: n }),
    rx = (e) => {
    ...
    ax = (e) => {
      ...
      let r = e.saturation / 100,
        a = e.value / 100
      if (((r = ex(0, Qy(r, 1))), (a = ex(0, Qy(a, 1))), 0 === r))
        return ((t = o = n = tx(255 * a)), sx(t, o, n, 1))
      const i = s / 60,
        l = a * r,
    ...
    cx = (e) => {
      if ('transparent' === e) return A.some(sx(0, 0, 0, 0))
      const t = ox.exec(e)
      if (null !== t) return A.some(lx(t[1], t[2], t[3], '1'))
      const o = nx.exec(e)
      return null !== o ? A.some(lx(o[1], o[2], o[3], o[4])) : A.none()
    },
    dx = (e) => `rgba(${e.red},${e.green},${e.blue},${e.alpha})`,
    ux = sx(255, 0, 0, 1),
    mx = (e, t) => {
    ...
    xx = (e, t) => () => e.execCommand(t)
  var wx = tinymce.util.Tools.resolve('tinymce.util.LocalStorage')
  const Sx = {},
    kx = (e) =>
      be(Sx, e).getOrThunk(() => {
        const t = `tinymce-custom-colors-${e}`,
          o = wx.getItem(t)
        if (m(o)) {
          const e = wx.getItem('tinymce-custom-colors')
          wx.setItem(t, g(e) ? e : '[]')
        }
        const n = ((e, t = 10) => {
          const o = wx.getItem(e),
            n = r(o) ? JSON.parse(o) : [],
    ...
    Ox = (e, t, o) => ({ hue: e, saturation: t, value: o }),
    _x = (e) => {
      let t = 0,
        o = 0,
        n = 0
      ...
      return i === l
        ...
        : ((t = s === i ? 3 : a === i ? 1 : 5),
          ...
          (o = (l - i) / l),
          (n = l),
          Ox(Math.round(t), Math.round(100 * o), Math.round(100 * n)))
    },
    Tx = (e) => Zy(ax(e)),
    Ex = (e) => {
      return ((t = e), Yy(t) ? A.some({ value: Ky(t) }) : A.none())
        .orThunk(() => cx(e).map(Zy))
        .getOrThunk(() => {
          ...
          const n = o.getImageData(0, 0, 1, 1).data,
            ...
            a = n[2],
            i = n[3]
          return Zy(sx(s, r, a, i))
        })
      var t
    },
    Ax = 'forecolor',
    Mx = 'hilitecolor',
    Dx = (e) => Math.max(5, Math.ceil(Math.sqrt(e))),
    Bx = (e, t) => {
      const o = Dx(t),
        n = Ix('color_cols')(e)
      return 5 !== n ? n : o
    ...
    Vx = Ix('custom_colors'),
    zx = (e, t) =>
      t === Ax && e.options.isSet('color_map_foreground')
        ? Ix('color_map_foreground')(e)
        : t === Mx && e.options.isSet('color_map_background')
          ? Ix('color_map_background')(e)
          : Ix('color_map')(e),
    Hx = Ix('color_default_foreground'),
    Lx = Ix('color_default_background'),
    Px = (e, t) => {
    ...
    Wx = (e, t, o, n) => {
      'custom' === o
        ? Kx(e)((o) => {
            o.each((o) => {
              ;(Cx(t, o), e.execCommand('mceApplyTextcolor', t, o), n(o))
            })
          }, Px(e, t).getOr(Rx))
        : 'remove' === o
    ...
    Xx = (e, t, o, n, s) => {
      e.ui.registry.addSplitButton(t, {
        ...
        select: qx(e, o),
        columns: Nx(e, o),
        fetch: Gx(zx(e, o), o, Vx(e)),
        onAction: (t) => {
          Wx(e, o, s.get(), b)
        },
        onItemAction: (n, r) => {
          Wx(e, o, r, (o) => {
            ;(s.set(o), gx(e, { name: t, color: o }))
          })
        },
        onSetup: (o) => {
          $x(o, t, s.get())
          const n = (e) => {
            e.name === t && $x(o, e.name, e.color)
          }
          return (
    ...
    Jx = (e, t, o, n, s, r, a, i) => {
      const l = Kb(t),
        c = Zx(t, o, n, 'color' !== s ? 'normal' : 'color', r, a, i)
      return Qb(e, l, c, n, { menuType: s })
    },
    Zx = (e, t, o, n, s, r, a) =>
      we(
        H(e, (i) => {
          return 'choiceitem' === i.type
            ? ((l = i), qn('choicemenuitem', Zv, l)).fold(Jb, (i) =>
                A.some(
                  ((e, t, o, n, s, r, a, i = !0) => {
                    const l = Py(
                      {
                        ...
                        checkMark: t ? A.some(Hy(a.icons)) : A.none(),
                        caret: A.none(),
                        value: e.value,
                      },
                      a,
      ...
      return 1 === e
        ...
        : 'auto' === e
          ...
          : {
              ...
              previousSelector: (e) =>
                'color' === t ? pi(e.element, '[aria-checked=true]') : A.none(),
            }
    },
    ew = la('cell-over'),
    tw = la('cell-execute'),
    ow = (e, t, o) => {
      const n = (o) => Ir(o, tw, { row: e, col: t }),
        s = (e, t) => {
          ;(t.stop(), n(e))
        }
      return ri({
        ...
        behaviours: kl([
          ...
          oh.config({ onFocus: (o) => Ir(o, ew, { row: e, col: t }) }),
        ]),
      })
    },
    nw = (e) => X(e, (e) => H(e, ai)),
    ...
    rw = {
      inserttable: (e) => {
        const t = la('size-label'),
          o = ((e, t, o) => {
            ...
            for (let t = 0; t < 10; t++) {
              const o = []
              for (let n = 0; n < 10; n++) o.push(ow(t, n, e))
              n.push(o)
            }
            return n
          })(t),
        ...
        return {
          ...
          components: [
            Gy.widget({
              ...
              components: nw(o).concat(s.asSpec()),
              behaviours: kl([
                Jp('insert-table-picker', [
                  ...
                  $r(ew, (e, t, n) => {
                    ...
                    ;(((e, t, o, n, s) => {
                      for (let n = 0; n < 10; n++)
                        for (let s = 0; s < 10; s++)
                          dh.set(e[n][s], n <= t && s <= o)
                    })(o, r, a),
                      Kp.set(s.get(e), [sw(r + 1, a + 1)]))
                  }),
                  $r(tw, (t, o, n) => {
      ...
      colorswatch: (e, t) => {
        ...
        return {
          ...
          dom: { tag: 'div', classes: ['tox-fancymenuitem'] },
          autofocus: !0,
          components: [Gy.widget(Dh.sketch(r))],
        }
      },
    },
    aw = (e) => ({
      type: 'separator',
      dom: { tag: 'div', classes: [hb, 'tox-collection__group-heading'] },
  ...
  const dw = Ol({ fields: lw, name: 'coupling', apis: iw, state: cw }),
    uw = (e) => {
      let t = A.none(),
        o = []
      const n = (e) => {
    ...
    pw = (e) => {
      ...
      return {
        map: (t) => pw(() => e().then(t)),
        bind: (t) => pw(() => e().then((e) => t(e).toPromise())),
        anonBind: (t) => pw(() => e().then(() => t.toPromise())),
        toLazy: () => mw.nu(t),
        toCached: () => {
          let t = null
          return pw(() => (null === t && (t = e()), t))
        },
        toPromise: e,
        get: t,
      }
    },
    hw = (e) => pw(() => new Promise(e)),
    fw = (e) => pw(() => Promise.resolve(e)),
    bw = x('sink'),
    vw = x(
      ju({
        name: bw(),
          ...
          e.bind((e) =>
            A.from(
              Lh.sketch({
                ...
                onOpenSubmenu: (e, t, o) => {
                  const n = l().getOrDie()
                  ;(Sd.position(n, o, { anchor: { type: 'submenu', item: t } }),
                    Xd.decloak(s))
                },
                onRepositionMenu: (e, t, n) => {
                  const s = l().getOrDie()
    ...
    ww = (e, t, o, n, s, r, a) => (Xd.close(n), fw(n)),
    Sw = (e, t, o, n, s, r) => {
      const a = dw.getCoupled(o, 'sandbox')
      return (Xd.isOpen(a) ? ww : xw)(e, t, o, a, n, s, r)
    },
    kw = (e, t) =>
      e
        .getSystem()
    ...
    Ow = (e, t, o) => {
      ...
      return {
        ...
        behaviours: yu(e.sandboxBehaviours, [
          ...
          wm.config({
            find: (e) => Xd.getState(e).bind((e) => wm.getCurrent(e)),
          }),
          Al.config({
            channels: {
              ...Qd({ isExtraPart: T }),
    ...
    _w = (e) => {
      const t = dw.getCoupled(e, 'sandbox')
      Cw(t)
    },
    Tw = () => [
      ys('sandboxClasses', []),
      vu('sandboxBehaviours', [wm, Al, Xd, pu]),
    ],
    Ew = x(
      [
        os('dom'),
        ...
        wc(),
        hu('dropdownBehaviours', [dh, dw, Pp, oh]),
        os('toggleClass'),
        ys('eventOrder', {}),
        us('lazySink'),
        ys('matchWidth', !1),
      ...
      factory: (e, t, o, n) => {
        const s = (e) => {
          ...
          a = {
            ...
            refetch: (t) =>
              dw.getExistingCoupled(t, 'sandbox').fold(
                () => r(t, b, zh.HighlightMenuAndItem).map(b),
                (o) => xw(e, w, t, o, n, b, zh.HighlightMenuAndItem).map(b)
              ),
            isOpen: dh.isOn,
            close: (e) => {
              dh.isOn(e) && r(e, b, zh.HighlightMenuAndItem).get(b)
        ...
        return {
          ...
          behaviours: bu(e.dropdownBehaviours, [
            ...
            Pp.config({
              ...
              onEscape: (e, t) =>
                Mw.isOpen(e) ? (Mw.close(e), A.some(!0)) : A.none(),
            }),
            oh.config({}),
          ]),
          events: mh(
          ...
          eventOrder: {
            ...e.eventOrder,
            [ur()]: ['disabling', 'toggling', 'alloy.base.behaviour'],
          },
          apis: a,
          domModification: {
            attributes: {
    ...
    Dw = (e, t, o) => {
      ;(Pb(e).each((e) => {
        var n
        ;(((e, t) => {
          _t(t.element, 'id').each((t) =>
            kt(e.element, 'aria-activedescendant', t)
          )
        })(e, o),
          (Ua((n = t).element, jb)
            ? A.some(n.element)
  ...
  const Rw = (e, t, o, n, s) => {
      ...
      switch (e.type) {
        case 'menuitem':
          return ((i = e), qn('menuitem', ny, i)).fold(Jb, (e) =>
            A.some(
              ((e, t, o, n = !0) => {
                const s = Py(
                  {
        ...
        case 'nestedmenuitem':
          return ((e) => qn('nestedmenuitem', sy, e))(e).fold(Jb, (e) =>
            A.some(
              ((e, t, o, n = !0, s = !1) => {
                const r = s
                  ? ((a = o.icons), Iy('chevron-down', a, [wb]))
                  : ((e) => Iy('chevron-right', e, [wb]))(o.icons)
                var a
                const i = Py(
                  {
                    presets: 'normal',
        ...
        case 'togglemenuitem':
          return ((e) => qn('togglemenuitem', ry, e))(e).fold(Jb, (e) =>
            A.some(
              ((e, t, o, n = !0) => {
                const s = Py(
                  {
        ...
        case 'separator':
          return ((e) => qn('separatormenuitem', Ev, e))(e).fold(Jb, (e) =>
            A.some(aw(e))
          )
        case 'fancymenuitem':
          return ((e) => qn('fancymenuitem', oy, e))(e).fold(Jb, (e) =>
            ((e, t) => be(rw, e.fancytype).map((o) => o(e, t)))(e, o)
          )
        default:
    ...
    Nw = (e, t, o, n, s, r, a) => {
      ...
      return we(
        H(e, (e) => {
          switch (e.type) {
            case 'separator':
              return ((n = e), qn('Autocompleter.Separator', Ev, n)).fold(
                Jb,
                (e) => A.some(aw(e))
              )
            case 'cardmenuitem':
              return ((e) => qn('cardmenuitem', Jv, e))(e).fold(Jb, (e) =>
                A.some(
                  ((e, t, o, n) => {
                    const s = {
                      dom: Ly(e.label),
                      optComponents: [
                        A.some({
                          dom: { tag: 'div', classes: [kb, Cb] },
                          components: jy(e.items, n),
                        }),
                      ],
                    }
                    return Dy(
                      {
                        data: By({ text: A.none(), ...e }),
                        enabled: e.enabled,
                        getApi: (e) => ({
                          isEnabled: () => !Rm.isDisabled(e),
                          setEnabled: (t) => {
            ...
            default:
              return ((e) => qn('Autocompleter.Item', Av, e))(e).fold(Jb, (e) =>
                A.some(
                  ((e, t, o, n, s, r, a, i = !0) => {
                    const l = Py(
                      {
                        presets: n,
                        textContent: A.none(),
                        htmlContent: o ? e.text.map((e) => Wy(e, t)) : A.none(),
                        ariaLabel: e.text,
                        iconContent: e.icon,
    ...
    Vw = (e, t, o, n, s, r) => {
      ...
      return (s ? Zb : Qb)(e, a, i, 1, l)
    },
    zw = (e) => Lh.singleData(e.value, e),
    Hw = (e, t) => {
      const o = Es(!1),
        n = Es(!1),
        s = ri(
          Ph.sketch({
            ...
            inlineBehaviours: kl([
              Jp('dismissAutocompleter', [Ur(Cr(), () => c())]),
            ]),
            lazySink: t.getSink,
          })
        ),
                  ...
                  Ph.showMenuAt(
                    ...
                    ((e, t, o, n) => {
                      ...
                      return {
                        ...
                        menu: {
                          markers: Eb(n),
                          fakeFocus: o === Iw.ContentFocus,
                        },
                      }
                    })(
                      Qb('autocompleter-value', !0, o, r, {
                        menuType: 'normal',
                      }),
                      r,
                      Iw.ContentFocus,
              ...
              },
              {
                ...
                value: (s) => (
                  ...
                  t
                    ...
                    .map((t) =>
                      o.get() ? (s.prevent(), !1) : e.triggerEvent(gr(), s)
                    )
                ),
              },
            ])
          ...
          o.triggerEvent('keydown', e)
            ...
            : o.stopBackspace &&
              ((e) =>
                ...
                !jw(e.target, '[contenteditable="true"]'))(e) &&
              e.prevent()
        }),
        l = tc(e, 'focusin', (e) => {
    ...
    Yw = As([{ stopped: [] }, { resume: ['element'] }, { complete: [] }]),
    Kw = (e, t, o, n, s, r) => {
      const a = e(t, n),
        i = ((e, t) => {
          const o = Es(!1),
      ...
      return a.fold(
        () => (r.logEventNoHandlers(t, n), Yw.complete()),
        (e) => {
          const o = e.descHandler
          return (
            Aa(o)(i),
            i.isStopped()
              ? (r.logEventStopped(t, e.element, o.purpose), Yw.stopped())
              : i.isCut()
                ? (r.logEventCut(t, e.element, o.purpose), Yw.complete())
                : st(e.element).fold(
                    () => (
    ...
    Jw = (e, t, o, n, s, r) =>
      Kw(e, t, o, n, s, r).fold(E, (n) => Jw(e, t, o, n, s, r), T),
    Zw = (e, t, o, n, s) => {
      const r = Xw(o, n)
      return Jw(e, t, o, n, r, s)
    },
    Qw = () => {
      const e = (() => {
          const e = {}
    ...
    tS = (e) => {
      const t = (t) => st(e.element).fold(E, (e) => Ze(t, e)),
        ...
        s = qw(e.element, {
          triggerEvent: (e, t) =>
            Si(e, t.target, (o) =>
              ((e, t, o, n) => Zw(e, t, o, o.target, n))(n, e, t, o)
            ),
        }),
        r = {
          debugInfo: x('real'),
          triggerEvent: (e, t, o) => {
            Si(e, t, (s) => Zw(n, e, o, t, s))
          },
          triggerFocus: (e, t) => {
            pa(e).fold(
              () => {
        ...
        a = (e) => {
          ;(e.connect(r),
            $e(e.element) ||
              (o.register(e),
              L(e.components(), a),
              r.triggerEvent(br(), e.element, { target: e.element })))
        },
        i = (e) => {
          ;($e(e.element) || (L(e.components(), i), o.unregister(e)),
            e.disconnect())
        },
        l = (t) => {
          Ad(e, t)
    ...
    oS = x([ys('prefix', 'form-field'), hu('fieldBehaviours', [wm, pu])]),
    nS = x([
              ...
              n.field().each((t) => {
                ...
                ;(n.label().each((e) => {
                  ...
                  n['aria-descriptor']().each((o) => {
                    const n = la(e.prefix)
                    ;(kt(o.element, 'id', n),
                      kt(t.element, 'aria-describedby', n))
                  }))
              })
            }),
          ]),
          a = {
            getField: (t) => om(t, e, 'field'),
            getLabel: (t) => om(t, e, 'label'),
          }
        return {
          uid: e.uid,
          dom: e.dom,
  ...
  var rS = Object.freeze({
      __proto__: null,
      exhibit: (e, t) =>
        Ea({ attributes: Ds([{ key: t.tabAttr, value: 'true' }]) }),
    }),
    aS = [ys('tabAttr', 'data-alloy-tabstop')]
  const iS = Ol({ fields: aS, name: 'tabstopping', active: rS })
  var lS = tinymce.util.Tools.resolve('tinymce.html.Entities')
  const cS = (e, t, o, n) => {
      const s = dS(e, t, o, n)
      return sS.sketch(s)
    },
    ...
    uS = (e) => ({ tag: 'div', classes: ['tox-form__group'].concat(e) }),
    mS = (e, t) =>
      sS.parts.label({
        dom: { tag: 'label', classes: ['tox-label'] },
        components: [ti(t.translate(e))],
      }),
    gS = la('form-component-change'),
    pS = la('form-close'),
    hS = la('form-cancel'),
    fS = la('form-action'),
    bS = la('form-submit'),
    ...
    CS = (e, t) => {
      ...
      ;(Pa(o, t.invalidClass),
        t.notify.each((t) => {
          ;(kS(e.element) && kt(e.element, 'aria-invalid', !1),
    ...
    OS = (e, t, o, n) => {
      ...
      ;(La(s, t.invalidClass),
        t.notify.each((t) => {
          ;(kS(e.element) && kt(e.element, 'aria-invalid', !0),
            t.getContainer(e).each((e) => {
              ta(e, n)
            }),
            t.onInvalid(e, n))
  ...
  const DS = Ol({
    ...
    FS = la('color-input-change'),
    IS = la('color-swatch-change'),
    RS = la('color-picker-cancel'),
    NS = ju({ schema: [os('dom')], name: 'label' }),
    VS = (e) =>
      ju({
        name: e + '-edge',
        overrides: (t) =>
  ...
  const $S = x('slider.change.value'),
    ...
    ck = (e) => e.snapStart,
    dk = (e) => e.rounded,
    uk = (e, t) => void 0 !== e[t + '-edge'],
    mk = (e) => uk(e, 'left'),
    gk = (e) => uk(e, 'right'),
    pk = (e) => uk(e, 'top'),
    hk = (e) => uk(e, 'bottom'),
    fk = (e) => e.model.value.get(),
    bk = (e, t) => ({ x: e, y: t }),
    vk = (e, t) => {
      Ir(e, $S(), { value: t })
    },
    ...
    wk = (e, t, o) => Math.max(t, Math.min(o, e)),
    Sk = (e) => {
      const {
          min: t,
          max: o,
    ...
    _k = 'bottom',
    Tk = 'left',
    Ek = (e) => e.element.dom.getBoundingClientRect(),
    Ak = (e, t) => e[t],
    Mk = (e) => {
      const t = Ek(e)
      return Ak(t, Tk)
    ...
    Pk = (e) => (t, o) =>
      ((e, t, o) => {
        const n = (e > 0 ? xk : yk)(fk(o), XS(o), ZS(o), ik(o))
        return (Hk(t, n), A.some(n))
      })(e, t, o).map(E),
    Uk = (e, t, o, n, s, r) => {
      const a = ((e, t, o, n, s) => {
        const r = Ik(e),
          a = n.bind((t) => A.some(Vk(t, e))).getOr(0),
          i = s.bind((t) => A.some(Vk(t, e))).getOr(r),
          l = {
            min: XS(t),
            max: ZS(t),
            range: nk(t),
  ...
  var Xk = Object.freeze({
    ...
    getValueFromEvent: (e) => qS(e).map((e) => e.left),
    findPositionOfValue: Uk,
    setPositionFromValue: (e, t, o, n) => {
      const s = fk(o),
        r = Uk(e, n.getSpectrum(e), s, n.getLeftEdge(e), n.getRightEdge(e), o),
        a = Jt(t.element) / 2
  ...
  const Yk = (e, t) => {
    ...
    Jk = (e) => (t, o) =>
      ((e, t, o) => {
        const n = (e > 0 ? xk : yk)(fk(o), YS(o), QS(o), ik(o))
        return (Yk(t, n), A.some(n))
      })(e, t, o).map(E),
    Zk = (e, t, o, n, s, r) => {
      const a = ((e, t, o, n, s) => {
        const r = Rk(e),
          a = n.bind((t) => A.some(zk(t, e))).getOr(0),
          i = s.bind((t) => A.some(zk(t, e))).getOr(r),
          l = {
            min: YS(t),
            max: QS(t),
            range: sk(t),
  ...
  var sC = Object.freeze({
    ...
    getValueFromEvent: (e) => qS(e).map((e) => e.top),
    findPositionOfValue: Zk,
    setPositionFromValue: (e, t, o, n) => {
      const s = fk(o),
        r = Zk(e, n.getSpectrum(e), s, n.getTopEdge(e), n.getBottomEdge(e), o),
        a = Wt(t.element) / 2
  ...
  const rC = (e, t) => {
    ...
    iC = (e, t) => (o, n) =>
      ((e, t, o, n) => {
        const s = e > 0 ? xk : yk,
          r = t ? fk(n).x : s(fk(n).x, XS(n), ZS(n), ik(n)),
          a = t ? s(fk(n).y, YS(n), QS(n), ik(n)) : fk(n).y
        return (rC(o, aC(r, a)), A.some(r))
      })(e, t, o, n).map(E),
    lC = iC(-1, !1),
    cC = iC(1, !1),
    dC = iC(-1, !0),
  ...
  const pC = bm({
      ...
      factory: (e, t, o, n) => {
        ...
        return {
          ...
          behaviours: bu(e.sliderBehaviours, [
            Pp.config({
              mode: 'special',
              focusIn: (t) => om(t, e, 'spectrum').map(Pp.focusIn).map(E),
            }),
            pu.config({
              store: {
                mode: 'manual',
    ...
    hC = la('rgb-hex-update'),
    fC = la('slider-update'),
    bC = la('palette-update'),
    vC = 'form',
    yC = [hu('formBehaviours', [pu])],
    xC = (e) => '<alloy.field.' + e + '>',
    wC = (e, t) => ({
      uid: e.uid,
      dom: e.dom,
    ...
    SC = {
      ...
      sketch: (e) => {
        const t = (() => {
            const e = []
            return {
              field: (t, o) => (e.push(t), Ju(vC, xC(t), o)),
              record: x(e),
            }
          })(),
          o = e(t),
          n = t.record(),
          s = H(n, (e) => Uu({ name: e, pname: xC(e) }))
        return mm(vC, yC, s, wC, o)
      },
    },
    kC = la('valid-input'),
    CC = la('invalid-input'),
    OC = la('validating-input'),
    _C = 'colorcustom.rgb.',
    TC = (e, t, o, n) => {
      const s = (o, n) =>
          DS.config({
            ...
            notify: {
              ...
              onValid: (e) => {
                Ir(e, kC, { type: o, value: pu.getValue(e) })
              },
              onInvalid: (e) => {
                Ir(e, CC, { type: o, value: pu.getValue(e) })
              },
            },
            validator: {
              validate: (t) => {
        ...
        r = (o, n, r, a, i) => {
          const l = e(_C + 'range'),
            ...
            d = sS.parts.field({
              ...
              inputBehaviours: kl([s(n, o), iS.config({})]),
              onSetValue: (e) => {
                DS.isInvalid(e) && DS.run(e).get(b)
              },
            }),
            u = [c, d],
            m = 'hex' !== n ? [sS.parts['aria-descriptor']({ text: l })] : []
          return {
        ...
        c = fm({
          factory: () => {
            const s = {
                        ...
                        c('red')
                          ...
                          .each((t) => {
                            const o = ((e, t) => {
                              const o = Zy(t)
                              return (
                                SC.getField(e, 'hex').each((t) => {
                                  oh.isFocused(t) ||
                                    pu.setValue(e, { hex: o.value })
                                }),
                                o
                              )
                            })(e, t)
              ...
              p = (t) => ({
                label: e(_C + t + '.label'),
                description: e(_C + t + '.description'),
              }),
              h = p('red'),
              f = p('green'),
              b = p('blue'),
            ...
            return fn(
              SC.sketch((o) => ({
                ...
                components: [
                  o.field(
                    'red',
                    sS.sketch(r(rx, 'red', h.label, h.description, 255))
                  ),
                  o.field(
                    'green',
                    sS.sketch(r(rx, 'green', f.label, f.description, 255))
                  ),
                  o.field(
                    'blue',
                    sS.sketch(r(rx, 'blue', b.label, b.description, 255))
                  ),
                  o.field(
                    'hex',
                    sS.sketch(r(Yy, 'hex', v.label, v.description, 'ffffff'))
                  ),
                  i.asSpec(),
                ],
                formBehaviours: kl([
                  DS.config({ invalidClass: t('form-invalid') }),
                  Jp('rgb-form-events', [Ur(kC, g), Ur(CC, m), Ur(OC, m)]),
                ]),
              })),
              {
                apis: {
    ...
    EC = (e, t) => {
      const o = fm({
        ...
        factory: (o) => {
          const n = TC(e, t, o.onValidHex, o.onInvalidHex),
            s = ((e, t) => {
              const o = pC.parts.spectrum({
                  dom: {
                    tag: 'canvas',
                    attributes: { role: 'presentation' },
              ...
              return fm({
                ...
                apis: {
                  ...
                  setThumb: (e, t, o) => {
                    ;((e, t) => {
                      const o = _x(ix(t))
                      pC.setValue(e, { x: o.saturation, y: 100 - o.value })
                    })(t, o)
                  },
                },
                extraApis: {},
            ...
            r = { paletteRgba: Es(ux), paletteHue: Es(0) },
            a = jh(
              ((e, t) => {
                const o = pC.parts.spectrum({
                    dom: {
            ...
            u = (e, t, o) => {
              a.getOpt(e).each((e) => {
                pC.setValue(e, ((e) => 100 - (e / 360) * 100)(o))
              })
            },
            m = (e, t) => {
              i.getOpt(e).each((e) => {
    ...
    AC = () => wm.config({ find: A.some }),
    MC = (e) =>
      wm.config({
        find: (t) =>
          lt(t.element, e).bind((e) => t.getSystem().getByDom(e).toOptional()),
      }),
    DC = Dn([ys('preprocess', w), ys('postprocess', w)]),
    BC = (e, t) => {
      const o = Yn('RepresentingConfigs.memento processors', DC, t)
      return pu.config({
        store: {
          mode: 'manual',
          getValue: (t) => {
    ...
    RC = (e) => pu.config({ store: { mode: 'memory', initialValue: e } }),
    NC = {
  ...
  var VC = tinymce.util.Tools.resolve('tinymce.Resource'),
    zC = tinymce.util.Tools.resolve('tinymce.util.Tools')
  const HC = (e, t) => {
      let o = null
      const n = () => {
    ...
    LC = la('alloy-fake-before-tabstop'),
    PC = la('alloy-fake-after-tabstop'),
    UC = (e) => ({
      dom: {
        tag: 'div',
      ...
      behaviours: kl([oh.config({ ignore: !0 }), iS.config({})]),
    }),
    WC = (e, t) => ({
      dom: { tag: 'div', classes: ['tox-navobj', ...e.getOr([])] },
      components: [UC([LC]), t, UC([PC])],
      behaviours: kl([MC(1)]),
    }),
    jC = (e, t) => {
    ...
    GC = (e, t) => {
      const o = t.element
      Ua(o, LC) ? jC(e, !0) : Ua(o, PC) && jC(e, !1)
    },
    $C = (e) => jw(e, ['.' + LC, '.' + PC].join(','), T),
    qC = la('update-dialog'),
    XC = la('update-title'),
    YC = la('update-body'),
    KC = la('update-footer'),
    JC = la('body-send-message'),
    ZC = la('dialog-focus-shifted'),
    QC = Do().browser,
    eO = QC.isSafari(),
    tO = QC.isFirefox(),
    oO = eO || tO,
    nO = QC.isChromium(),
    sO = ({ scrollTop: e, scrollHeight: t, clientHeight: o }) =>
      Math.ceil(e) + o >= t,
    rO = (e, t) => e.scrollTo(0, 'bottom' === t ? 99999999 : t),
    aO = (e, t, o) => {
      const n = e.dom
      A.from(n.contentDocument).fold(o, (e) => {
        ...
        const s = ((e, t) => {
          ...
          r = () => {
            ...
            g(e) && (s ? rO(e, 'bottom') : !s && oO && 0 !== o && rO(e, o))
          }
        ;(eO && n.addEventListener('load', r, { once: !0 }),
          e.open(),
          e.write(t),
          e.close(),
          eO || r())
    ...
    lO = la('toolbar.button.execute'),
    cO = la('common-button-display-events'),
    dO = {
      [ur()]: [
        'disabling',
      ...
      [Sr()]: ['toolbar-button-events', cO],
      [Ws()]: ['focusing', 'alloy.base.behaviour', cO],
    },
    uO = (e) => Dt(e.element, 'width', It(e.element, 'width')),
    mO = (e, t, o) =>
      ef(
        e,
        {
    ...
    gO = (e, t) => mO(e, t, []),
    pO = (e, t) => mO(e, t, [Kp.config({})]),
    hO = (e, t, o) => ({
      dom: { tag: 'span', classes: [`${t}__select-label`] },
      components: [ti(o.translate(e))],
      behaviours: kl([Kp.config({})]),
    }),
    fO = la('update-menu-text'),
    bO = la('update-menu-icon'),
    vO = (e, t, o) => {
      const n = Es(b),
        s = e.text.map((e) => jh(hO(e, t, o.providers))),
        r = e.icon.map((e) => jh(pO(e, o.providers.icons))),
        a = (e, t) => {
          const o = pu.getValue(e)
          return (
            oh.focus(o),
            Ir(o, 'keydown', { raw: t.event.raw }),
            Mw.close(o),
            A.some(!0)
          )
        },
        ...
        u = jh(
          Mw.sketch({
            ...
            onOpen: (t, o, n) => {
              e.searchable &&
                ((e) => {
                  Pb(e).each((e) => oh.focus(e))
                })(n)
            },
            dropdownBehaviours: kl([
              ...e.dropdownBehaviours,
              Sy(() => e.disabled || o.providers.isDisabled()),
              wy(),
              BS.config({}),
              Kp.config({}),
              Jp('dropdown-events', [_y(e, n), Ty(e, n)]),
              Jp(d, [Kr((e, t) => uO(e))]),
              Jp('menubutton-update-display-text', [
                ...
                Ur(bO, (e, t) => {
                  r.bind((t) => t.getOpt(e)).each((e) => {
                    Kp.set(e, [pO(t.event.icon, o.providers.icons)])
                  })
                }),
              ]),
            ]),
              ...
              Jp('dropdown-sandbox-events', [
                Ur(Vb, (e, t) => {
                  ;(((e) => {
                    const t = pu.getValue(e),
                      o = Lb(e).map(Ub)
                    Mw.refetch(t).get(() => {
                      const e = dw.getCoupled(t, 'sandbox')
                      o.each((t) =>
                        Lb(e).each((e) =>
                          ((e, t) => {
                ...
                Ur(zb, (e, t) => {
                  ;(((e, t) => {
                    ;((e) =>
                      Xd.getState(e)
                        .bind(Gm.getHighlighted)
                        .bind(Gm.getHighlighted))(e).each((o) => {
                      ;((e, t, o, n) => {
                        const s = { ...n, target: t }
                        e.getSystem().triggerEvent(o, t, s)
                      })(
            ...
            fetch: (t) => hw(k(e.fetch, t)),
          })
        )
      return u.asSpec()
    },
    yO = (e) => 'separator' === e.type,
    xO = { type: 'separator' },
    wO = (e, t) => {
      const o = ((e, t) => {
        const o = j(
        ...
        return (o.length > 0 && yO(o[o.length - 1]) && o.pop(), o)
      })(r(e) ? e.split(' ') : e, t)
      return W(
        o,
        (e, o) => {
          if (((e) => ve(e, 'getSubmenuItems'))(o)) {
            ...
            return {
              menus: fn(e.menus, s.menus),
              items: [s.item, ...e.items],
              expansions: fn(e.expansions, s.expansions),
            }
          }
    ...
    SO = (e, t, o, n) => {
      const s = la('primary-menu'),
        r = wO(e, o.shared.providers.menuItems())
      ...
      const a = ((e) =>
        ...
        i = Vw(s, r.items, t, o, n.isHorizontalMenu, a),
        l = ((e) =>
          e.search.fold(
            () => ({ searchMode: 'no-search' }),
            (e) => ({ searchMode: 'search-with-results' })
          ))(n),
        c = ce(r.menus, (e, n) => Vw(n, e, t, o, !1, l)),
        d = fn(c, Ms(s, i))
      ...
      H(o, (o) =>
        kO(o)
          ? {
              ...
              active: o.value === n,
              onAction: () => {
                ;(pu.setValue(e, o.value), Ir(e, gS, { name: t }), oh.focus(e))
              },
            }
          : {
              type: 'nestedmenuitem',
              text: o.text,
              getSubmenuItems: () => OO(e, t, o.items, n),
            }
      ),
    _O = (e, t) =>
      re(e, (e) => (kO(e) ? Ce(e.value === t, e) : _O(e.items, t))),
    TO = fm({
      name: 'HtmlSelect',
      configFields: [
        os('options'),
        ...
        overrides: (e) => ({
          fieldBehaviours: kl([
            Jp('coupled-input-behaviour', [
              Ur(Zs(), (o) => {
                ;((e, t, o) => om(e, t, o).bind(wm.getCurrent))(o, e, t).each(
                  (t) => {
                    om(o, e, 'lock').each((n) => {
          ...
          pu.config({
            store: {
              ...
              getValue: (t) => {
                ...
                return {
                  [e.field1Name]: pu.getValue(o.field1()),
                  [e.field2Name]: pu.getValue(o.field2()),
                }
              },
              setValue: (t, o) => {
                const n = im(t, e, ['field1', 'field2'])
                ;(ye(o, e.field1Name) &&
                  pu.setValue(n.field1(), o[e.field1Name]),
                  ye(o, e.field2Name) &&
                    pu.setValue(n.field2(), o[e.field2Name]))
              },
            },
          }),
        ]),
        apis: {
          getField1: (t) => om(t, e, 'field1'),
          getField2: (t) => om(t, e, 'field2'),
          getLock: (t) => om(t, e, 'lock'),
        },
      }),
      apis: {
      ...
      const o = e.label.map((e) => mS(e, t)),
            ...
            DS.config({
              ...
              validator: {
                validate: (t) => {
                  const o = pu.getValue(t),
                    n = e.validator(o)
                  return fw(!0 === n ? sn.value(o) : sn.error(n))
                },
        ...
        c = [
          Rm.config({
            ...
            onDisabled: (e) => {
              sS.getField(e).each(Rm.disable)
            },
            onEnabled: (e) => {
              sS.getField(e).each(Rm.enable)
            },
          }),
          wy(),
        ]
    ...
    VO = (e) => e.dimension.property,
    zO = (e, t) => e.dimension.getDimension(t),
    HO = (e, t) => {
      const o = NO(e, t)
      ja(o, [t.shrinkingClass, t.growingClass])
    },
    LO = (e, t) => {
      ;(Pa(e.element, t.openClass),
        La(e.element, t.closedClass),
        Dt(e.element, VO(t), '0px'),
        Lt(e.element))
    },
    PO = (e, t) => {
      ;(Pa(e.element, t.closedClass),
        La(e.element, t.openClass),
        Ht(e.element, VO(t)))
    },
    UO = (e, t, o, n) => {
      ;(o.setCollapsed(),
        Dt(e.element, VO(t), zO(t, e.element)),
        HO(e, t),
        LO(e, t),
        t.onStartShrink(e),
        t.onShrunk(e))
    ...
    WO = (e, t, o, n) => {
      const s = n.getOrThunk(() => zO(t, e.element))
      ;(o.setCollapsed(), Dt(e.element, VO(t), s), Lt(e.element))
      const r = NO(e, t)
      ;(Pa(r, t.growingClass),
    ...
    jO = (e, t, o) => {
      const n = zO(t, e.element)
      ;('0px' === n ? UO : WO)(e, t, o, A.some(n))
    },
    GO = (e, t, o) => {
      const n = NO(e, t),
        ...
        r = zO(t, e.element)
      PO(e, t)
      const a = zO(t, e.element)
      ;((s
        ? () => {
            ;(Dt(e.element, VO(t), r), Lt(e.element))
          }
        : () => {
            LO(e, t)
          })(),
  ...
  var XO = Object.freeze({
      ...
      refresh: (e, t, o) => {
        if (o.isExpanded()) {
          Ht(e.element, VO(t))
          const o = zO(t, e.element)
          Dt(e.element, VO(t), o)
        }
      },
      grow: (e, t, o) => {
        o.isExpanded() || GO(e, t, o)
      },
      shrink: (e, t, o) => {
        o.isExpanded() && jO(e, t, o)
      },
      immediateShrink: (e, t, o) => {
        o.isExpanded() && UO(e, t, o)
      },
      hasGrown: (e, t, o) => o.isExpanded(),
      hasShrunk: (e, t, o) => o.isCollapsed(),
      isGrowing: $O,
      isShrinking: qO,
      isTransitioning: (e, t, o) => $O(e, t) || qO(e, t),
      toggleGrow: (e, t, o) => {
        ;(o.isExpanded() ? jO : GO)(e, t, o)
      },
    ...
    KO = [
      ...
      ns(
        ...
        Jn('property', {
          width: [
            Ri('property', 'width'),
            Ri('getDimension', (e) => Jt(e) + 'px'),
          ],
          height: [
            Ri('property', 'height'),
            Ri('getDimension', (e) => Wt(e) + 'px'),
          ],
        })
      ),
    ]
  const JO = Ol({
    ...
    ZO = (e) => ({
      ...
      setActive: (t) => {
        const o = e.element
        t
          ? (La(o, 'tox-tbtn--enabled'), kt(o, 'aria-pressed', !0))
          : (Pa(o, 'tox-tbtn--enabled'), Et(o, 'aria-pressed'))
      },
      isActive: () => Ua(e.element, 'tox-tbtn--enabled'),
      setText: (t) => {
        Ir(e, fO, { text: t })
      },
      setIcon: (t) => Ir(e, bO, { icon: t }),
    }),
    QO = (e, t, o, n, s = !0) =>
      vO(
        {
          ...
          role: n,
          fetch: (t, n) => {
            const s = { pattern: e.search.isSome() ? Fw(t) : '' }
            e.fetch(
              (t) => {
                n(
                  SO(t, gb.CLOSE_ON_EXECUTE, o, {
                    isHorizontalMenu: !1,
                    search: e.search,
                  })
                )
          ...
          presets: 'normal',
          classes: [],
          dropdownBehaviours: [...(s ? [iS.config({})] : [])],
        },
        t,
        o.shared
      ),
          ...
          ;(n.setActive(s),
            ...
            o.shared.getSink().each((o) => {
              t()
                ...
                .each((t) => {
                  ;(Dl(t.element),
                    Ir(t, fS, { name: e.name, value: e.storage.get() }))
                })
            }))
        },
        s = (e) => (t) => {
    ...
    n_ = ({
      ...
      const a = e.menu.map((e) => QO(e, 'tox-mbtn', r, A.none(), o)),
        i = [t_(e.title)]
      return (
        a.each((e) => i.push(e)),
        Wh.sketch({
    ...
    s_ = la('directory-label-event-id'),
    r_ = ({ directory: e, visible: t, noChildren: o, backstage: n }) => {
      const s = e.menu.map((e) => QO(e, 'tox-mbtn', n, A.none())),
        r = [
          {
        ...
        mi(t.element, '.tox-tree--directory').each((o) => {
          t.getSystem()
            ...
            .each((o) => {
              const n = !dh.isOn(o)
              ;(dh.toggle(o),
                Ir(t, 'expand-tree-node', { expanded: n, node: e.id }))
            })
        })
      }
      return Wh.sketch({
        ...
        behaviours: kl([
          ...
          dh.config({
            ...
            onToggled: (e, o) => {
              ...
              var d
              ;(o ? JO.grow(r) : JO.shrink(r), Kp.set(r, c))
            },
          }),
        ]),
      }
  ...
  var d_ = Object.freeze({
    ...
    events: (e, t) => {
      ...
      return Hr(
        [Ur(e.event, o), Jr(() => t.cancel())].concat(
          e.cancelEvent.map((e) => [Ur(e, () => t.cancel())]).getOr([])
        )
      )
    },
  })
  ...
  const p_ = Ol({ fields: g_, name: 'streaming', active: d_, state: m_ }),
    h_ = (e, t, o) => {
      const n = pu.getValue(o)
      ;(pu.setValue(t, n), b_(t))
    },
    f_ = (e, t) => {
      const o = e.element,
        n = $a(o),
    ...
    b_ = (e) => {
      f_(e, (e, t) => e.setSelectionRange(t.length, t.length))
    },
    v_ = x('alloy.typeahead.itemexecute'),
    y_ = x(
      [
        us('lazySink'),
        os('fetch'),
        ...
        Ai(['openClass']),
        us('initialData'),
        hu('typeaheadBehaviours', [oh, pu, p_, Pp, dh, dw]),
            ...
            e.previewing.get()
              ? e.lazyTypeaheadComp.get().each((t) => {
                  ;((e, t, o) => {
                    ...
                    () => {
                      e.model.selectsOver
                        ? (Gm.dehighlight(o, n), e.previewing.set(!0))
                        : e.previewing.set(!1)
                    },
                    (t) => {
              ...
              : e.lazyTypeaheadComp.get().each((t) => {
                  ;(e.model.populateFromBrowse && h_(e.model, t, n),
                    _t(n.element, 'id').each((e) =>
                      kt(t.element, 'aria-activedescendant', e)
                    ))
                })
          },
          onExecute: (t, o) =>
            e.lazyTypeaheadComp
              .get()
              .map((e) => (Ir(e, v_(), { item: o }), !0)),
          onHover: (t, o) => {
            ;(e.previewing.set(!1),
              e.lazyTypeaheadComp.get().each((t) => {
                e.model.populateFromBrowse && h_(e.model, t, o)
              }))
          },
        }),
      }),
    ...
    w_ = bm({
      ...
      factory: (e, t, o, n) => {
        const s = (t, o, s) => {
            e.previewing.set(!1)
            const r = dw.getCoupled(t, 'sandbox')
            if (Xd.isOpen(r))
              ...
              xw(e, a(t), t, r, n, o, zh.HighlightMenuAndItem).get(b)
            }
          },
          r = Fb(e),
          a = (e) => (t) =>
          ...
          c = [
            ...
            p_.config({
              ...
              onStream: (t, o) => {
                const s = dw.getCoupled(t, 'sandbox')
                if (oh.isFocused(t) && $a(t.element).length >= e.minChars) {
                  const o = i(s).bind((e) =>
                    Gm.getHighlighted(e).map(pu.getValue)
                  )
                  e.previewing.set(!0)
                  const r = (t) => {
                    i(s).each((t) => {
                      o.fold(
                        ...
                        (e) => {
                          ;(Gm.highlightBy(
                            t,
                            (t) => pu.getValue(t).value === e.value
                          ),
                            Gm.getHighlighted(t).orThunk(
                              () => (Gm.highlightFirst(t), A.none())
                            ))
                        }
                      )
                    })
                  }
                  xw(e, a(t), t, s, n, r, zh.HighlightJustMenu).get(b)
                }
              },
              cancelEvent: fr(),
            }),
            Pp.config({
              ...
              onEnter: (t) => {
                const o = dw.getCoupled(t, 'sandbox'),
                  n = Xd.isOpen(o)
                if (n && !e.previewing.get())
                  return i(o)
                    .bind((e) => Gm.getHighlighted(e))
                    .map((e) => (Ir(t, v_(), { item: e }), !0))
                {
                ...
                sandbox: (t) =>
                  Ow(e, t, {
                    ...
                    onClose: () => {
                      ;(e.lazyTypeaheadComp
                        .get()
                        .each((e) => Et(e.element, 'aria-activedescendant')),
                        dh.off(t))
                    },
                  }),
              },
            ...
            Jp(
              ...
              [
                ...
                Qr((t) => {
                  const o = b
                  Sw(e, a(t), t, n, o, zh.HighlightMenuAndItem).get(b)
                }),
                Ur(v_(), (t, o) => {
                  const n = dw.getCoupled(t, 'sandbox')
                  ;(h_(e.model, t, o.event.item),
                    Fr(t, fr()),
          ...
          d = { [kr()]: [pu.name(), p_.name(), l], ...e.eventOrder }
        return {
          uid: e.uid,
          dom: Rb(
            fn(e, {
    ...
    S_ = (e) => ({
      ...
      bindResult: (t) => S_(e.map((e) => e.bind(t))),
      mapResult: (t) => S_(e.map((e) => e.map(t))),
      mapError: (t) => S_(e.map((e) => e.mapError(t))),
    ...
    O_ = (e, t, o, n = []) => {
      const s = {
        ...
        r = e.icon.map((e) => gO(e, o.icons)),
        a = My([r])
      return C_(e, t, n, s, a, o)
    },
    __ = (e) => {
      switch (e) {
        case 'primary':
    ...
    E_ = (e, t, o, n = [], s = []) => {
      const r = T_(e, A.some(t), o, n, s)
      return Wh.sketch(r)
    },
    A_ = (e, t) => (o) => {
      'custom' === t
        ? Ir(o, fS, { name: e, value: {} })
        : 'submit' === t
          ? Fr(o, bS)
          : 'cancel' === t
            ? Fr(o, hS)
      ...
      if (((e, t) => 'menu' === t)(0, t)) {
        const t = () => r,
          ...
          s = {
            ...
            fetch: e_(n.items, t, o),
          },
          r = jh(QO(s, 'tox-tbtn', o, A.none()))
        return r.asSpec()
      }
      if (
        ...
        const n = A_(e.name, t),
          s = { ...e, borderless: !1 }
        return E_(s, n, o.shared.providers, [])
      }
      if (((e, t) => 'togglebutton' === t)(0, t))
        return ((e, t) => {
          var o, n
          const s = e.icon.map((e) => pO(e, t.icons)).map(jh),
    ...
    I_ = (e, t) =>
      ((e) => H(e, B_))(((e, t) => U(t, (t) => t.type === e))(e, t)),
    R_ = (e) => I_('header', e.targets),
    N_ = (e) => I_('anchor', e.targets),
    V_ = (e) =>
      A.from(e.anchorTop)
        .map((e) => F_('<top>', e))
        .toArray(),
    ...
    j_ = {
      ...
      collection: W_((e, t, o) =>
        ((e, t, o) => {
          const n = e.label.map((e) => mS(e, t)),
            ...
            r = s((o, n, s, r) => {
              ;(n.stop(),
                t.isDisabled() || Ir(o, fS, { name: e.name, value: r }))
            }),
            a = [
              Ur(
                qs(),
            ...
            l = sS.parts.field({
              ...
              behaviours: kl([
                Rm.config({
                  ...
                  onDisabled: (e) => {
                    i(e, (e) => {
                      ;(La(e, 'tox-collection__item--state-disabled'),
                        kt(e, 'aria-disabled', !0))
                    })
                  },
                  onEnabled: (e) => {
                    i(e, (e) => {
                      ;(Pa(e, 'tox-collection__item--state-disabled'),
                        Et(e, 'aria-disabled'))
                    })
                  },
                }),
                  ...
                  onSetValue: (o, n) => {
                    ;(((o, n) => {
                      const s = H(n, (o) => {
                          ...
                          return `<div class="tox-collection__item${t.isDisabled() ? ' tox-collection__item--state-disabled' : ''}" tabindex="-1" data-collection-item-value="${lS.encodeAllRaw(o.value)}" title="${i}" aria-label="${i}">${r}${s}</div>`
                        }),
                        r =
                      ...
                      'auto' === e.columns &&
                        ay(o, 5, 'tox-collection__item').each(
          ...
          var c
          return cS(n, l, ['tox-form__group--collection'], [])
                ...
                components: e.url
                  ? [
                      Wh.sketch({
                        ...
                        action: (t) =>
                          Ir(t, fS, { name: 'alert-banner', value: e.url }),
      ...
      iframe:
        ((fE = (e, t, o) =>
          ((e, t, o) => {
                ...
                return {
                  ...
                  setValue: (e, n) => {
                    if (o.get() !== n) {
                      const o = e.element,
                        s = () => kt(o, 'srcdoc', n)
                      t ? iO.fold(x(aO), (e) => e.throttle)(o, n, s) : s()
                    }
                    o.set(n)
                  },
                }
              })(o, e.streamContent),
              l = e.label.map((e) => mS(e, t)),
              c = sS.parts.field({
                factory: {
                  sketch: (e) =>
                    WC(A.from(r), {
            ...
            return cS(l, c, ['tox-form__group--stretched'], [])
          })(e, t.shared.providers, o)),
        (e, t, o, n) => {
          const s = fn(t, { source: 'dynamic' })
          return W_(fE)(e, s, o, n)
        }),
      button: W_((e, t) =>
        ((e, t) => {
          const o = A_(e.name, 'custom')
          return (
            (n = A.none()),
            (s = sS.parts.field({
              factory: Wh,
              ...T_(e, A.some(o), t, [RC(''), AC()]),
            })),
            cS(n, s, [], [])
          )
          var n, s
      ...
      colorinput: W_((e, t, o) =>
        ((e, t, o, n) => {
          const s = sS.parts.field({
              factory: Nb,
              inputClasses: ['tox-textfield'],
              data: n,
              onSetValue: (e) => DS.run(e).get(b),
              inputBehaviours: kl([
                ...
                DS.config({
                  ...
                  validator: {
                    ...
                    validate: (e) => {
                      const t = pu.getValue(e)
                      if (0 === t.length) return fw(sn.value(!0))
                      {
                        const e = Re('span')
            ...
            r = e.label.map((e) => mS(e, t.providers)),
            a = (e, t) => {
              Ir(e, IS, { value: t })
            },
            i = jh(
                      ...
                      A.from(
                        zw(
                          fn(
                            ...
                            { movement: Qx(e.columns, e.presets) }
                          )
                        )
                      )
                    ),
                  parts: { menu: Db(0, 0, e.presets) },
                }))(
                {
                  dom: {
                    tag: 'span',
          ...
          return sS.sketch({
            ...
            fieldBehaviours: kl([
              Jp('form-field-events', [
                ...
                Ur(IS, (e, t) => {
                  sS.getField(e).each((o) => {
                    ;(pu.setValue(o, t.event.value),
                      wm.getCurrent(e).each(oh.focus))
                  })
                }),
                Ur(RS, (e, t) => {
                  sS.getField(e).each((t) => {
                    wm.getCurrent(e).each(oh.focus)
                  })
                }),
              ]),
          ...
          const n = (e) => 'tox-' + e,
            ...
            r = jh(
              s.sketch({
                ...
                onValidHex: (e) => {
                  Ir(e, fS, { name: 'hex-valid', value: !0 })
                },
                onInvalidHex: (e) => {
                  Ir(e, fS, { name: 'hex-valid', value: !1 })
                },
              })
            )
          return {
      ...
      dropzone: W_((e, t, o) =>
        ((e, t, o) => {
            ...
            i = (o, n) => {
              n &&
                (pu.setValue(
                  o,
                  ((e, t) => {
                    const o = zC.explode(t.getOption('images_file_types'))
                    return U(se(e), (e) =>
                      N(o, (t) =>
                  ...
                  components: [
                    {
                      ...
                      components: [
                        ...
                        Wh.sketch({
                          ...
                          components: [
                            ti(t.translate('Browse for an image')),
                            l.asSpec(),
                          ],
                          action: (e) => {
          ...
          return cS(c, d, ['tox-form__group--stretched'], [])
        })(e, t.shared.providers, o)
      ),
      grid: W_((e, t) =>
        ((e, t) => ({
      ...
      listbox: W_((e, t, o) =>
        ((e, t, o) => {
          const n = t.shared.providers,
            s = o
              .bind((t) => _O(e.items, t))
              .orThunk(() => oe(e.items).filter(kO)),
            r = e.label.map((e) => mS(e, n)),
            a = sS.parts.field({
              dom: {},
              factory: {
                sketch: (o) =>
                  vO(
                    {
                      ...
                      role: A.none(),
                      fetch: (o, n) => {
                        const s = OO(o, e.name, e.items, pu.getValue(o))
                        n(
                          SO(s, gb.CLOSE_ON_EXECUTE, t, {
                            isHorizontalMenu: !1,
                            search: A.none(),
                          })
                        )
      ...
      sizeinput: W_((e, t) =>
        ((e, t) => {
          ...
          const n = la('ratio-event'),
            ...
            c = DO.parts.field1(a([sS.parts.label(l('Width')), i(!0)])),
            d = DO.parts.field2(a([sS.parts.label(l('Height')), i(!1)]))
          return DO.sketch({
            dom: { tag: 'div', classes: ['tox-form__group'] },
            components: [
              {
            ...
            coupledFieldBehaviours: kl([
              Rm.config({
                disabled: () => !e.enabled || t.isDisabled(),
                onDisabled: (e) => {
                  ;(DO.getField1(e).bind(sS.getField).each(Rm.disable),
                    DO.getField2(e).bind(sS.getField).each(Rm.disable),
                    DO.getLock(e).each(Rm.disable))
                },
                onEnabled: (e) => {
                  ;(DO.getField1(e).bind(sS.getField).each(Rm.enable),
                    DO.getField2(e).bind(sS.getField).each(Rm.enable),
                    DO.getLock(e).each(Rm.enable))
                },
              }),
              wy(),
              Jp('size-input-events2', [
                Ur(n, (e, t) => {
                  const n = t.event.isField1,
                    s = n ? DO.getField1(e) : DO.getField2(e),
                    r = n ? DO.getField2(e) : DO.getField1(e),
                    a = s.map(pu.getValue).getOr(''),
                    i = r.map(pu.getValue).getOr('')
                  o = ((e, t) => {
                    const o = BO(e).toOptional(),
                      n = BO(t).toOptional()
                    return Se(o, n, (e, t) =>
                      FO(e, t.unit)
                        .map((e) => t.value / e)
      ...
      slider: W_((e, t, o) =>
        ((e, t, o) => {
          ...
          return pC.sketch({
            ...
            components: [n, s, r],
            sliderBehaviours: kl([AC(), oh.config({})]),
            onChoose: (t, o, n) => {
              Ir(t, gS, { name: e.name, value: n })
            },
          })
        })(e, t.shared.providers, o)
      ),
        ...
        ((e, t, o, n) => {
          const s = t.shared.providers,
            ...
            a = {
              ...
              inputClasses: ['tox-textfield'],
              sandboxClasses: ['tox-dialog__popups'],
              inputAttributes: { 'aria-errormessage': L_, type: 'url' },
              minChars: 0,
              responseTime: 0,
              fetch: (n) => {
                const s = ((e, t, o) => {
                    ...
                    return o.getLinkInformation().fold(
                      ...
                      (t) => {
                        const n = H_(
                          a,
                          ((e) => H(e, (e) => F_(e, e)))(o.getHistory(e))
                        )
                        return 'file' === e
                          ? ((s = [
                              n,
                              H_(a, R_(t)),
                              H_(a, q([V_(t), N_(t), z_(t)])),
                            ]),
                            j(
                              s,
                              (e, t) =>
              ...
              onSetValue: (e, t) => {
                e.hasConfigured(DS) && DS.run(e).get(b)
              },
                ...
                Jp('urlinput-events', [
                  Ur(Zs(), (t) => {
                    const o = $a(t.element),
                      n = o.trim()
                    ;(n !== o && qa(t.element, n),
                      'file' === e.filetype && Ir(t, gS, { name: e.name }))
                  }),
                  Ur(Qs(), (t) => {
                    ;(Ir(t, gS, { name: e.name }), r(t))
                  }),
                  Ur(cr(), (t) => {
                    ;(Ir(t, gS, { name: e.name }), r(t))
                  }),
              ...
              parts: { menu: Db(0, 0, 'normal') },
              onExecute: (e, t, o) => {
                Ir(t, bS, {})
              },
              onItemExecute: (t, o, n, s) => {
                ;(r(t), Ir(t, gS, { name: e.name }))
              },
            },
            i = sS.parts.field({ ...a, factory: w_ }),
            l = e.label.map((e) => mS(e, s)),
            c = jh(
              ((e, t, o = e, n = e) =>
                ef(
                  o,
          ...
          return sS.sketch({
            ...
            fieldBehaviours: kl([
              Rm.config({
                ...
                onDisabled: (e) => {
                  ;(sS.getField(e).each(Rm.disable),
                    p.getOpt(e).each(Rm.disable))
                },
                onEnabled: (e) => {
                  ;(sS.getField(e).each(Rm.enable), p.getOpt(e).each(Rm.enable))
                },
              }),
              wy(),
              Jp('url-input-events', [
                Ur(m, (t) => {
                  wm.getCurrent(t).each((o) => {
                    ...
                    u.each((n) => {
                      n(s).get((n) => {
                        ;(pu.setValue(o, n), Ir(t, gS, { name: e.name }))
                      })
                    })
                  })
                }),
              ...
              Kr((s) => {
                o.getOpt(s).each((o) => {
                  ;(((e) => ve(e, 'init'))(e)
                    ...
                    : VC.load(e.scriptId, e.scriptUrl).then((t) =>
      ...
      htmlpanel: W_((e) =>
        'presentation' === e.presets
          ...
          : eS.sketch({
              ...
              containerBehaviours: kl([iS.config({}), oh.config({})]),
            })
      ),
      imagepreview: W_((e, t, o) =>
        ((e, t) => {
              ...
              FC(
                ...
                (e, t) => {
                  ...
                  n.getOpt(e).each((o) => {
                    ...
                    ;(t.url !== Ot(n, 'src') &&
                      (kt(n, 'src', t.url),
                      Pa(e.element, 'tox-imagepreview__loaded')),
                      a(),
                      ((s = n),
                      new Promise((e, t) => {
                        const o = () => {
      ...
      table: W_((e, t) =>
        ((e, t) => {
          ...
          return {
            ...
            behaviours: kl([iS.config({}), oh.config({})]),
          }
          var n, s
        })(e, t.shared.providers)
      ),
                  ...
                  [`update-active-item-${i}`]: {
                    onReceive: (e, t) => {
                      ;(a.set(A.some(t.value)),
                        Kp.set(e, l(A.some(t.value), r.get())))
                    },
                  },
                },
              }),
    ...
    G_ = { field: (e, t) => t, record: x([]) },
    $_ = (e, t, o, n) => {
      const s = fn(n, { shared: { interpreter: (t) => q_(e, t, o, s) } })
      return q_(e, t, o, s)
    },
    q_ = (e, t, o, n) =>
      be(j_, t.type).fold(
    ...
    X_ = (e, t, o) => q_(G_, e, t, o),
    Y_ = 'layout-inset',
    K_ = (e) => e.x,
    J_ = (e, t) => e.x + e.width / 2 - t.width / 2,
    Z_ = (e, t) => e.x + e.width - t.width,
    Q_ = (e) => e.y,
    eT = (e, t) => e.y + e.height - t.height,
    tT = (e, t) => e.y + e.height / 2 - t.height / 2,
    oT = (e, t, o) =>
      zi(
        Z_(e, t),
        eT(e, t),
    ...
    aT = (e, t, o) =>
      zi(J_(e, t), Q_(e), o.insetNorth(), ji(), 'north', Ki(e, { top: 2 }), Y_),
    iT = (e, t, o) =>
      zi(
        J_(e, t),
        eT(e, t),
    ...
    cT = (e, t, o) =>
      zi(K_(e), tT(e, t), o.insetWest(), $i(), 'west', Ki(e, { left: 1 }), Y_),
    dT = (e) => {
      switch (e) {
        case 'north':
          return aT
    ...
    uT = (e, t, o, n, s) => Xl(n).map(dT).getOr(aT)(e, t, o, n, s),
    mT = (e) => {
      switch (e) {
        case 'north':
          return iT
    ...
    gT = (e, t, o, n, s) => Xl(n).map(mT).getOr(aT)(e, t, o, n, s),
    pT = {
      valignCentre: [],
      alignCentre: [],
      alignLeft: [],
    ...
    yT = (e) => (t) => ({ type: 'node', root: e(), node: t }),
    xT = (e, t, o, n) => {
      const s = nb(e),
        r = () => Ve(e.getBody()),
        ...
        i = () => s || !n()
      return {
        inlineDialog: hT(a, t, i),
        inlineBottomDialog: fT(e.inline, a, o, i),
        banner: bT(a, t, i),
        cursor: vT(e, r),
        node: yT(r),
      }
    ...
    zT = (e) => e.innerText || e.textContent,
    HT = (e) =>
      ((e) => e && 'A' === e.nodeName && void 0 !== (e.id || e.name))(e) &&
      PT(e),
    LT = (e) => e && /^(H[1-6])$/.test(e.nodeName),
    PT = (e) =>
      ((e) => {
        let t = e
        for (; (t = t.parentNode); ) {
          const e = t.contentEditable
          if (e && 'inherit' !== e) return RT(t)
        }
        return !1
      })(e) && !NT(e),
    UT = (e) => LT(e) && PT(e),
    WT = (e) => {
      ...
      return VT(
        'header',
        null !== (t = zT(e)) && void 0 !== t ? t : '',
        '#' + o,
        ((e) => (LT(e) ? parseInt(e.nodeName.substr(1), 10) : 0))(e),
        () => {
          e.id = o
        }
      )
    ...
    jT = (e) => {
      const t = e.id || e.name,
        o = zT(e)
      return VT('anchor', o || '#' + t, '#' + t, 0, b)
    },
    GT = (e) => FT(e.title).length > 0,
    $T = (e) => {
      const t = ((e) => {
      ...
      return U(
        ((e) => H(U(e, UT), WT))(t).concat(((e) => H(U(e, HT), jT))(t)),
        GT
      )
    },
    qT = 'tinymce-url-history',
    XT = (e) => r(e) && /^https?/.test(e),
    YT = (e) =>
      a(e) &&
      he(e, (e) => {
        return !(l((t = e)) && t.length <= 5 && Y(t, XT))
        var t
      }).isNone(),
    KT = () => {
      const e = wx.getItem(qT)
      if (null === e) return {}
      let t
      try {
        t = JSON.parse(e)
        ...
        if (e instanceof SyntaxError)
          return (
            console.log('Local storage ' + qT + ' was not valid JSON', e),
            {}
          )
        throw e
      }
      return YT(t)
        ? t
        : (console.log('Local storage ' + qT + ' was not valid format', t), {})
    },
    JT = (e) => {
      const t = KT()
      return be(t, e).getOr([])
    ...
    ZT = (e, t) => {
      ...
      ;((o[t] = [e].concat(s).slice(0, 5)),
        ((e) => {
          ...
          wx.setItem(qT, JSON.stringify(e))
        })(o))
    },
    QT = (e) => !!e,
    eE = (e) => ce(zC.makeMap(e, /[, ]/), QT),
    tE = (e) => A.from(Ff(e)),
    oE = (e) => A.from(e).filter(r).getOrUndefined(),
    nE = (e) => ({
      getHistory: JT,
      addToHistory: ZT,
      getLinkInformation: () =>
      ...
      getUrlPicker: (t) =>
        ((e, t) =>
          ((e, t) => {
            const o = ((e) => {
              const t = A.from(Nf(e)).filter(QT).map(eE)
              return tE(e).fold(T, (e) =>
                t.fold(E, (e) => ae(e).length > 0 && e)
              )
            })(e)
            return d(o) ? (o ? tE(e) : A.none()) : o[t] ? tE(e) : A.none()
          })(e, t).map(
            (o) => (n) =>
              hw((s) => {
                const i = {
    ...
    aE = x([
      ...
      os('makeItem'),
      ys('setupItem', b),
      vu('listBehaviours', [Kp]),
    ]),
    iE = ju({
      name: 'items',
      overrides: () => ({ behaviours: kl([Kp.config({})]) }),
    }),
    lE = x([iE]),
    cE = bm({
      name: x('CustomList')(),
      ...
      factory: (e, t, o, n) => {
        const s = e.shell
          ? { behaviours: [Kp.config({})], components: [] }
    ...
    dE = x([os('dom'), ys('shell', !0), hu('toolbarBehaviours', [Kp])]),
    uE = x([
      ju({
        name: 'groups',
        overrides: () => ({ behaviours: kl([Kp.config({})]) }),
  ...
  const vE = (e) =>
    ...
    SE = (e, t) => e.y >= t.y,
    kE = (e, t) => e.bottom <= t.bottom,
    CE = (e, t, o) => ({ location: 'top', leftX: t, topY: o.bounds.y - e.y }),
    OE = (e, t, o) => ({
      location: 'bottom',
      leftX: t,
      bottomY: e.bottom - o.bounds.bottom,
    }),
    _E = (e) => e.box.x - e.win.x,
    TE = (e, t, o) =>
                ...
                .filter(({ box: e }) =>
                  ((e, t, o) =>
                    Y(e, (e) => {
                      switch (e) {
                        case 'bottom':
                          return kE(t, o.bounds)
                        case 'top':
                          return SE(t, o.bounds)
                      }
                    }))(o.getModes(), e, t)
                )
                .bind(({ box: t }) => AE(e, t, o)))(e, t, o).orThunk(() =>
              t.optScrollEnv
                .bind((n) => TE(e, t, o))
                .bind(({ box: e, location: o }) => {
                  const n = en(),
                    s = _E({ win: n, box: e }),
                    r = 'top' === o ? CE(n, s, t) : OE(n, s, t)
                  return ME(r)
                })
            ))(n, t, o)
        : ((e, t, o) => {
            const n = Jo(e),
              ...
              r = ((e, t, o) => {
                ...
                return re(e, (e) => {
                  switch (e) {
                    case 'bottom':
                      return kE(s, o.bounds) ? A.none() : A.some(OE(n, r, o))
                    case 'top':
                      return SE(s, o.bounds) ? A.none() : A.some(CE(n, r, o))
                    default:
                      return A.none()
                  }
      ...
      t.contextual.each((t) => {
        t.lazyContext(e).each((r) => {
          ...
          a !== o.isVisible() &&
            (o.setVisible(a),
            s && !a
              ? (Wa(e.element, [t.fadeOutClass]), t.onHide(e))
              : (a ? xE : wE)(e, t))
        })
      })
    },
    RE = (e, t, o, n, s) => {
      ;(IE(e, t, o, n, !0), FE(e, t, o, s.positionCss))
    },
    NE = (e, t, o) => {
      e.getSystem().isConnected() &&
        ((e, t, o) => {
    ...
    VE = (e, t, o) => {
      o.isDocked() &&
        ((e, t, o) => {
          ...
          ;(((e, t, o) => {
            const n = e.element
            return TE(n, t, o).bind(({ box: e }) => AE(n, e, o))
          })(e, s, o).each((n) => {
            switch (n.morph) {
              case 'static':
                BE(e, t, o)
                break
              case 'absolute':
                FE(e, t, o, n.positionCss)
            }
          }),
            o.setVisible(!0),
            t.contextual.each((t) => {
              ;(ja(n, [t.fadeInClass, t.fadeOutClass, t.transitionClass]),
                t.onShow(e))
            }),
            NE(e, t, o))
        })(e, t, o)
          ...
          Yr(or(), (o, n) => {
            e.contextual.each((e) => {
              ;(Ua(o.element, e.transitionClass) &&
                (ja(o.element, [e.transitionClass, e.fadeInClass]),
  ...
  const jE = Ol({
    ...
    GE = x(la('toolbar-height-change')),
    $E = {
      fadeInClass: 'tox-editor-dock-fadein',
      fadeOutClass: 'tox-editor-dock-fadeout',
      transitionClass: 'tox-editor-dock-transition',
    },
    qE = 'tox-tinymce--toolbar-sticky-on',
    XE = 'tox-tinymce--toolbar-sticky-off',
    YE = (e, t) => R(jE.getModes(e), t),
    KE = (e) => {
      const t = e.element
      rt(t).each((o) => {
        const n = 'padding-' + jE.getModes(e)[0]
        if (jE.isDocked(e)) {
          const e = Jt(o)
          ;(Dt(t, 'width', e + 'px'),
            Dt(
              ...
              ((e) =>
                jt(e) +
                (parseInt(It(e, 'margin-top'), 10) || 0) +
                (parseInt(It(e, 'margin-bottom'), 10) || 0))(t) + 'px'
            ))
    ...
    JE = (e, t) => {
      t
        ? (Pa(e, $E.fadeOutClass), Wa(e, [$E.transitionClass, $E.fadeInClass]))
        : (Pa(e, $E.fadeInClass), Wa(e, [$E.fadeOutClass, $E.transitionClass]))
    },
    ZE = (e, t) => {
      const o = Ve(e.getContainer())
      t ? (La(o, qE), Pa(o, XE)) : (La(o, XE), Pa(o, qE))
    },
    QE = (e, t) => {
      const o = Ql(),
        n = t.getSink,
        ...
        a = e.inline
          ? []
          : [Al.config({ channels: { [GE()]: { onReceive: KE } } })]
      return [
        oh.config({}),
        jE.config({
          contextual: {
            ...
            onShown: (e) => {
              ;(s((e) => ja(e, [$E.transitionClass, $E.fadeInClass])),
                o.get().each((t) => {
                  ;(((e, t) => {
                    const o = et(t)
                    Il(o)
  ...
  var eA = Object.freeze({
    ...
    setup: (e, t, o) => {
      ;(e.inline ||
        ...
        e.on('SkinLoaded', () => {
          o().each((e) => {
            jE.isDocked(e) ? jE.reset(e) : jE.refresh(e)
          })
        }),
    ...
    isDocked: (e) => e().map(jE.isDocked).getOr(!1),
    getBehaviours: QE,
  })
  const tA = Dn(
      [ev, ns('items', Fn([Rn([tv, ds('items', Hn)]), Hn]))].concat(Mv)
    ),
    oA = [
      ps('text'),
      ps('tooltip'),
    ...
    rA = Dn([
      ...
      iv,
      uv,
      ks('presets', 'normal', ['normal', 'color', 'listpreview']),
      kv(1),
      cv,
      dv,
    ])
          ...
          const n = H(o, (e) => {
            const o = {
              ...
              n = sA(o)
                .mapError((e) => Kn(e))
                .getOrDie()
            return QO(n, 'tox-mbtn', t.backstage, A.some('menuitem'))
          })
          Kp.set(e, n)
        },
      }
                    ...
                    e
                      ...
                      .each((o) => {
                        e.getSystem()
                          .getByDom(t)
                          .each((e) => {
                            ;(Mw.expand(e), Mw.close(o), oh.focus(e))
                          })
                      })
                })
              })
              ...
              t.event.prevFocus
                ...
                .each((o) => {
                  t.event.newFocus
                    .bind((t) => e.getSystem().getByDom(t).toOptional())
                    .each((e) => {
                      Mw.isOpen(o) && (Mw.expand(e), Mw.close(o))
                    })
                })
            }),
          ]),
  ...
  const iA = 'container',
      ...
      const o = (t) => am(e),
        ...
        a = n((e, t) => {
          if (s(e)) {
            const o = e.element
            ;(Dt(o, 'display', 'none'),
              kt(o, 'aria-hidden', 'true'),
              Ir(e, Tr(), { name: t, visible: !1 }))
          }
        }),
        i = ((e) => (t, o) => {
          L(o, (o) => e(t, o))
    ...
    mA = {
      ...
      sketch: (e) => {
        const t = (() => {
            const e = []
            return {
              slot: (t, o) => (e.push(t), Ju(iA, cA(t), o)),
              record: x(e),
            }
          })(),
          o = e(t),
          n = t.record(),
          s = H(n, (e) => Uu({ name: e, pname: cA(e) }))
        return mm(iA, lA, s, dA, o)
      },
    },
    gA = Dn([pv, hv, Os('onShow', b), Os('onHide', b), uv]),
    pA = (e) => ({ element: () => e.element.dom }),
    hA = (e, t) => {
      const o = H(ae(t), (e) => {
        const o = t[e],
          n = Xn(((e) => qn('sidebar', gA, e))(o))
        return {
          name: e,
          getApi: pA,
          onSetup: n.onSetup,
    ...
    fA = (e) =>
      mA.sketch((t) => ({
        ...
        components: hA(t, e),
        slotBehaviours: iy([Kr((e) => mA.hideAllSlots(e))]),
      })),
    bA = (e, t) => {
      kt(e, 'role', t)
    },
    vA = (e) =>
      wm
        .getCurrent(e)
        .bind((e) =>
          JO.isGrowing(e) || JO.hasGrown(e)
            ? wm
                .getCurrent(e)
                .bind((e) => G(mA.getSlotNames(e), (t) => mA.isShowing(e, t)))
            : A.none()
        ),
    yA = la('FixSizeEvent'),
    xA = la('AutoSizeEvent')
  ...
  const kA = Ol({
    ...
    OA = (e) => wm.getCurrent(e).each((e) => Dl(e.element)),
    _A = (e, t, o) => {
      const n = Es(!1),
        s = Ql(),
        r = (o) => {
          ...
          n.get() &&
            ...
            (o.preventDefault(), OA(t()), e.editorManager.setActive(e))
        }
      e.inline ||
        e.on('PreInit', () => {
    ...
    DA = (e, t, o) => {
      ...
      const s = nm(e, t, 'primary'),
        r = dw.getCoupled(e, 'overflowGroup')
      Dt(s.element, 'visibility', 'hidden')
      const a = n.concat([r]),
        i = re(a, (e) =>
          Rl(e.element).bind((t) => e.getSystem().getByDom(t).toOptional())
        )
      ;(o([]), MA(s, a))
      const l = ((e, t, o, n) => {
        const s = ((e, t, o) => {
          ...
          })(e, t, o).getOrThunk(() => EA(t, e - o(n), o)),
          r = s.within,
          a = s.extra,
          i = s.withinWidth
        return 1 === a.length && a[0].width <= o(n)
          ? ((e, t, o) => {
              const n = AA(e.concat(t))
              return TA(n, [], o)
            })(r, a, i)
          : a.length >= 1
            ? ((e, t, o, n) => {
                const s = AA(e).concat([o])
                return TA(s, AA(t), n)
              })(r, a, n, i)
            : ((e, t, o) => TA(AA(e), [], o))(r, 0, i)
      })(Jt(s.element), t.builtGroups.get(), (e) => Jt(e.element), r)
      ;(0 === l.extra.length
        ? (Kp.remove(s, r), o([]))
        : (MA(s, l.within), o(l.extra)),
        Ht(s.element, 'visibility'),
        Lt(s.element),
        i.each(oh.focus))
    },
    BA = x([
      hu('splitToolbarBehaviours', [dw]),
      es('builtGroups', () => Es([])),
    ]),
    FA = x(
      [
    ...
    IA = x([
      Uu({ factory: mE, schema: dE(), name: 'primary' }),
      Wu({ schema: dE(), name: 'overflow' }),
      ...
      Wu({
        ...
        overrides: (e) => ({
          toolbarBehaviours: kl([
            Pp.config({
              mode: 'cyclic',
              onEscape: (t) => (om(t, e, 'button').each(oh.focus), A.none()),
            }),
          ]),
        }),
      }),
    ...
    zA = Ql(),
    HA = (e, t) => {
      const o = dw.getCoupled(e, 'toolbarSandbox')
    ...
    PA = (e, t, o, n, s) => {
      ;(mE.setGroups(t, s), LA(e, t, o, n), dh.on(e))
    },
    UA = bm({
      ...
      factory: (e, t, o, n) => ({
                  ...
                  ((e, t, o) => {
                    ...
                    return {
                      ...
                      behaviours: kl([
                        Pp.config({
                          mode: 'special',
                          onEscape: (e) => (Xd.close(e), A.some(!0)),
                        }),
                        Xd.config({
                          onOpen: (s, r) => {
                            const a = zA.get().getOr(!1)
                            o.fetch().get((s) => {
                              ;(PA(e, r, o, t.layouts, s),
                                n.link(e.element),
                                a || Pp.focusIn(r))
                            })
                          },
                        ...
                        Al.config({
                          channels: {
                            ...
                            ...tu({
                              doReposition: () => {
                                Xd.getState(
                                  dw.getCoupled(e, 'toolbarSandbox')
                                ).each((n) => {
                                  LA(e, n, o, t.layouts)
                                })
                              },
        ...
        apis: {
          setGroups: (t, n) => {
            Xd.getState(dw.getCoupled(t, 'toolbarSandbox')).each((s) => {
              PA(t, s, e, o.layouts, n)
            })
          },
          reposition: (t) => {
            Xd.getState(dw.getCoupled(t, 'toolbarSandbox')).each((n) => {
              LA(t, n, e, o.layouts)
            })
          },
          toggle: (e) => {
          ...
          toggleWithoutFocusing: (e) => {
            ;((e, t) => {
              ;(zA.set(!0), HA(e, t), zA.clear())
            })(e, n)
          },
          getToolbar: (e) => Xd.getState(dw.getCoupled(e, 'toolbarSandbox')),
          isOpen: (e) => Xd.isOpen(dw.getCoupled(e, 'toolbarSandbox')),
        },
      }),
      configFields: NA(),
      partFields: VA(),
    ...
    WA = x([os('items'), Ai(['itemSelector']), hu('tgroupBehaviours', [Pp])]),
    jA = x([Gu({ name: 'items', unit: 'item' })]),
    GA = bm({
      name: 'ToolbarGroup',
      configFields: WA(),
      partFields: jA(),
      factory: (e, t, o, n) => ({
        ...
        dom: e.dom,
        components: t,
        behaviours: bu(e.tgroupBehaviours, [
          Pp.config({ mode: 'flow', selector: e.markers.itemSelector }),
        ]),
        ...
        return {
          ...
          behaviours: bu(e.splitToolbarBehaviours, [
            dw.config({
              others: {
                overflowGroup: () =>
                  GA.sketch({ ...n['overflow-group'](), items: [s.asSpec()] }),
              },
            }),
          ]),
          apis: {
            setGroups: (t, o) => {
              ;(e.builtGroups.set(H(o, t.getSystem().build)), qA(t, s, e))
            },
            refresh: (t) => qA(t, s, e),
            toggle: (e) => {
              s.getOpt(e).each((e) => {
            ...
            toggleWithoutFocusing: (e) => {
              s.getOpt(e).each(UA.toggleWithoutFocusing)
            },
            isOpen: (e) => s.getOpt(e).map(UA.isOpen).getOr(!1),
            reposition: (e) => {
              s.getOpt(e).each((e) => {
                UA.reposition(e)
              })
            },
            getOverflow: (e) => s.getOpt(e).bind(UA.getToolbar),
          },
          domModification: { attributes: { role: 'group' } },
        }
      },
        ...
        overrides: (e) => ({
          toolbarBehaviours: kl([
            ...
            Pp.config({
              mode: 'acyclic',
              onEscape: (t) => (
                om(t, e, 'overflow-button').each(oh.focus),
                A.some(!0)
              ),
            }),
          ]),
      ...
      factory: (e, t, o, n) => {
        ...
        return {
          ...
          apis: {
            ...
            toggle: (t) => JA(t, e),
            isOpen: (t) =>
              ((e, t) => om(e, t, 'overflow').map(JO.hasGrown).getOr(!1))(t, e),
          },
          domModification: { attributes: { role: 'group' } },
        }
      },
    ...
    eM = (e) => {
      ...
      return {
        ...
        tgroupBehaviours: kl([iS.config({}), oh.config({})]),
      }
    },
    tM = (e) => GA.sketch(eM(e)),
    oM = (e, t) => {
      const o = Kr((t) => {
        const o = H(e.initGroups, tM)
        mE.setGroups(t, o)
      })
      return kl([
        Cy(e.providers.isDisabled),
        wy(),
        Pp.config({
          mode: t,
          onEscape: e.onEscape,
    ...
    nM = (e) => {
      ...
      return {
        ...
        parts: {
          'overflow-group': eM({ title: A.none(), items: [] }),
          'overflow-button': O_(
            {
              name: 'more',
    ...
    rM = (e) => {
      ...
      return QA.sketch({
        ...
        onOpened: (t) => {
          ;(t.getSystem().broadcastOn([GE()], { type: 'opened' }),
            e.onToggled(t, !0))
        },
        onClosed: (t) => {
          ;(t.getSystem().broadcastOn([GE()], { type: 'closed' }),
            e.onToggled(t, !1))
        },
      })
    },
      ...
      return mE.sketch({
        ...
        dom: {
          ...
          classes: ['tox-toolbar'].concat(
            e.type === nf.scrolling ? ['tox-toolbar--scrolling'] : []
          ),
        },
        components: [mE.parts.groups({})],
        toolbarBehaviours: oM(e, t),
      })
    },
    iM = [
      gv,
      pv,
      ps('tooltip'),
      ks('buttonType', 'secondary', ['primary', 'secondary']),
      Cs('borderless', !1),
      is('onAction'),
    ],
    lM = {
      button: [...iM, nv, as('type', ['button'])],
      togglebutton: [...iM, Cs('active', !1), as('type', ['togglebutton'])],
    },
    cM = [as('type', ['group']), _s('buttons', [], Jn('type', lM))],
    dM = Jn('type', { ...lM, group: cM }),
    uM = Dn([_s('buttons', [], dM), is('onShow'), is('onHide')]),
    mM = (e, t) =>
      ((e, t) => {
        var o, n
        const s = 'togglebutton' === e.type,
          r = e.icon.map((e) => pO(e, t.icons)).map(jh),
          a = {
            ...e,
            name: s
          ...
          i = __(null !== (n = e.buttonType) && void 0 !== n ? n : 'secondary'),
              ...
              'group' === o.type
                ? ((t = !0),
                  ((e, t) => ({
                    ...
                    components: H(e.buttons, (e) => mM(e, t)),
                  }))(o, e.providers))
                : mM(o, e.providers)
            )
            return {
  ...
  const bM = (e, t, o) =>
      pe(t, (t, n) => {
        ...
        return e.slot(
          ...
          fM.sketch({
            ...
            components: [
              ...(s.buttons.length > 0
                ? [fM.parts.header({ buttons: s.buttons, providers: o })]
                : []),
              fM.parts.pane({}),
            ],
          })
    ...
    yM = (e) => G(mA.getSlotNames(e), (t) => mA.isShowing(e, t)),
    xM = (e, t, o) => {
      mA.getSlot(e, t).each((e) => {
        fM.getPane(e).each((t) => {
          var n
  ...
  var wM = fm({
    factory: (e, t) => {
      const o = {
        setViews: (e, o) => {
          Kp.set(e, [vM(o, t.backstage.shared.providers)])
        },
        whichView: (e) => wm.getCurrent(e).bind(yM),
        toggleView: (e, t, o, n) =>
          wm.getCurrent(e).exists((s) => {
            const r = yM(s),
              a = r.exists((e) => n === e),
              i = mA.getSlot(s, n).isSome()
            return (
              i &&
                (mA.hideAllSlots(s),
                a
                ...
                r.each((e) => ((e, t) => xM(e, t, fM.getOnHide))(s, e))),
              i
            )
          }),
      }
  ...
  const SM = rE.optional({
      ...
      factory: {
        sketch: (e) =>
          cE.sketch({
            ...
            dom: e.dom,
            listBehaviours: kl([
              Pp.config({ mode: 'acyclic', selector: '.tox-toolbar' }),
            ]),
            makeItem: () =>
              aM({
                type: e.type,
    ...
    CM = rE.optional({
      factory: {
        sketch: (e) => {
          const t = ((e) =>
            e.type === nf.sliding ? rM : e.type === nf.floating ? sM : aM)(e)
          return t({
            type: e.type,
            uid: e.uid,
            onEscape: () => (e.onEscape(), A.some(!0)),
    ...
    TM = rE.optional({ name: 'socket', schema: [os('dom')] }),
    EM = rE.optional({
      factory: {
        sketch: (e) => ({
          uid: e.uid,
          ...
          components: [
            {
              ...
              behaviours: kl([
                ...
                JO.config({
                  ...
                  onShrunk: (e) => {
                    ;(wm.getCurrent(e).each(mA.hideAllSlots), Fr(e, xA))
                  },
                  onGrown: (e) => {
                    Fr(e, xA)
                  },
                  onStartGrow: (e) => {
                    Ir(e, yA, { width: Nt(e.element, 'width').getOr('') })
                  },
                  onStartShrink: (e) => {
                    Ir(e, yA, { width: Jt(e.element) + 'px' })
                  },
                }),
                Kp.config({}),
                wm.config({
      ...
      factory: {
        sketch: (e) => ({
          ...
          behaviours: kl([
            Kp.config({}),
            kA.config({ focus: !1 }),
            wm.config({ find: (e) => oe(e.components()) }),
          ]),
          components: [],
        }),
      },
  ...
  var BM = bm({
    ...
    factory: (e, t, o) => {
      let n = !1
      const s = {
        getSocket: (t) => sE.getPart(t, e, 'socket'),
        setSidebar: (t, o, n) => {
          sE.getPart(t, e, 'sidebar').each((e) =>
            ((e, t, o) => {
            ...
            ((e, t) => {
              wm.getCurrent(e).each((o) => {
                wm.getCurrent(o).each((n) => {
                  JO.hasGrown(o)
                    ? mA.isShowing(n, t)
                      ? (JO.shrink(o), bA(e.element, 'presentation'))
                      : (mA.hideAllSlots(n),
                        mA.showSlot(n, t),
                        bA(e.element, 'region'))
                    : (mA.hideAllSlots(n),
        ...
        whichSidebar: (t) => sE.getPart(t, e, 'sidebar').bind(vA).getOrNull(),
        getHeader: (t) => sE.getPart(t, e, 'header'),
        getToolbar: (t) => sE.getPart(t, e, 'toolbar'),
        setToolbar: (t, o) => {
          sE.getPart(t, e, 'toolbar').each((e) => {
            const t = H(o, tM)
            e.getApis().setGroups(e, t)
          })
        },
        setToolbars: (t, o) => {
          sE.getPart(t, e, 'multiple-toolbar').each((e) => {
            const t = H(o, (e) => H(e, tM))
            cE.setItems(e, t)
          })
        },
        refreshToolbar: (t) => {
          sE.getPart(t, e, 'toolbar').each((e) => e.getApis().refresh(e))
        },
        ...
        isToolbarDrawerToggled: (t) =>
          sE
            ...
            .getOr(!1),
        getThrobber: (t) => sE.getPart(t, e, 'throbber'),
        focusToolbar: (t) => {
          sE.getPart(t, e, 'toolbar')
            .orThunk(() => sE.getPart(t, e, 'multiple-toolbar'))
            .each((e) => {
              Pp.focusIn(e)
            })
        },
        setMenubar: (t, o) => {
          sE.getPart(t, e, 'menubar').each((e) => {
            aA.setMenus(e, o)
          })
        },
        focusMenubar: (t) => {
        ...
        setViews: (t, o) => {
          sE.getPart(t, e, 'viewWrapper').each((e) => {
            wM.setViews(e, o)
          })
        },
        toggleView: (t, o) =>
          sE.getPart(t, e, 'viewWrapper').exists((e) =>
            wM.toggleView(
              e,
              () => s.showMainView(t),
              () => s.hideMainView(t),
        ...
        whichView: (t) =>
          sE.getPart(t, e, 'viewWrapper').bind(wM.whichView).getOrNull(),
        hideMainView: (t) => {
          ;((n = s.isToolbarDrawerToggled(t)),
            n && s.toggleToolbarDrawer(t),
            sE.getPart(t, e, 'editorContainer').each((e) => {
              const t = e.element
              ;(Dt(t, 'display', 'none'), kt(t, 'aria-hidden', 'true'))
            }))
        },
    ...
    partFields: [OM, SM, CM, kM, TM, EM, _M, AM, MM, DM],
    apis: {
  ...
  const FM = {
      ...
      const o = { ...FM, ...t.menus },
        ...
        s =
          void 0 === t.menubar || !0 === t.menubar
            ? IM('file edit view insert format tools table help')
            : IM(!1 === t.menubar ? '' : t.menubar),
        a = U(s, (e) => {
          const o = ve(FM, e)
        ...
        i = H(a, (n) => {
          ...
          })({ title: s.title, items: IM(s.items) }, t, e)
        })
      return U(
        i,
        (e) =>
    ...
    VM = (e, t, o) => (e.on('remove', () => o.unload(t)), o.load(t)),
    zM = (e, t) => VM(e, t + '/skin.min.css', e.ui.styleSheetLoader),
    HM = (e, t) => {
      var o
      return (
        (o = Ve(e.getElement())),
        bt(o).isSome()
          ? VM(e, t + '/skin.shadowdom.min.css', rf.DOM.styleSheetLoader)
          : Promise.resolve()
      )
    },
    LM = (e, t) => {
      ...
      return (
        ...
        !Xf(t) && r(o)
          ? Promise.all([zM(t, o), HM(t, o)]).then(
              NM(t),
              (
                (e, t) => () =>
                  ((e, t) => {
    ...
    jM = (e, t, o) => {
      const n = o.dataset,
        s =
          'basic' === n.type
            ? () => H(n.data, (e) => DT(e, o.isSelectedFor, o.getPreviewFor))
            : n.getData
      return { items: WM(0, t, o), getStyleItems: s }
    },
    GM = (e, t, o) => {
      const { items: n, getStyleItems: s } = jM(0, t, o),
        r = vx(e, 'NodeChange', (t) => {
  ...
  const qM = (e, t, o) => {
      const n =
        ((s = ((e, t) =>
          t === $M.SemiColon ? e.replace(/;$/, '').split(';') : e.split(' '))(
          e.options.get(t),
          o
        )),
        H(s, (e) => {
    ...
    YM = (e) => {
      ...
      return {
        ...
        onAction: (t) => () =>
          G(XM, (e) => e.format === t.format).each((t) =>
            e.execCommand(t.command)
          ),
        updateText: (t) => {
          const o = G(XM, (t) => e.formatter.match(t.format)).fold(
            x('left'),
            (e) => e.title.toLowerCase()
          )
          Ir(t, bO, { icon: `align-${o}` })
        },
        dataset: t,
        shouldHide: !1,
    ...
    JM = (e) => {
      const t = 'Paragraph',
        o = qM(e, 'block_formats', $M.SemiColon)
      return {
        tooltip: 'Blocks',
        text: A.some(t),
        icon: A.none(),
        ...
        onAction: yx(e),
        updateText: (n) => {
          const s = KM(e, () => o.data).fold(x(t), (e) => e.title)
          Ir(n, fO, { text: s })
        },
        dataset: o,
        shouldHide: !1,
    ...
    eD = (e) => {
      const t = 'System Font',
              ...
              Ce(
                ((e) =>
                  ...
                  (() => {
                    ...
                    return Y(ZM, (e) => t.indexOf(e.toLowerCase()) > -1)
                  })())(a),
                { title: t, format: a }
              )
            )
        ...
        n = qM(e, 'font_family_formats', $M.SemiColon)
      return {
        tooltip: 'Fonts',
        text: A.some(t),
        icon: A.none(),
    ...
    nD = (e, t) =>
      A.from(oD.exec(e)).bind((e) => {
        const o = Number(e[1]),
          n = e[2]
        return ((e, t) => N(t, (t) => N(tD[t], (t) => e === t)))(n, t)
    ...
    cD = (e) => {
      const t = () => {
        ...
        o = x(A.none),
        n = qM(e, 'font_size_formats', $M.Space)
      return {
        tooltip: 'Font sizes',
        text: A.some('12pt'),
        icon: A.none(),
    ...
    uD = x(
      [
        ...
        os('dom'),
        Di('onOpen'),
        hu('splitDropdownBehaviours', [dw, Pp, oh]),
        ys('matchWidth', !1),
        ys('useMinWidth', !1),
        ys('eventOrder', {}),
        us('role'),
    ...
    mD = Uu({
      ...
      overrides: (e) => ({
        ...
        buttonBehaviours: kl([
          dh.config({ toggleOnExecute: !1, toggleClass: e.toggleClass }),
        ]),
      }),
    }),
    gD = Uu({
    ...
    hD = bm({
      ...
      factory: (e, t, o, n) => {
        const s = (e) => {
          ...
          r = (t) => {
            Sw(e, w, t, n, s, zh.HighlightMenuAndItem).get(b)
          },
          a = (t) => {
            ...
            ...Hr([
              Kr((t, o) => {
                om(t, e, 'aria-descriptor').each((e) => {
                  const o = la('aria')
                  ;(kt(e.element, 'id', o),
                    kt(t.element, 'aria-describedby', o))
                })
              }),
            ]),
            ...mh(A.some(r)),
    ...
    yD = la('focus-button'),
    xD = (e, t, o, n, s) => {
      const r = t.map((e) => jh(hO(e, 'tox-tbtn', s))),
        a = e.map((e) => jh(pO(e, s.icons)))
      return {
        dom: {
          tag: 'button',
        ...
        components: My([a.map((e) => e.asSpec()), r.map((e) => e.asSpec())]),
        eventOrder: {
          [Ws()]: ['focusing', 'alloy.base.behaviour', cO],
          [Sr()]: [cO, 'toolbar-group-button-events'],
        },
        buttonBehaviours: kl(
          [
            Cy(s.isDisabled),
            ...
            Jp(cO, [
              ...
              Ur(bO, (e, t) => {
                a.bind((t) => t.getOpt(e)).each((e) => {
                  Kp.set(e, [pO(t.event.icon, s.icons)])
                })
              }),
              Ur(Ws(), (e, t) => {
                ;(t.event.prevent(), Fr(e, yD))
              }),
            ]),
          ].concat(n.getOr([]))
        ),
    ...
    wD = (e, t, o) => {
      var n
      const s = Es(b),
        r = xD(e.icon, e.text, e.tooltip, A.none(), o)
      return Wh.sketch({
        dom: r.dom,
              ...
              Jp('toolbar-button-events', [
                ...
                Qr((e, t) => {
                  Oy(
                    ...
                    ;(Ir(e, lO, { buttonApi: t }), a.onAction(t))
                  })
                })),
                _y(t, s),
                Ty(t, s),
              ]),
              Cy(() => !e.enabled || o.isDisabled()),
              wy(),
            ].concat(t.toolbarButtonBehaviours)
          ),
          [cO]:
            null === (n = r.buttonBehaviours) || void 0 === n ? void 0 : n[cO],
        },
      })
      var a
    },
      ...
      wD(
        e,
        {
          toolbarButtonBehaviours:
            o.length > 0 ? [Jp('toolbarButtonWith', o)] : [],
          getApi: fD,
          onSetup: e.onSetup,
        },
        t
        ...
        A.from(
          zw(
            fn(
              ...
              {
                movement: Qx(t.columns, t.presets),
                menuBehaviours: iy(
                  'auto' !== t.columns
                    ? []
                    : [
                        Kr((e, o) => {
                          ay(e, 4, Ob(t.presets)).each(
    ...
    TD = {
      button: _D(Bv, (e, t) => {
        return ((o = e), (n = t.shared.providers), SD(o, n, []))
        var o, n
      }),
      togglebutton: _D(Rv, (e, t) => {
        return ((o = e), (n = t.shared.providers), kD(o, n, []))
        var o, n
      }),
      menubutton: _D(sA, (e, t) => QO(e, 'tox-tbtn', t, A.none(), !1)),
      splitbutton: _D(
        (e) => qn('SplitButton', rA, e),
        (e, t) =>
          ((e, t) => {
            const o = (e) => ({
                isEnabled: () => !Rm.isDisabled(e),
                ...
                isActive: () =>
                  pi(e.element, 'span').exists((t) =>
                    e.getSystem().getByDom(t).exists(dh.isOn)
                  ),
                setText: (t) =>
                  pi(e.element, 'span').each((o) =>
                    e
            ...
            return hD.sketch({
              ...
              splitDropdownBehaviours: kl([
                ky(t.providers.isDisabled),
                wy(),
                Jp('split-dropdown-events', [
                  Kr((e, t) => uO(e)),
                  Ur(yD, oh.focus),
                  _y(s, n),
                  Ty(s, n),
              ...
              eventOrder: {
                [Sr()]: ['alloy.base.behaviour', 'split-dropdown-events'],
              },
              toggleClass: 'tox-tbtn--enabled',
              lazySink: t.getSink,
              fetch: CD(o, e, t.providers),
              parts: { menu: Db(0, e.columns, e.presets) },
              components: [
                hD.parts.button(
                  xD(
                    e.icon,
      ...
      grouptoolbarbutton: _D(
        (e) => qn('GroupToolbarButton', tA, e),
        (e, t, o) => {
          const n = o.ui.registry.getAll().buttons,
            s = {
              [yc]: t.shared.header.isPositionedAtTop()
                ? vc.TopToBottom
                : vc.BottomToTop,
            }
          if (Cf(o) === nf.floating)
            return ((e, t, o, n) => {
              const s = t.shared,
                ...
                i = [Jp('toolbar-group-button-events', [_y(a, r), Ty(a, r)])]
              return UA.sketch({
                lazySink: s.getSink,
                fetch: () =>
                  hw((t) => {
                ...
                parts: {
                  button: xD(e.icon, e.text, e.tooltip, A.some(i), s.providers),
                  toolbar: {
                    dom: {
                      tag: 'div',
                      classes: ['tox-toolbar__overflow'],
    ...
    ED = {
      styles: (e, t) => {
        ...
        return GM(e, t, dD(e, o))
      },
      fontsize: (e, t) => GM(e, t, cD(e)),
      fontsizeinput: (e, t) =>
        ((e, t, o) => {
          let n = A.none()
          const s = vx(e, 'NodeChange', (t) => {
              const s = t.getComponent()
              ;((n = A.some(s)),
                o.updateInputValue(s),
                Rm.set(s, !e.selection.isEditable()))
            }),
            ...
            m = (e) =>
              Fl(e.element)
                ? (ct(e.element).each((e) => Dl(e)), A.some(!0))
                : A.none(),
            g = (o, n, s, i) => {
              ...
              return Wh.sketch({
                ...
                components: [gO(n, t.shared.providers.icons)],
                buttonBehaviours: kl([
                  Rm.config({}),
                  Jp(c, [
                    _y({ onSetup: d, getApi: r }, a),
                    Ty({ getApi: r }, a),
                    Ur(Ks(), (e, t) => {
                      ;(t.event.raw.keyCode !== sD.space() &&
                        t.event.raw.keyCode !== sD.enter()) ||
                        Rm.isDisabled(e) ||
                        o(!1)
                    }),
                    Ur(er(), u),
            ...
            p = jh(
              g((e) => c(!1, e), 'minus', 'Decrease font size', [
                'highlight-on-focus',
              ])
            ),
            h = jh(
              g((e) => d(!1, e), 'plus', 'Increase font size', [
                'highlight-on-focus',
              ])
            ),
            f = jh({
          ...
          return {
            ...
            behaviours: kl([
              ...
              Pp.config({
                ...
                onEscape: (e) =>
                  Fl(e.element) ? A.none() : (Dl(e.element), A.some(!0)),
              }),
            ]),
          }
        })(
          ...
          ((e) => {
            ...
            return {
              updateInputValue: (e) => Ir(e, fO, { text: t() }),
              onAction: (t, o) =>
                e.execCommand('FontSize', !1, t, { skip_focus: !o }),
              getNewValue: (o, n) => {
                nD(o, ['unsupportedLength', 'empty'])
                const s = nD(o, ['unsupportedLength', 'empty']).or(
                    nD(t(), ['unsupportedLength', 'empty'])
                  ),
      ...
      fontfamily: (e, t) => GM(e, t, eD(e)),
      blocks: (e, t) => GM(e, t, JM(e)),
      align: (e, t) => GM(e, t, YM(e)),
    },
    AD = (e, t, o, n) => {
      const s = ((e) => {
          const t = e.toolbar,
          ...
          return !1 === t
            ...
            : void 0 === t || !0 === t
              ? ((e) => {
                  const t = H(OD, (t) => {
                    const o = U(t.items, (t) => ve(e, t) || ve(ED, t))
            ...
            0 === s.trim().length
              ...
              : ((e, t, o, n, s, r) =>
                  be(t, o.toLowerCase())
                    ...
                    .fold(
                      () => be(ED, o.toLowerCase()).map((t) => t(e, s)),
                      (t) =>
    ...
    MD = (e, t, o, n) => {
      ...
      if (f(a, r)) {
        const t = a.map((t) => {
          ...
          return AD(e, s, n, A.none())
        })
        BM.setToolbars(s, t)
      } else BM.setToolbar(s, AD(e, o, n, A.none()))
    },
    DD = Do(),
    BD = DD.os.isiOS() && DD.os.version.major <= 12
  var FD = Object.freeze({
    ...
    render: async (e, t, o, n, s) => {
      ...
      ;(Rd(d, r.mothership),
        ((e, t, o) => {
          ;(ib(e) && Rd(o.mainUi.mothership.element, o.popupUi.mothership),
            Id(t, o.dialogUi.mothership))
        })(e, u, t),
        e.on('PostRender', () => {
          ;(BM.setSidebar(l, o.sidebar, $f(e)),
            MD(e, t, o, n),
            i.set(e.getWin().innerWidth),
            BM.setMenubar(l, RM(e, o)),
            BM.setViews(l, o.views),
            ((e, t) => {
              ...
              const r = e.getDoc().documentElement,
                ...
                l = () => {
                  ...
                  ;(t.left === s.innerWidth && t.top === s.innerHeight) ||
                    (a.set($t(s.innerWidth, s.innerHeight)), mx(e))
                },
                c = () => {
                  const t = e.getDoc().documentElement,
                    o = i.get()
                  ;(o.left === t.offsetWidth && o.top === t.offsetHeight) ||
                    (i.set($t(t.offsetWidth, t.offsetHeight)), mx(e))
                },
                d = (t) => {
                  ;((e, t) => {
      ...
      const m = BM.getSocket(l).getOrDie(
      ...
      ;(xy(e, t),
        e.addCommand('ToggleSidebar', (t, o) => {
          ;(BM.toggleSidebar(l, o), e.dispatch('ToggleSidebar'))
        }),
        e.addQueryValueHandler('ToggleSidebar', () => {
          var e
          return null !== (e = BM.whichSidebar(l)) && void 0 !== e ? e : ''
        }),
        e.addCommand('ToggleView', (t, o) => {
          if (BM.toggleView(l, o)) {
            const t = l.element
            ;(r.mothership.broadcastOn([Yd()], { target: t }),
              ...
              c(BM.whichView(l)) &&
                (e.focus(), e.nodeChanged(), BM.refreshToolbar(l)))
          }
        }),
        e.addQueryValueHandler('ToggleView', () => {
          var e
          return null !== (e = BM.whichView(l)) && void 0 !== e ? e : ''
        }))
      const g = Cf(e)
      ;(g !== nf.sliding && g !== nf.floating) ||
        e.on('ResizeWindow ResizeEditor ResizeContent', () => {
          ...
          o !== i.get() &&
            (BM.refreshToolbar(t.mainUi.outerContainer), i.set(o))
        })
      const p = {
        setEnabled: (e) => {
          yy(t, !e)
  ...
  const ID = (e) =>
    ...
    VD = (e) => {
      const t = pf(e),
        o = hf(e),
        n = bf(e)
      return ID(t).map((e) => ND(e, o, n))
    },
    { ToolbarLocation: zD, ToolbarMode: HD } = cb,
    LD = (e, t, o, n, s) => {
      const { mainUi: r, uiMotherships: a } = o,
        ...
        g = Cf(e),
        p = g === HD.sliding || g === HD.floating,
        h = Es(!1),
        f = () => h.get() && !e.removed,
        b = (e) =>
          p
            ? e.fold(x(0), (e) =>
                e.components().length > 1 ? Wt(e.components()[1].element) : 0
              )
            : 0,
        v = () => {
          L(a, (e) => {
        ...
        y = (o) => {
          ...
          l ||
            s.on((e) => {
              const o = d.getOrThunk(() => {
                const e = ID(It(xt(), 'margin-left')).getOr(0)
          ...
          ;(p && BM.refreshToolbar(r.outerContainer),
            l ||
              ((o) => {
                s.on((n) => {
                  const s = BM.getToolbar(r.outerContainer),
                    a = b(s),
                    i = Jo(t),
                    { top: l, left: c } = ((e, t) =>
                      ib(e) ? vE(t) : A.none())(
          ...
          s.get().exists((o) => {
            const n = u.getDockingMode(),
              a = ((o) => {
                switch (_f(e)) {
                  case zD.auto:
                    const e = BM.getToolbar(r.outerContainer),
                      n = b(e),
                      s = Wt(o.element) - n,
                      a = Jo(t)
                    if (a.y > s) return 'top'
                    {
                      ...
                      return a.bottom < o - s || en().bottom < a.bottom - s
                        ? 'bottom'
                        : 'top'
                    }
                  case zD.bottom:
            ...
            return (
              ...
              ((i = a),
              s.on((e) => {
                ;(jE.setModes(e, [i]), u.setDockingMode(i))
      ...
      return {
        ...
        show: () => {
          ;(h.set(!0),
            ...
            w(),
            ib(e)
              ? y((e) => (jE.isDocked(e) ? jE.reset(e) : jE.refresh(e)))
              : y(jE.refresh))
        },
        hide: () => {
          ;(h.set(!1),
  ...
  var UD = Object.freeze({
    ...
    render: async (e, t, o, n, s) => {
      ...
      const d = () => {
        ...
        a.set(BM.getHeader(r.outerContainer).getOrDie())
        const s = sb(e)
        ;(ib(e)
          ? (Rd(i, r.mothership), Rd(i, t.popupUi.mothership))
          : Id(s, r.mothership),
          Id(s, t.dialogUi.mothership),
          MD(e, t, o, n),
          BM.setMenubar(r.outerContainer, RM(e, o)),
          l.show(),
          ((e, t, o, n) => {
            const s = Es(PD(t, o.isPositionedAtTop())),
              r = (n) => {
                const { pos: r, bounds: a } = PD(t, o.isPositionedAtTop()),
            ...
            ;(n || (e.on('activate', o.show), e.on('deactivate', o.hide)),
              e.on('SkinLoaded ResizeWindow', () => o.update(jE.reset)),
              e.on('NodeChange keydown', (e) => {
                requestAnimationFrame(() => r(e))
              }))
            let a = 0
            const i = HC(() => o.update(jE.refresh), 33)
            ;(e.on('ScrollWindow', () => {
              const e = Uo().left
  ...
  const WD = 'contexttoolbar-hide',
                ...
                ((e) => 'contextformtogglebutton' === e.type)(t)
                  ? ((e, t, o) => {
                      const { primary: n, ...s } = t.original,
                        r = Xn(Rv({ ...s, type: 'togglebutton', onAction: b }))
                      return kD(r, o, [jD(e, t)])
                    })(e, t, o)
                  : ((e, t, o) => {
                      const { primary: n, ...s } = t.original,
                        r = Xn(Bv({ ...s, type: 'button', onAction: b }))
                      return SD(r, o, [jD(e, t)])
                    })(e, t, o))(e, t, o)
            )
          )
          return {
    ...
    $D = (e, t, o) => t.bottom - e.y >= o && e.bottom - t.y >= o,
    qD = (e) => {
      const t = ((e) => {
        const t = e.getBoundingClientRect()
    ...
    KD = { maxHeightFunction: cc(), maxWidthFunction: RA() },
    JD = (e) => 'node' === e,
    ZD = (e, t, o, n, s) => {
      const r = qD(e),
      ...
      return ((e, t) => {
        ...
        : a
          ? ((e, o, s) => {
              ...
              Dt(e, 'position', o)
              const i = $D(r, Jo(t), -20) && !n.isReposition() ? gT : uT
              return (a.each((t) => Dt(e, 'position', t)), i)
            })(t, n.getMode())
          : ('fixed' === n.getMode() ? s.y + Uo().top : s.y) + (Wt(t) + 12) <=
              r.y
            ? aT
            : iT
    },
    QD = (e, t, o, n) => {
      const s = (t) => (n, s, r, a, i) => ({
          ...ZD(e, a, t, o, i)({ ...n, y: i.y, height: i.height }, s, r, a, i),
          alwaysFit: !0,
        }),
        r = (e) => (JD(n) ? [s(e)] : [])
      return t
        ? {
            onLtr: (e) => [cl, sl, rl, al, il, ll].concat(r(e)),
            onRtl: (e) => [cl, rl, sl, il, al, ll].concat(r(e)),
          }
        : {
            onLtr: (e) => [ll, cl, al, sl, il, rl].concat(r(e)),
            onRtl: (e) => [ll, cl, il, rl, al, sl].concat(r(e)),
          }
    },
    eB = (e, t) => {
    ...
    tB = (e, t) => {
      ...
      return (
        L(i, (i) => {
          ...
          'contextform' === l.type
            ? ((e, i) => {
                const l = Xn(qn('ContextForm', Uv, i))
                ;((o[e] = l),
                  l.launch.map((o) => {
                    r['form:' + e] = {
                      ...i.launch,
            ...
            : 'contexttoolbar' === l.type &&
              ((e, t) => {
                var o
                ;((o = t), qn('ContextToolbar', Wv, o)).each((o) => {
    ...
    oB = la('forward-slide'),
    nB = la('backward-slide'),
    sB = la('change-slide-event'),
    rB = 'tox-pop--resizing',
    aB = 'tox-pop--transition',
    iB = (e, t, o, n) => {
      const s = n.backstage,
        r = s.shared,
                ...
                Jp('context-toolbar-events', [
                  Yr(or(), (e, t) => {
                    'width' === t.event.raw.propertyName &&
                      (Pa(e.element, rB), Ht(e.element, 'width'))
                  }),
                  Ur(sB, (e, t) => {
                    const o = e.element
                    Ht(o, 'width')
                    const n = Jt(o)
                    ;(Ph.setContent(e, t.event.contents), La(o, rB))
                    const s = Jt(o)
                    ;(Dt(o, 'width', n + 'px'),
                      Ph.getContent(e).each((e) => {
                        t.event.focus
                          .bind((e) => (Dl(e), Rl(o)))
                          .orThunk(() => (Pp.focusIn(e), Il(ht(o))))
                      }),
                      setTimeout(() => {
                  ...
                  Ur(oB, (e, o) => {
                    ;(Ph.getContent(e).each((o) => {
                      t.set(
                        t.get().concat([{ bar: o, focus: Il(ht(e.element)) }])
                      )
                    }),
                      Ir(e, sB, {
                  ...
                  Ur(nB, (e, o) => {
                    ne(t.get()).each((o) => {
                      ;(t.set(t.get().slice(0, t.get().length - 1)),
                        Ir(e, sB, { contents: ai(o.bar), focus: o.focus }))
                    })
                  }),
                ]),
                Pp.config({
              ...
              o = xe(c.get(), 'node')
                ? ((e, t) =>
                    t
                      .filter((e) => yt(e) && je(e))
                      .map(Zo)
                      .getOrThunk(() => qD(e)))(e, i.get())
                : qD(e)
            return t.height <= 0 || !$D(o, t, 0.01)
          }
          return !0
        },
        p = () => {
        ...
        h = () => {
          if (Ph.isOpen(d)) {
            const e = d.element
            ;(Ht(e, 'display'),
              g() ? Dt(e, 'display', 'none') : (l.set(0), Ph.reposition(d)))
          }
        },
        f = (t) => ({
        ...
        x = (t, n) => {
              ...
              const s = 'node' === t ? r.anchors.node(n) : r.anchors.cursor(),
                c = ((e, t, o, n) =>
                  'line' === t
                    ? {
                        bubble: gc(12, 0, YD),
                        layouts: { onLtr: () => [dl], onRtl: () => [ul] },
                        overrides: KD,
                      }
                    : {
                        bubble: gc(0, 12, YD, 1 / 12),
                        layouts: QD(e, o, n, t),
                        overrides: KD,
                      })(e, t, a(), {
                  lastElement: i.get,
          ...
          const b = d.element
          ;(Ht(b, 'display'),
            ((e) => xe(Se(e, i.get(), Ze), !0))(n) ||
              (Pa(b, aB), Sd.reset(o, d)),
            Ph.showWithinBounds(
              d,
              f(s),
              { anchor: h, transition: { classes: [aB], mode: 'placement' } },
              () => A.some(u())
            ),
          ...
          e.on('contexttoolbar-show', (t) => {
            ...
            be(o.lookupTable, t.toolbarKey).each((o) => {
              ;(x([o], Ce(t.target !== e, t.target)),
                Ph.getContent(d).each(Pp.focusIn))
            })
          }),
          e.on('focusout', (t) => {
            Uh.setEditorTimeout(
    ...
    uB = (e, t) => (o) => {
      ...
      return (
        ...
        hx(() => e.off('PastePlainTextToggle', n), fx(e)(o))
      )
    },
    mB = (e, t) => () => {
    ...
    pB = (e, t) =>
      vx(e, 'Undo Redo AddUndo TypingUndo ClearUndos SwitchMode', (o) => {
      ...
      ;(((e) => {
        ...
        ((e) => {
          ...
          ;(Xx(e, 'forecolor', 'forecolor', 'Text color', n),
            Xx(e, 'backcolor', 'hilitecolor', 'Background color', s),
        ...
        ((e) => {
          ;(((e) => {
            e.ui.registry.addButton('visualaid', {
              tooltip: 'Visual aids',
              text: 'Visual aids',
              onAction: xx(e, 'mceToggleVisualAid'),
            })
          })(e),
            ((e) => {
        ...
        ((e) => {
          ;((e) => {
            ;(e.ui.registry.addButton('outdent', {
              ...
              icon: 'outdent',
              onSetup: dB(e),
              onAction: xx(e, 'outdent'),
            }),
              e.ui.registry.addButton('indent', {
                tooltip: 'Increase indent',
                icon: 'indent',
                onSetup: fx(e),
                onAction: xx(e, 'indent'),
              }))
          })(e)
        })(e),
        cB(e),
    ...
    bB = (e) => (r(e) ? e.split(/[ ,]/) : e),
    vB = (e) => (t) => t.options.get(e),
    yB = vB('contextmenu_never_use_native'),
    xB = vB('contextmenu_avoid_overlap'),
    wB = (e) => {
      const t = e.ui.registry.getAll().contextMenus,
        o = e.options.get('contextmenu')
      return e.options.isSet('contextmenu') ? o : U(o, (e) => ve(t, e))
    },
    SB = (e, t) => ({ type: 'makeshift', x: e, y: t }),
    kB = (e) => 'longpress' === e.type || 0 === e.type.indexOf('touch'),
    CB = (e, t) =>
      'contextmenu' === t.type || 'longpress' === t.type
        ? e.inline
          ? ((e) => {
              if (kB(e)) {
                const t = e.touches[0]
                return SB(t.pageX, t.pageY)
              }
              return SB(e.pageX, e.pageY)
            })(t)
          : ((e, t) => {
              const o = rf.DOM.getPos(e)
              return ((e, t, o) => SB(e.x + t, e.y + o))(t, o.x, o.y)
            })(
              e.getContentAreaContainer(),
              ((e) => {
                if (kB(e)) {
                  const t = e.touches[0]
                  return SB(t.clientX, t.clientY)
                }
                return SB(e.clientX, e.clientY)
              })(t)
            )
        : OB(e),
    OB = (e) => ({ type: 'selection', root: Ve(e.selection.getNode()) }),
    _B = (e, t, o) => {
      switch (o) {
        case 'node':
          return ((e) => ({
      ...
      SO(a, gb.CLOSE_ON_EXECUTE, n, {
        ...
        ;(t.preventDefault(),
          Ph.showMenuAt(
            s,
            { anchor: i },
            { menu: { markers: Eb('normal') }, data: e }
          ))
      })
    },
    EB = {
      onLtr: () => [cl, sl, rl, al, il, ll, aT, iT, rT, nT, sT, oT],
      onRtl: () => [cl, rl, sl, il, al, ll, aT, iT, sT, oT, rT, nT],
    },
    AB = {
      valignCentre: [],
      alignCentre: [],
        ...
        u = () => {
          ...
          ;((e, t, o, n, s, r, a) => {
            const i = ((e, t, o) => {
              const n = _B(e, t, o)
              return {
                bubble: gc(0, 'point' === o ? 12 : 0, AB),
                layouts: EB,
                overrides: { maxWidthFunction: RA(), maxHeightFunction: cc() },
                ...n,
              }
            })(e, t, r)
            SO(o, gb.CLOSE_ON_EXECUTE, n, {
              isHorizontalMenu: !0,
              search: A.none(),
            }).map((o) => {
              t.preventDefault()
              ...
              ;(Ph.showMenuWithinBounds(
                ...
                { anchor: i },
                {
                  menu: { markers: Eb('normal'), highlightOnOpen: l },
                  data: o,
                  type: 'horizontal',
                },
                () =>
                  A.some(XD(e, n.shared, 'node' === r ? 'node' : 'selection'))
              ),
                e.dispatch(WD))
            })
          })(e, t, a, n, s, r, !(c || i || (l && d)))
    ...
    IB = (e, t) => {
      ...
      return e.concat(o).concat(t).concat([BB])
    },
    RB = (e, t) =>
      !((e) => 'longpress' === e.type || ve(e, 'touches'))(t) &&
      (2 !== t.button || (t.target === e.getBody() && '' === t.pointerType)),
    NB = (e, t) => (RB(e, t) ? e.selection.getStart(!0) : t.target),
    VB = (e, t, o) => {
      const n = Do().deviceType.isTouch,
        ...
        i = (t) => {
          if (
            (yB(e) && t.preventDefault(),
            ((e, t) => t.ctrlKey && !yB(e))(e, t) ||
              ((e) => 0 === wB(e).length)(e))
          )
            return
          const a = ((e, t) => {
            const o = xB(e),
              n = RB(e, t) ? 'selection' : 'point'
            if (De(o)) {
              const s = NB(e, t)
              return jw(Ve(s), o) ? 'node' : n
            }
            return n
          })(e, t)
          ;(n() ? MB : TB)(
    ...
    HB = (e) => (t) => t.translate(-e.left, -e.top),
    LB = (e) => (t) => t.translate(e.left, e.top),
    PB = (e) => (t, o) => j(e, (e, t) => t(e), $t(t, o)),
    UB = (e, t, o) => e.fold(PB([LB(o), HB(t)]), PB([HB(t)]), PB([])),
    WB = (e, t, o) => e.fold(PB([LB(o)]), PB([]), PB([LB(t)])),
    jB = (e, t, o) => e.fold(PB([]), PB([HB(o)]), PB([LB(t), HB(o)])),
    GB = (e, t, o) => {
      const n = e.fold(
        (e, t) => ({
    ...
    $B = (e, t, o, n) => {
      ...
      return e.fold(s(jB, qB), s(WB, XB), s(UB, YB))
    },
    qB = zB.offset,
    XB = zB.absolute,
    YB = zB.fixed,
    ...
    JB = (e, t, o, n, s, r) => {
      const a = ((e, t, o, n) =>
          ((e, t) => {
            ...
            () => o,
            (e) => YB(e.left + n.left, e.top + n.top)
          ))(e, t, o, n),
        i = t.mustSnap ? QB(e, t, a, s, r) : eF(e, t, a, s, r),
        l = UB(a, s, r)
      return (
        ((e, t, o) => {
          const n = e.element
        ...
        i.fold(
          () => ({ coord: YB(l.left, l.top), extra: A.none() }),
    ...
    ZB = (e, t, o, n) =>
      re(e, (e) => {
        ...
        return r
          ? A.some({ output: $B(e.output, t, o, n), extra: e.extra })
          : A.none()
      }),
    QB = (e, t, o, n, s) => {
      const r = t.getSnapPoints(e)
      return ZB(r, o, n, s).orThunk(() => {
        const e = j(
          r,
          (e, t) => {
            const r = t.sensor,
  ...
  const iF = [
    ...
    lF = (e) => {
      ...
      t.isSome() && o.isSome() && n.isSome()
        ? A.some(
            ((e, t, o) =>
              ('fixed' === o ? YB : qB)(parseInt(e, 10), parseInt(t, 10)))(
              t.getOrDie(),
              o.getOrDie(),
              n.getOrDie()
            )
    ...
    dF = (e, t, o, n, s) => {
      const r = o.update(n, s),
        a = o.getStartData().getOrThunk(() => cF(t, e))
      r.each((o) => {
        ;((e, t, o, n) => {
          const s = t.getTarget(e.element)
          if (t.repositionTarget) {
                ...
                ((e, t, o, n, s) => {
                  ...
                  t.fold(
                    () => {
                      ...
                      var t, a, i
                      const l = UB(e, n, s)
                      return YB(l.left, l.top)
                    },
                    (t) => {
                      const a = JB(e, t, o, r, n, s)
                      return (
                        a.extra.each((o) => {
                          t.onSensor(e, o)
                        }),
  ...
  const pF = (e, t, o) => [
    ...
    hF = [...iF, Ri('dragger', { handlers: mF(pF) })]
  ...
  const bF = (e, t, o) => {
    ...
    vF = hF,
    yF = [...iF, Ri('dragger', { handlers: mF(bF) })],
    xF = [
      ...iF,
      Ri('dragger', {
        handlers: mF((e, t, o) => [...pF(e, t, o), ...bF(e, t, o)]),
      }),
    ]
  ...
  const kF = Tl({
      ...
      e.fold(
        ...
        (e) => {
          ...
          return kF.snap({
            sensor: XB(s, r),
            range: $t(40, 40),
            output: XB(A.some(o - a.width / 2), A.some(n - a.height / 2)),
            extra: { td: t },
          })
        }
      ),
    ...
    TF = (e, t) => {
      const o = Es([]),
        ...
        i = (e) => {
          const o = Zo(e)
          return CF(u.getOpt(t), e, o.x, o.y, o.width, o.height)
        },
        l = (e) => {
          const o = Zo(e)
          return CF(m.getOpt(t), e, o.right, o.bottom, o.width, o.height)
        },
        c = OF(
          () => H(o.get(), (e) => i(e)),
          r,
  ...
  const MF = (e, t, o) => {
      const n = Ve(e.getContainer()),
        s = ((e, t, o, n, s) => {
          const r = { height: ND(n + t.top, ff(e), vf(e)) }
          return (o === AF.Both && (r.width = ND(s + t.left, hf(e), bf(e))), r)
        })(e, t, o, Wt(n), Jt(n))
      ;(le(s, (e, t) => {
        h(e) && Dt(n, t, RD(e))
      }),
      ...
      components: (() => {
        const o = (() => {
            ...
            return (
              ...
              e.hasPlugin('wordcount') &&
                o.push(
                  ((e, t) => {
                    const o = (e, o, n) =>
                      Kp.set(e, [ti(t.translate(['{0} ' + n, o[n]]))])
                    return Wh.sketch({
                      dom: {
                        tag: 'button',
                      ...
                      buttonBehaviours: kl([
                        ...
                        Jp('wordcount-events', [
                          Qr((e) => {
                            ...
                            ;(pu.setValue(e, { mode: n, count: t.count }),
                              o(e, t.count, n))
                          }),
                          Kr((t) => {
                            e.on('wordCountUpdate', (e) => {
                              const { mode: n } = pu.getValue(t)
                              ;(pu.setValue(t, { mode: n, count: e.wordCount }),
                                o(t, e.wordCount, n))
                            })
                          }),
                        ]),
          ...
          n = ((e, t) => {
            const o = ((e) => {
              const t = jf(e)
              return !1 === t ? AF.None : 'both' === t ? AF.Both : AF.Vertical
            })(e)
            if (o === AF.None) return A.none()
            const n =
              o === AF.Both
    ...
    FF = (e, t) => t.get().getOrDie(`UI for ${e} has not been rendered`),
    IF = (e, t) => {
      const o = e.inline,
        n = o ? UD : FD,
        s = ab(e) ? eA : bE,
        ...
        b = r.lazyGetInOuterOrDie('toolbar', BM.getToolbar),
        v = r.lazyGetInOuterOrDie('throbber', BM.getThrobber),
        y = ((e, t, o, n) => {
          const s = Es(!1),
            r = ((e) => {
              const t = Es(tb(e) ? 'bottom' : 'top')
              return {
            ...
            c = ((e) => ({
              colorPicker: wT(e),
              hasCustomColors: ST(e),
              getColors: kT(e),
              getColorCols: CT(e),
            }))(t),
            d = ((e) => ({ isDraggableModal: OT(e) }))(t),
            u = {
              shared: {
                providers: a,
                anchors: xT(t, o, n, r.isPositionedAtTop),
                header: r,
              },
              urlinput: i,
              styles: l,
        ...
        x = () => {
          const t = (() => {
              const t = {
                  attributes: { [yc]: d ? vc.BottomToTop : vc.TopToBottom },
                },
                o = BM.parts.menubar({
                ...
                i = Yf(e),
                l = qf(e),
                c = BM.parts.promotion({
                  dom: { tag: 'div', classes: ['tox-promotion'] },
                }),
                g = r || a || i,
                h = l ? [c, o] : [o]
              return BM.parts.header({
                dom: {
                  tag: 'div',
            ...
            r = BM.parts.viewWrapper({ backstage: y.popup }),
            i =
              Pf(e) && !o ? A.some(BF(e, y.popup.shared.providers)) : A.none(),
            l = q([d ? [] : [t], o ? [] : [n], d ? [t] : []]),
            h = BM.parts.editorContainer({
        ...
        w = (t) => {
          const o = RD(
            ...
            n = RD(((e) => VD(e).getOr(pf(e)))(e))
          return (
            e.inline ||
              (zt('div', 'width', n) && Dt(t.element, 'width', n),
              zt('div', 'height', o)
                ? Dt(t.element, 'height', o)
                : Dt(t.element, 'height', '400px')),
            o
          )
        }
      return {
        popups: { backstage: y.popup, getMothership: () => FF('popups', l) },
        dialogs: { backstage: y.dialog, getMothership: () => FF('dialogs', i) },
        renderUI: () => {
          const o = x(),
            a = (() => {
              const t = sb(e),
                ...
                n = {
                  ...
                  behaviours: kl([
                    Sd.config({ useFixed: () => s.isDocked(p) }),
                  ]),
                },
                r = {
            ...
            ;((f = o.outerContainer),
              ...
              e.addCommand('ToggleToolbarDrawer', (e, t) => {
                ;(null == t ? void 0 : t.skipFocus)
                  ? BM.toggleToolbarDrawerWithoutFocusing(f)
                  : BM.toggleToolbarDrawer(f)
              }),
              e.addQueryStateHandler('ToggleToolbarDrawer', () =>
                BM.isToolbarDrawerToggled(f)
              ),
              ((e, t, o) => {
                const n = (e, n) => {
                    L([t, ...o], (t) => {
              ...
              fB(e, y.popup),
              VB(e, y.popup.shared.getSink, y.popup),
              ((e) => {
              ...
              _A(e, v, y.popup.shared),
              iB(e, c, r.sink, { backstage: y.popup }),
              TF(e, r.sink))
            const b = {
    ...
    VF = x([
      ...
      Uu({ factory: NF, schema: [os('dom')], name: 'close' }),
      Uu({ factory: NF, schema: [os('dom')], name: 'body' }),
      ju({ factory: NF, schema: [os('dom')], name: 'footer' }),
      Wu({
        factory: {
    ...
    zF = bm({
      ...
      factory: (e, t, o, n) => {
        const s = Ql(),
          ...
          a = {
            ...e.eventOrder,
            [Sr()]: [r].concat(e.eventOrder['alloy.system.attached'] || []),
          }
        return {
          uid: e.uid,
          dom: e.dom,
    ...
    HF = Dn([ev, tv].concat(Kv)),
    LF = Ln,
    PF = [
      Tv('button'),
      pv,
      ks('align', 'end', ['start', 'end']),
      Sv,
      wv,
      hs('buttonType', ['primary', 'secondary']),
    ],
    UF = [...PF, nv],
    WF = [as('type', ['submit', 'cancel', 'custom']), ...UF],
    jF = [as('type', ['menu']), gv, hv, pv, ds('items', HF), ...PF],
    GF = [
      ...PF,
      as('type', ['togglebutton']),
      rs('tooltip'),
      pv,
      gv,
      Cs('active', !1),
    ...
    qF = [
      ev,
      nv,
      as('level', ['info', 'warn', 'error', 'success']),
      rv,
      ys('url', ''),
    ],
    XF = Dn(qF),
    YF = [
      ...
      pv,
      xv,
      hs('buttonType', ['primary', 'secondary', 'toolbar']),
      Sv,
    ],
    KF = Dn(YF),
    JF = [ev, tv],
    ...
    eI = Dn(QF),
    tI = Ln,
    oI = ZF.concat([kv('auto')]),
    nI = Dn(oI),
    sI = Rn([av, nv, rv]),
    rI = ZF.concat([Ss('storageKey', 'default')]),
    aI = Dn(rI),
    iI = Hn,
    lI = Dn(ZF),
    cI = Hn,
    dI = JF.concat([
      ...
      rs('scriptId'),
      rs('scriptUrl'),
      xs('settings', void 0, Wn),
    ]),
    uI = JF.concat([Ss('tag', 'textarea'), is('init')]),
    mI = Gn((e) =>
      qn('customeditor.old', Mn(uI), e).orThunk(() =>
        qn('customeditor.new', Mn(dI), e)
      )
    ),
    gI = Hn,
    pI = Dn(ZF),
    hI = Bn(On),
    fI = (e) => [ev, ss('columns'), e],
    bI = [
      ev,
      rs('html'),
      ks('presets', 'presentation', ['presentation', 'document']),
    ],
    vI = Dn(bI),
    yI = ZF.concat([
      Cs('border', !1),
    ...
    xI = Dn(yI),
    wI = Hn,
    SI = Dn(JF.concat([ps('height')])),
    kI = Dn([rs('url'), gs('zoom'), gs('cachedWidth'), gs('cachedHeight')]),
    CI = ZF.concat([
      ps('inputMode'),
      ps('placeholder'),
      Cs('maximized', !1),
    ...
    OI = Dn(CI),
    _I = Hn,
    TI = (e) => [ev, ov, e, ks('align', 'start', ['start', 'center', 'end'])],
    EI = [nv, av],
    AI = [
      nv,
      ds(
    ...
    MI = Fn([Dn(EI), Dn(AI)]),
    DI = ZF.concat([ds('items', MI), wv]),
    BI = Dn(DI),
    FI = Hn,
    II = ZF.concat([cs('items', [nv, av]), ws('size', 1), wv]),
    RI = Dn(II),
    NI = Hn,
    VI = ZF.concat([Cs('constrain', !0), wv]),
    zI = Dn(VI),
    HI = Dn([rs('width'), rs('height')]),
    LI = JF.concat([ov, ws('min', 0), ws('max', 0)]),
    PI = Dn(LI),
    UI = zn,
    WI = [ev, ds('header', Hn), ds('cells', Bn(Hn))],
    jI = Dn(WI),
    GI = ZF.concat([ps('placeholder'), Cs('maximized', !1), wv]),
    $I = Dn(GI),
    qI = Hn,
    XI = [as('type', ['directory', 'leaf']), sv, rs('id'), ms('menu', nA)],
    YI = Dn(XI),
    KI = XI.concat([
      ds(
        'children',
        Zn(0, () => jn('type', { directory: JI, leaf: YI }))
      ),
    ]),
    JI = Dn(KI),
    ZI = jn('type', { directory: JI, leaf: YI }),
    QI = [
      ev,
      ds('items', ZI),
      fs('onLeafAction'),
      fs('onToggleExpand'),
      _s('defaultExpandedIds', [], Hn),
      ps('defaultSelectedId'),
    ],
    eR = Dn(QI),
    tR = ZF.concat([ks('filetype', 'file', ['image', 'media', 'file']), wv]),
    oR = Dn(tR),
    nR = Dn([av, Cv]),
    sR = (e) =>
      Qn(
        ...
        Bn(
          Gn((t) =>
            qn(`Checking item of ${e}`, rR, t).fold(
              (e) => sn.error(Kn(e)),
              (e) => sn.value(e)
            )
          )
    ...
    aR = [ev, ys('classes', []), ds('items', rR)],
    iR = Dn(aR),
    lR = [Tv('tab'), sv, ds('items', rR)],
    cR = [ev, cs('tabs', lR)],
    dR = Dn(cR),
    uR = UF,
    mR = $F,
    gR = Dn([
      rs('title'),
      ns('body', jn('type', { panel: iR, tabpanel: dR })),
      Ss('size', 'normal'),
      _s('buttons', [], mR),
      ys('initialData', {}),
      Os('onAction', b),
    ...
    pR = Dn([as('type', ['cancel', 'custom']), ...uR]),
    hR = Dn([
      rs('title'),
      rs('url'),
      gs('height'),
    ...
    fR = (e) => (a(e) ? [e].concat(X(fe(e), fR)) : l(e) ? X(e, fR) : []),
    bR = (e) => r(e.type) && r(e.name),
    vR = {
      checkbox: tI,
      colorinput: iI,
      colorpicker: cI,
    ...
    yR = (e) => {
      const t = ((e) => U(fR(e), bR))(e),
        o = X(t, (e) =>
          ((e) => A.from(vR[e.type]))(e).fold(
            () => [],
            (t) => [ns(e.name, t)]
          )
        )
    ...
    xR = (e) => {
      var t
      return {
        internalDialog: Xn(qn('dialog', gR, e)),
        dataValidator: yR(e),
    ...
    wR = {
      ...
      openUrl: (e, t) => e(Xn(qn('dialog', hR, t))),
      redial: (e) => xR(e),
    }
  var SR = Object.freeze({
    ...
    kR = Object.freeze({ __proto__: null, getState: (e, t, o) => o }),
    CR = [
      os('channel'),
      us('renderComponents'),
      us('updateState'),
  ...
  const OR = Ol({
    ...
    TR = (e, t, o) => {
      const n = jh(
        SC.sketch((n) => ({
          ...
          components: H(e.items, (e) => $_(n, e, t, o)),
        }))
      )
      return {
        ...
        behaviours: kl([
          Pp.config({ mode: 'acyclic', useTabstopAt: C($C) }),
          ((s = n), wm.config({ find: s.getOpt })),
          BC(n, {
            postprocess: (e) => _R(e).fold((e) => (console.error(e), {}), w),
          }),
          Jp('dialog-body-panel', [
            Ur(Xs(), (e, t) => {
              e.getSystem().broadcastOn([ZC], {
    ...
    AR = x([
      ...
      os('dom'),
      ys('clickToDismiss', !1),
      hu('tabbarBehaviours', [Gm, Pp]),
      Ai(['tabClass', 'selectedClass']),
    ]),
    MR = Gu({
      factory: ER,
      name: 'tabs',
          ...
          apis: {
            ...
            showTab: (e, t) => {
              s(e, (e) => {
                ...
                return G(o, (e) => pu.getValue(e) === t).filter(
                  (t) => !Gm.isHighlighted(e, t)
                )
              })
            },
          },
              ...
              (o) => (
                ...
                Math.min(
                  ...
                  ((e, t, o) => {
                    ...
                    const a = Wt(t),
                      i =
                        t.dom.offsetLeft >= o.dom.offsetLeft + Jt(o)
                          ? Math.max(Wt(o), a)
                          : a,
    ...
    PR = (e) => pi(e, '[role="tabpanel"]'),
    UR = 'send-data-to-section',
    ...
    jR = (e, t, o) => {
          ...
          view: () => [
            SC.sketch((n) => ({
              ...
              formBehaviours: kl([
                ...
                Al.config({
                  channels: Ds([
                    { key: UR, value: { onReceive: s } },
                    { key: WR, value: { onReceive: r } },
                  ]),
                }),
              ]),
            })),
              ...
              Kr((o) => {
                ...
                PR(n).each((s) => {
                  ;(Dt(s, 'visibility', 'hidden'),
                    ...
                    Ht(s, 'visibility'),
                    ((e, t) => {
                      oe(e).each((e) => zR.showTab(t, e.value))
                    })(e, o),
                    requestAnimationFrame(() => {
                      LR(n, s, t)
                    }))
      ...
      return zR.sketch({
        ...
        onChangeTab: (e, t, o) => {
          const n = pu.getValue(t)
          ;(Ir(e, xS, { name: n, oldName: a.get() }), a.set(n))
        },
        tabs: i,
        components: [
          zR.parts.tabbar({
            dom: { tag: 'div', classes: ['tox-dialog__body-nav'] },
            components: [BR.parts.tabs({})],
            markers: {
              tabClass: 'tox-tab',
              selectedClass: 'tox-dialog__body-nav-item--active',
            },
            tabbarBehaviours: kl([iS.config({})]),
          }),
          zR.parts.tabview({
            dom: { tag: 'div', classes: ['tox-dialog__body-content'] },
          }),
        ...
        tabSectionBehaviours: kl([
          ...
          Pp.config({ mode: 'acyclic' }),
          wm.config({ find: (e) => oe(zR.getViewItems(e)) }),
          FC(
            A.none(),
            (e) => (e.getSystem().broadcastOn([UR], {}), n.get()),
            (e, t) => {
        ...
        OR.config({
          ...
          renderComponents: (e) => {
            ...
            return 'tabpanel' === t.type
              ? [jR(t, e.initialData, n)]
              : [TR(t, e.initialData, n)]
          },
          initialData: e,
        }),
      ]),
  ...
  var JR = Object.hasOwnProperty,
    ...
    nN = Object.seal,
    sN = Object.create,
    rN = 'undefined' != typeof Reflect && Reflect,
    aN = rN.apply,
    iN = rN.construct
  ;(aN ||
    (aN = function (e, t, o) {
  ...
  var lN,
    cN = yN(Array.prototype.forEach),
    dN = yN(Array.prototype.pop),
    uN = yN(Array.prototype.push),
    mN = yN(String.prototype.toLowerCase),
    gN = yN(String.prototype.match),
    pN = yN(String.prototype.replace),
    hN = yN(String.prototype.indexOf),
    fN = yN(String.prototype.trim),
    bN = yN(RegExp.prototype.test),
    vN =
      ((lN = TypeError),
      function () {
  ...
  function SN(e, t) {
    for (; null !== e; ) {
      var o = tN(e, t)
      if (o) {
        if (o.get) return yN(o.get)
        if ('function' == typeof o.value) return yN(o.value)
      }
      e = eN(e)
    }
    return function (e) {
  ...
  var kN = oN([
    ...
    WN = (function e() {
      var t =
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : UN(),
        o = function (t) {
          return e(t)
        }
      if (
      ...
      var w = (function (e, t) {
          if ('object' !== $R(e) || 'function' != typeof e.createPolicy)
            return null
          var o = null,
        ...
        A = {}
      try {
        A = wN(s).documentMode ? s.documentMode : {}
      } catch (e) {}
      var M = {}
      o.isSupported =
        'function' == typeof y &&
      ...
      var D,
        ...
        H = zN,
        L = null,
        P = xN({}, [].concat(YR(kN), YR(CN), YR(ON), YR(TN), YR(AN))),
        U = null,
        W = xN({}, [].concat(YR(MN), YR(DN), YR(BN), YR(FN))),
        j = Object.seal(
          Object.create(null, {
            tagNameCheck: {
              writable: !0,
        ...
        ce = null,
        de = xN({}, ['audio', 'video', 'img', 'source', 'image', 'track']),
        ue = null,
        me = xN({}, [
          'alt',
          'class',
        ...
        Se = function (e) {
          ;(ye && ye === e) ||
            ((e && 'object' === $R(e)) || (e = {}),
            (e = wN(e)),
            (L = 'ALLOWED_TAGS' in e ? xN({}, e.ALLOWED_TAGS) : P),
            (U = 'ALLOWED_ATTR' in e ? xN({}, e.ALLOWED_ATTR) : W),
            (ue =
              'ADD_URI_SAFE_ATTR' in e ? xN(wN(me), e.ADD_URI_SAFE_ATTR) : me),
            (ce =
              'ADD_DATA_URI_TAGS' in e ? xN(wN(de), e.ADD_DATA_URI_TAGS) : de),
            (ie = 'FORBID_CONTENTS' in e ? xN({}, e.FORBID_CONTENTS) : le),
            (G = 'FORBID_TAGS' in e ? xN({}, e.FORBID_TAGS) : {}),
            ($ = 'FORBID_ATTR' in e ? xN({}, e.FORBID_ATTR) : {}),
            ...
            ae &&
              ((L = xN({}, YR(AN))),
              (U = []),
              !0 === ae.html && (xN(L, kN), xN(U, MN)),
              !0 === ae.svg && (xN(L, CN), xN(U, DN), xN(U, FN)),
              !0 === ae.svgFilters && (xN(L, ON), xN(U, DN), xN(U, FN)),
              !0 === ae.mathMl && (xN(L, TN), xN(U, BN), xN(U, FN))),
            e.ADD_TAGS && (L === P && (L = wN(L)), xN(L, e.ADD_TAGS)),
            e.ADD_ATTR && (U === W && (U = wN(U)), xN(U, e.ADD_ATTR)),
            e.ADD_URI_SAFE_ATTR && xN(ue, e.ADD_URI_SAFE_ATTR),
            e.FORBID_CONTENTS &&
              (ie === le && (ie = wN(ie)), xN(ie, e.FORBID_CONTENTS)),
            se && (L['#text'] = !0),
            J && xN(L, ['html', 'head', 'body']),
            L.table && (xN(L, ['tbody']), delete G.tbody),
            oN && oN(e),
            (ye = e))
        },
        ke = xN({}, ['mi', 'mo', 'mn', 'ms', 'mtext']),
        Ce = xN({}, ['foreignobject', 'desc', 'title', 'annotation-xml']),
        Oe = xN({}, ['title', 'style', 'font', 'a', 'script']),
        _e = xN({}, CN)
      ;(xN(_e, ON), xN(_e, _N))
      var Te = xN({}, TN)
      xN(Te, EN)
      var Ee = function (e) {
          uN(o.removed, { element: e })
          try {
        ...
        Ae = function (e, t) {
          try {
            uN(o.removed, { attribute: t.getAttributeNode(e), from: t })
          } catch (e) {
            uN(o.removed, { attribute: null, from: t })
          }
        ...
        Me = function (e) {
          ...
          return (
            e &&
              o &&
              a.insertBefore(s.createTextNode(o), a.childNodes[0] || null),
            fe === he
        ...
        Ie = function (e) {
          ...
          if (
            ...
            return (Ee(e), !0)
          if (bN(/[\u0080-\uFFFF]/, e.nodeName)) return (Ee(e), !0)
          var s = B(e.nodeName)
          if (
            ...
            e.hasChildNodes() &&
              ...
              bN(/<[/\w]/g, e.innerHTML) &&
              bN(/<[/\w]/g, e.textContent))
          )
            return (Ee(e), !0)
          if ('select' === s && bN(/<template/i, e.innerHTML))
            return (Ee(e), !0)
          if (!L[s] || G[s]) {
            if (!G[s] && Ne(s)) {
              if (j.tagNameCheck instanceof RegExp && bN(j.tagNameCheck, s))
                return !1
              if (j.tagNameCheck instanceof Function && j.tagNameCheck(s))
                return !1
            }
            if (se && !ie[s]) {
          ...
          return e instanceof l &&
            ...
            ? (Ee(e), !0)
            : ('noscript' !== s && 'noembed' !== s) ||
                !bN(/<\/no(script|embed)/i, e.innerHTML)
              ? (K &&
                  3 === e.nodeType &&
                  ((t = e.textContent),
                  (t = pN(t, F, ' ')),
                  (t = pN(t, I, ' ')),
                  e.textContent !== t &&
                    (uN(o.removed, { element: e.cloneNode() }),
                    (e.textContent = t))),
        ...
        Re = function (e, t, o) {
          if (ne && ('id' === t || 'name' === t) && (o in s || o in xe))
            return !1
          if (X && !$[t] && bN(R, t));
          else if (q && bN(N, t));
          else if (!U[t] || $[t]) {
          ...
          if (r) {
            ...
            for (s = r.length; s--; ) {
              var i = (t = r[s]),
                l = i.name,
                c = i.namespaceURI
              ;((o = 'value' === l ? t.value : fN(t.value)), (n = B(l)))
              var d = o
              if (
                ((a.attrName = n),
                (a.attrValue = o),
        ...
        ze = function e(t) {
          ...
          for (Fe('beforeSanitizeShadowDOM', t, null); (o = n.nextNode()); )
            (Fe('uponSanitizeShadowNode', o, null),
              Ie(o) || (o.content instanceof r && e(o.content), Ve(o)))
      ...
      return (
        (o.sanitize = function (e, s) {
          ...
          if (
            ...
            (1 ===
              (l = (a = Me('\x3c!----\x3e')).ownerDocument.importNode(e, !0))
                .nodeType &&
              'BODY' === l.nodeName) ||
            'HTML' === l.nodeName
              ? (a = l)
          ...
          for (var g = De(re ? e : a); (c = g.nextNode()); )
            (3 === c.nodeType && c === d) ||
              Ie(c) ||
              (c.content instanceof r && ze(c.content), Ve(c), (d = c))
          ...
          return (
            J &&
              ...
              bN(PN, a.ownerDocument.doctype.name) &&
        ...
        (o.addHook = function (e, t) {
          'function' == typeof t && ((M[e] = M[e] || []), uN(M[e], t))
        }),
        (o.removeHook = function (e) {
          if (M[e]) return dN(M[e])
        }),
  ...
  const jN = (e) => WN().sanitize(e),
    GN = lf.deviceType.isTouch(),
    $N = (e, t) => ({
      dom: {
        tag: 'div',
        styles: { display: 'none' },
    ...
    YN = (e, t) =>
      zF.parts.body({
        ...
        components: [
          {
            dom: { tag: 'div', classes: ['tox-dialog__body-content'] },
            components: [{ dom: CA(`<p>${jN(t.translate(e))}</p>`) }],
          },
        ],
      }),
    KN = (e) =>
    ...
    ZN = (e) => {
      ...
      return zF.sketch({
        ...
        parts: {
          blocker: {
            dom: CA(`<div class="${o}"></div>`),
            components: [
              { dom: { tag: 'div', classes: GN ? [n, n + '--opaque'] : [n] } },
            ],
          },
        },
        dragBlockClass: o,
        modalBehaviours: kl([
          ...
          Jp(
            ...
            e.dialogEvents.concat([
              Yr(Xs(), (e, t) => {
                kA.isBlocked(e) || Pp.focusIn(e)
              }),
              Ur(_r(), (e, t) => {
                e.getSystem().broadcastOn([ZC], { newFocus: t.event.newFocus })
              }),
            ])
          ),
          Jp('scroll-lock', [
    ...
    QN = (e) =>
      Wh.sketch({
        ...
        buttonBehaviours: kl([iS.config({})]),
        components: [
          ef('close', { tag: 'span', classes: ['tox-icon'] }, e.icons),
        ],
        action: (e) => {
          Fr(e, hS)
        },
    ...
    tV = () => ({ dom: CA('<div class="tox-dialog__draghandle"></div>') }),
    oV = (e, t, o) =>
      ((e, t, o) => {
        const n = zF.parts.title(eV(e, t, A.none(), o)),
          s = zF.parts.draghandle(tV()),
          r = zF.parts.close(QN(o)),
          a = [n].concat(e.draggable ? [s] : []).concat([r])
        return eS.sketch({
          dom: CA('<div class="tox-dialog__header"></div>'),
          components: a,
        })
      })(
        {
    ...
    sV = (e, t, o) => ({
      ...
      onBlock: (o) => {
        ...
        zF.setBusy(e(), (e, s) => nV(o.message, s, t, n))
      },
      onUnblock: () => {
        zF.setIdle(e())
      },
    ...
    lV = (e, t) => [
      ...
      e(hS, (e, t, o, n) => {
        ;(t.onCancel(e), Fr(n, pS))
      }),
      Ur(yS, (e, o) => t.onUnblock()),
      Ur(vS, (e, o) => t.onBlock(o.event)),
    ],
    cV = (e, t, o) => {
      const n = (t, o) =>
          Ur(t, (t, n) => {
      ...
      return [
        ...lV(n, t),
        n(bS, (e, t) => t.onSubmit(e)),
        n(gS, (e, t, o) => {
          t.onChange(e, { name: o.name })
        }),
        n(fS, (e, t, n, s) => {
          const r = () =>
              s.getSystem().isConnected() ? Pp.focusIn(s) : void 0,
            a = (e) =>
              Tt(e, 'disabled') ||
              _t(e, 'aria-disabled').exists((e) => 'true' === e),
            i = ht(s.element),
            l = Il(i)
    ...
    uV = (e, t, o) => ({
      dom: CA('<div class="tox-dialog__footer"></div>'),
      components: [],
      behaviours: kl([
        OR.config({
          channel: `${KC}-${t}`,
          ...
          updateState: (e, t) => {
            const n = H(t.buttons, (e) => {
              const t = jh(((e, t) => M_(e, e.type, t))(e, o))
    ...
    mV = (e, t, o) => zF.parts.footer(uV(e, t, o)),
    gV = (e, t) => {
      if (e.getRoot().getSystem().isConnected()) {
        const o = wm.getCurrent(e.getFormWrapper()).getOr(e.getFormWrapper())
        return SC.getField(o, t).orThunk(() => {
          const o = e.getFooter().bind((e) => OR.getState(e).get())
    ...
    pV = (e, t, o) => {
      const n = (t) => {
        ...
        s = {
          ...
          setEnabled: (t, o) => {
            gV(e, t).each(o ? Rm.enable : Rm.disable)
          },
          focus: (t) => {
            gV(e, t).each(oh.focus)
          },
          block: (e) => {
            if (!r(e))
              throw new Error(
          ...
          redial: (r) => {
            n((n) => {
              const a = e.getId(),
                i = t(r),
                l = aV(i.internalDialog.buttons, o)
              ;(n.getSystem().broadcastOn([`${qC}-${a}`], i),
                n.getSystem().broadcastOn([`${XC}-${a}`], i.internalDialog),
                n.getSystem().broadcastOn([`${YC}-${a}`], i.internalDialog),
                n.getSystem().broadcastOn([`${KC}-${a}`], {
                  ...i.internalDialog,
                  buttons: l,
                }),
      ...
      const s = la('dialog'),
        ...
        c = jh(
          ((e, t, o, n) =>
            eS.sketch({
              dom: CA('<div class="tox-dialog__header"></div>'),
              components: [eV(e, t, A.some(o), n), tV(), QN(n)],
        ...
        g = Ce(
          0 !== u.length,
          jh(((e, t, o) => uV(e, t, o))({ buttons: u }, s, o))
        ),
        p = cV(
          () => b,
          {
            onBlock: (e) => {
              kA.block(f, (t, n) => {
                ...
                return nV(e.message, n, o.shared.providers, s)
              })
            },
            onUnblock: () => {
              kA.unblock(f)
        ...
        f = ri({
          dom: {
            tag: 'div',
            classes: ['tox-dialog', h, ...l.toArray()],
            attributes: { role: 'dialog', 'aria-labelledby': r },
          },
          eventOrder: {
            [dr()]: [OR.name(), Al.name()],
            [ur()]: ['execute-on-form'],
            [Sr()]: ['reflecting', 'execute-on-form'],
          },
          behaviours: kl([
            Pp.config({
              mode: 'cyclic',
              onEscape: (e) => (Fr(e, pS), A.some(!0)),
              useTabstopAt: (e) =>
                !$C(e) &&
                ('button' !== Ue(e) || 'disabled' !== Ot(e, 'disabled')),
              firstTabstop: 1,
            }),
            OR.config({
              channel: `${qC}-${s}`,
  ...
  var fV = tinymce.util.Tools.resolve('tinymce.util.URI')
  const bV = [
      'insertContent',
      'setContent',
      'execCommand',
    ...
    vV = (e) => a(e) && -1 !== bV.indexOf(e.mceAction),
    yV = (e, t, o, n) => {
      const s = la('dialog'),
        i = oV(e.title, s, n),
        l = ((e) => {
          ...
          return zF.parts.body(t)
        })(e),
        c = e.buttons.bind((e) =>
          0 === e.length ? A.none() : A.some(mV({ buttons: e }, s, n))
        ),
        u = ((e, t) => {
          const o = (e, t) =>
              Ur(e, (e, o) => {
        ...
        h = new fV(e.url, { base_uri: new fV(window.location.href) }),
          ...
          Jp('messages', [
            Kr(() => {
              const t = tc(Ve(window), 'message', (t) => {
                if (h.isSameOrigin(new fV(t.raw.origin))) {
                  const n = t.raw.data
                  vV(n)
                    ? ((e, t, o) => {
                        switch (o.mceAction) {
    ...
    xV = (e, t) => Xn(qn('data', t, e)),
    wV = (e) => jw(e, '.tox-alert-dialog') || jw(e, '.tox-confirm-dialog'),
    SV = (e, t, o) =>
      t && o
        ? []
        : [
              ...
              const s = () => {
                ...
                l = ri(
                  ZN({
                    lazySink: () => t.getSink(),
                    header: $N(a, i),
                    body: YN(o, t.providers),
                    footer: A.some(KN(JN([], [r.asSpec()]))),
                    onEscape: s,
                    extraClasses: ['tox-alert-dialog'],
                    extraBehaviours: [],
                    extraStyles: {},
                    dialogEvents: [Ur(hS, s)],
                    eventOrder: {},
                  })
                )
              zF.show(l)
          ...
          return {
            open: (o, n) => {
              const s = (e) => {
                ...
                i = XN(),
                l = qN(() => s(!1), t.providers),
                c = ri(
                  ZN({
                    lazySink: () => t.getSink(),
                    header: $N(i, l),
                    body: YN(o, t.providers),
                    footer: A.some(KN(JN([], [a, r.asSpec()]))),
                    onEscape: () => s(!1),
                    extraClasses: ['tox-confirm-dialog'],
                    extraBehaviours: [],
                    extraStyles: {},
                    dialogEvents: [Ur(hS, () => s(!1)), Ur(bS, () => s(!0))],
                    eventOrder: {},
                  })
                )
              zF.show(c)
            ...
            const r = n,
              a = ((e, t, o) => {
                const n = la('dialog'),
                  ...
                  r = oV(s.title, n, o),
                  a = ((e, t, o) => {
                    const n = GR(e, t, A.none(), o, !1)
                    return zF.parts.body(n)
                  })({ body: s.body, initialData: s.initialData }, n, o),
                  i = aV(s.buttons),
                  l = iV(i),
                  c = Ce(0 !== i.length, mV({ buttons: i }, n, o)),
                  d = cV(
                    () => p,
                    sV(() => m, o.shared.providers, t),
                    o.shared.getSink
                  ),
                  u = ((e) => {
                    switch (e) {
                  ...
                  g = {
                    getId: x(n),
                    getRoot: x(m),
                    getBody: () => zF.getBody(m),
                    getFooter: () => zF.getFooter(m),
                    getFormWrapper: () => {
                      const e = zF.getBody(m)
                      return wm.getCurrent(e).getOr(e)
                    },
                    toggleFullscreen: () => {
                      const e = 'tox-dialog--fullscreen',
                ...
                { dataValidator: s, initialData: r, internalDialog: t },
                {
                  redial: wR.redial,
                  closeWindow: () => {
                    ;(zF.hide(a.dialog), o(a.instanceApi))
                  },
                },
                e.backstages.dialog
              )
            return (zF.show(a.dialog), a.instanceApi.setData(r), a.instanceApi)
          }, t),
        a = (n, s, r, a) =>
          wR.open((n, i, l) => {
            const c = xV(i, l),
            ...
            return (
              ...
              (o && u) || (jE.refresh(p), t.on('ResizeEditor', m)),
                ...
                Ph.sketch({
                  ...
                  inlineBehaviours: kl([
                    ...
                    jE.config({
                      contextual: {
                        lazyContext: () =>
                          A.some(Jo(Ve(t.getContentAreaContainer()))),
                        fadeInClass: 'tox-dialog-dock-fadein',
                        fadeOutClass: 'tox-dialog-dock-fadeout',
                        transitionClass: 'tox-dialog-dock-transition',
                      },
          ...
          ((o, n) =>
            wR.openUrl((o) => {
              const s = yV(
                ...
                {
                  closeWindow: () => {
                    ;(zF.hide(s.dialog), n(s.instanceApi))
                  },
                },
                t,
                e.backstages.dialog
              )
              return (zF.show(s.dialog), s.instanceApi)
            }, o))(o, n),
        alert: (e, t) => {
          n.open(e, t)
        },
  ...
  tn.add('silver', (e) => {
      ...
      ;(uf(e),
        ((e) => {
          ...
          ;(t('color_map', {
            ...
            t('color_cols', {
              processor: 'number',
              default: Dx(zx(e, 'default').length),
            }),
            t('color_cols_foreground', {
              processor: 'number',
              default: Bx(e, zx(e, Ax).length),
            }),
            t('color_cols_background', {
              processor: 'number',
              default: Bx(e, zx(e, Mx).length),
            }),
            t('custom_colors', { processor: 'boolean', default: !0 }),
            t('color_default_foreground', { processor: 'string', default: Rx }),
            t('color_default_background', { processor: 'string', default: Rx }))
        })(e),
        ((e) => {
          const t = e.options.register
    ...
    const {
      ...
      popups: n,
      renderUI: s,
    } = IF(e, { getPopupSinkBounds: () => t() })
    Hw(e, n.backstage.shared)
    const a = kV({
      editor: e,
    ...
    return {
      renderUI: async () => {
        const o = await s()
        return (
          Uw(e, n.getMothership().element).each((e) => {
            t = () => Ww(e)
          }),
          o
        )
