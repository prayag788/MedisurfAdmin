...
!(function () {
  ...
  const F = (e) => (t) => _(t) && $(t) === e,
    ...
    q = (e, t, n) =>
      ((e, t, n, r, o) =>
        r(n) ? g.some(n) : a(o) && o(n) ? g.none() : t(n, r, o))(0, Q, e, t, n),
    W = (e, t) => {
      H(e).each((n) => {
  ...
  const ne = (e) => b(e, R),
    ...
    ae = (e, t) => {
      ...
      var r, o
      ;((o = n),
        ((e) => g.from(e.dom.nextSibling).map(R))((r = e)).fold(
          () => {
            H(r).each((e) => {
              Z(e, o)
            })
  ...
  const ue = (e) => (t) => l(t) && t.nodeName.toLowerCase() === e,
    ...
    De = (e, t) => {
      ...
      let l,
        ...
        d = !1
      for (
        a = n.create(s, i), Le(t.firstChild, r) || o.appendChild(a);
        (l = t.firstChild);
      ) {
        const e = l.nodeName
        ;(d ||
          ...
          (d = !0),
          Le(l, r)
            ? (o.appendChild(l), (a = null))
            : (a || ((a = n.create(s, i)), o.appendChild(a)), a.appendChild(l)))
      }
      return (
        !d && a && a.appendChild(n.create('br', { 'data-mce-bogus': '1' })),
        o
      )
    },
    Be = de.DOM,
      ...
      const n = e.dom.getParents(t, e.dom.isBlock),
        r = k(n, (t) => {
          return (
            ...
            !he((r = t)) &&
              !ve(r) &&
              C(_e, (e) => n.isValidChild(r.nodeName, e))
          )
          var n, r
        })
      ...
      S(e, (t, n) => {
        ;((e, t) => {
          const n = e[t].depth,
            ...
            o = (e) => e.depth < n
          return O(A(e.slice(0, t)), r, o).orThunk(() =>
            O(e.slice(t + 1), r, o)
          )
        })(e, n).fold(
          () => {
  ...
  const St = de.DOM,
            ...
            ;(r.hasChildNodes()
              ? ((o = Math.min(o, r.childNodes.length - 1)),
                n
                  ...
                  : St.insertAfter(e, r.childNodes[o]))
              : r.appendChild(e),
              (r = e),
              (o = 0))
          }
        ...
        if (n) {
          if (ge(n) && n.parentNode) {
            ...
            ;((r = ((e) => {
              ...
              for (; n; ) {
                if (n === e) return r
                ;((ge(n) && 'bookmark' === n.getAttribute('data-mce-type')) ||
                  r++,
                  (n = n.nextSibling))
              }
              return -1
      ...
      const i = (t, n) => {
        ...
        for (; (l = s[i]()); )
          if (
            ...
            !Ct(l.textContent) &&
            0 !==
              (null === (o = l.textContent) || void 0 === o ? void 0 : o.length)
          )
            return g.some(l)
        return g.none()
      }
      if (n && pe(o))
        if (Ct(o.textContent)) o = i(o, !1).getOr(o)
          ...
          for (
            ...
            null !== o.previousSibling &&
            (At(e, o.previousSibling) || pe(o.previousSibling));
          )
            o = o.previousSibling
      if (!n && pe(o))
        if (Ct(o.textContent)) o = i(o, !0).getOr(o)
          ...
          for (
            null !== o.parentNode && At(e, o.parentNode) && (o = o.parentNode);
            null !== o.nextSibling &&
            (At(e, o.nextSibling) || pe(o.nextSibling));
          )
            o = o.nextSibling
      for (; o.parentNode !== r; ) {
          ...
          ((e, t, n) => {
            ...
            return (
              ce.each(a, (t) => {
                ...
                if (o.isBlock(t) || Se(t))
                  return (Se(t) && o.remove(t), void (l = null))
                const i = t.nextSibling
                bt.isBookmarkNode(t) &&
                (he(i) || Ne(e, i) || (!i && t.parentNode === n))
                  ? (l = null)
                  : (l ||
                      ((l = o.create('p')),
                      null === (s = t.parentNode) ||
    ...
    Et = (e, t, n) => {
      return (
        ((e, t) => he(e) && e.nodeName === (null == t ? void 0 : t.nodeName))(
          t,
          n
        ) &&
        ((e, t, n) =>
    ...
    Dt = (e, t) => {
      ...
      if (((r = t.previousSibling), Et(e, t, r))) {
        const o = r
      ...
      ce.each(n, (t) => {
        ;((e, t) => {
          ...
          if (n && 'LI' === n.nodeName && n.firstChild === t) {
            ...
            r && 'LI' === r.nodeName
              ? (r.appendChild(t), ke(e, n) && Pt.remove(n))
              : Pt.setStyle(n, 'listStyleType', 'none')
          }
          if (he(n)) {
    ...
    Rt = (e, t, n, r) => {
      ...
      n &&
        ((e, t) =>
          !!Se(t) && e.isBlock(t.nextSibling) && !Se(t.previousSibling))(
          e.dom,
          o
        ) &&
        l.next()
              ...
              ((e, t) => {
                ...
                if (s && n.isEmpty(s)) {
                  ...
                  if (i) {
                    ...
                    return (
                      !!((e, t, n = u) =>
                        I(e, t, n).getOr(e.isNone() && t.isNone()))(
                        q(R(i), l, a),
                        q(R(r.startContainer), l, a),
                        U
                      ) &&
                      (e.undoManager.transact(() => {
                        ;(((e, t, n) => {
  ...
  const Wt = (e) => 3 === e.type,
    ...
    Gt = (e) => {
      const t = (t, n) => {
        ...
        n = L(
          e.children(),
          (e, n) => (Wt(n) ? [...e, n] : Zt(e) || Wt(n) ? e : (t(e, n), [])),
          []
        )
      Zt(n) || t(n)
    },
    Jt = (e, t) => (n) => (
      ...
      Je(e, (r) => {
        ;(n.setActive(We(r.parents, t)),
          n.setEnabled(!Ge(e, r.element) && e.selection.isEditable()))
      })
    ),
    Xt = (e, t) => (n) =>
      Je(e, (r) => n.setEnabled(We(r.parents, t) && !Ge(e, r.element)))
  e.add(
    'lists',
    (e) => (
      ((e) => {
                    ...
                    null === n ||
                      ...
                      e.undoManager.transact(() => {
                        ;(o(t.styles) && e.dom.setStyles(n, t.styles),
                          o(t.attrs) &&
                            oe(t.attrs, (t, r) => e.dom.setAttrib(n, r, t)))
                      })
                  })(e, n)
              }),
