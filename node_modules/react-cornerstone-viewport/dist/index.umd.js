(function (global, factory) {
  ...
  */
  ...
  var CornerstoneViewport = /*#__PURE__*/function (_Component) {
    ...
    createClass(CornerstoneViewport, [{
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  cornerstone__default['default'].enable(this.element, cornerstoneOptions); // ~~ EVENTS: ELEMENT
                  ...
                  try {
                    ...
                    cornerstoneTools__default['default'].addStackStateManager(this.element, ['stack', 'playClip', 'referenceLines']);
      ...
      value: function _bindInternalCornerstoneEventListeners() {
        ...
        cornerstone__default['default'].events[addOrRemoveEventListener]('cornerstoneimageloadprogress', this.onImageProgress); // Update number of images loaded
      ...
      value: function _bindInternalElementEventListeners() {
        ...
        this.element[addOrRemoveEventListener](cornerstone__default['default'].EVENTS.NEW_IMAGE, this.onNewImage); // Updates state's imageId, and imageIndex

        this.element[addOrRemoveEventListener](cornerstone__default['default'].EVENTS.NEW_IMAGE, this.onNewImageDebounced); // Updates state's viewport

        this.element[addOrRemoveEventListener](cornerstone__default['default'].EVENTS.IMAGE_RENDERED, this.onImageRendered); // Set Viewport Active
  ...
  function _trySetActiveTool(element, activeToolName) {
    ...
    cornerstoneTools__default['default'].setToolActiveForElement(element, activeToolName, {
      mouseButtonMask: 1
    });
  }
  /**
