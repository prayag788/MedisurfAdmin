...
import React__default, { PureComponent, cloneElement, isValidElement, createRef, Component } from 'react';
...
var ImageScrollbar = /*#__PURE__*/function (_PureComponent) {
  ...
  var _super = _createSuper$4(ImageScrollbar);
...
var ViewportOverlay = /*#__PURE__*/function (_PureComponent) {
  ...
  createClass(ViewportOverlay, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React__default.createElement("div", null, formatPN(patientName)), /*#__PURE__*/React__default.createElement("div", null, patientId)), /*#__PURE__*/React__default.createElement("div", {
        className: "top-right overlay-element"
      }, /*#__PURE__*/React__default.createElement("div", null, studyDescription), /*#__PURE__*/React__default.createElement("div", null, formatDA(studyDate), " ", formatTM(studyTime))), /*#__PURE__*/React__default.createElement("div", {
      ...
      }, /*#__PURE__*/React__default.createElement("div", null, seriesNumber >= 0 ? "Ser: ".concat(seriesNumber) : ''), /*#__PURE__*/React__default.createElement("div", null, stackSize > 1 ? "Img: ".concat(instanceNumber, " ").concat(imageIndex, "/").concat(stackSize) : ''), /*#__PURE__*/React__default.createElement("div", null, frameRate >= 0 ? "".concat(formatNumberPrecision(frameRate, 2), " FPS") : '', /*#__PURE__*/React__default.createElement("div", null, imageDimensions), /*#__PURE__*/React__default.createElement("div", null, isValidNumber(sliceLocation) ? "Loc: ".concat(formatNumberPrecision(sliceLocation, 2), " mm ") : '', sliceThickness ? "Thick: ".concat(formatNumberPrecision(sliceThickness, 2), " mm") : ''), /*#__PURE__*/React__default.createElement("div", null, seriesDescription))));
      return /*#__PURE__*/React__default.createElement("div", {
...
defineProperty(ViewportOrientationMarkers, "defaultProps", {
...
var CornerstoneViewport = /*#__PURE__*/function (_Component) {
  ...
  createClass(CornerstoneViewport, [{
    ...
    value: function () {
      var _componentDidMount = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
        var _this2 = this;
              ...
              case 0:
                ...
                try {
                  ...
                  requestFn = function requestFn(imageId, options) {
                    return cornerstone.loadAndCacheImage(imageId, options).then(function (image) {
                      cornerstone.displayImage(_this2.element, image, initialViewport);
                    });
                  }; // 1. Load the image using the ImageLoadingPool


                  cornerstone.imageLoadPoolManager.addRequest(requestFn.bind(this, imageId, options), requestType, {
                    imageId: imageId
    ...
    value: function () {
      var _componentDidUpdate = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(prevProps, prevState) {
        var _this3 = this;
              ...
              case 0:
                ...
                if (hasStackChanged) {
                  ...
                  try {
                    ...
                    requestFn = function requestFn(imageId, options) {
                      return cornerstone.loadAndCacheImage(imageId, options).then(function (image) {
                        cornerstone.displayImage(_this3.element, image, initialViewport);
                        cornerstone.reset(_this3.element);
                      });
                    };

                    cornerstone.imageLoadPoolManager.addRequest(requestFn.bind(this, imageId, {
                      addToBeginning: addToBeginning,
                      priority: priority
                    }), requestType, {
                      imageId: imageId
    ...
    function _setupLoadHandlers() {
      ...
      var startLoadHandler = function startLoadHandler(element) {
        clearTimeout(_this4.loadHandlerTimeout); // Call user defined loadHandler
    ...
    value: function render() {
      ...
      }, this.props.enableResizeDetector && this.element != null && /*#__PURE__*/React__default.createElement(ResizeDetector, {
        handleWidth: true,
        handleHeight: true,
        skipOnMount: true,
...
export { ViewportOverlay, CornerstoneViewport as default };
